...
struct Linker_x014332857624502915;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x05205718914998314;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x06321688631886984;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x04457696052034599;
...
struct Linker_x06602129175319886;
...
struct Linker_x07789597766844041;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06427601001654535;
...
struct Linker_x03109815504437283;
...
struct Linker_x08950459091132017;
...
struct Linker_x09262763697319865;
...
struct Linker_x018646135655925256;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0013899832900196252;
...
struct Linker_x017817719778517338;
...
struct Linker_x08850959222577488;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x029915024798494283;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x04287003291545002;
...
struct Linker_x08586341502168404;
...
struct Linker_x00551231652046138;
...
struct Linker_x07298995574828482;
...
struct Linker_x04056638145954756;
...
struct Linker_x03165923819560441;
...
struct Linker_x05320618899045859;
...
struct Linker_x07578362693977319;
...
struct Linker_x09140699864701485;
...
struct Linker_x07652336812999645;
...
struct Linker_x08167700765287527;
...
struct Linker_x0192166721355989;
...
struct Linker_x05864303361153413;
...
# 19 "./util/AddrTools.h"
struct Linker_x05148766176895401;
...
struct Linker_x04810108456596316;
...
struct Linker_x02803084600620538;
...
# 108 "subnode/SubnodePathfinder.c" 3 4
                                        ((void *)0)
# 108 "subnode/SubnodePathfinder.c"
                                            );
...
# 110 "subnode/SubnodePathfinder.c"
    ...
    Message_push32(msg, msgType, 
# 113 "subnode/SubnodePathfinder.c" 3 4
                                ((void *)0)
# 113 "subnode/SubnodePathfinder.c"
                                    );
...
# 127 "subnode/SubnodePathfinder.c" 3 4
                                             ((void *)0)
# 127 "subnode/SubnodePathfinder.c"
                                                 );
...
# 139 "subnode/SubnodePathfinder.c" 3 4
                                                                ((void *)0)
# 139 "subnode/SubnodePathfinder.c"
                                                                    );
...
{
    struct SnodeQuery* snq = (__extension__ ({ __typeof__((struct SnodeQuery*) prom->userData) Identity_ptr = ((struct SnodeQuery*) prom->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (168), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
    struct SubnodePathfinder_pvt* pf = (__extension__ ({ __typeof__(snq->pf) Identity_ptr = (snq->pf); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (169), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
...
# 197 "subnode/SubnodePathfinder.c" 3 4
                              ((void *)0)
# 197 "subnode/SubnodePathfinder.c"
                                  );
    Message_pop32(msg, 
# 198 "subnode/SubnodePathfinder.c" 3 4
                      ((void *)0)
# 198 "subnode/SubnodePathfinder.c"
                          );
    uint32_t version = Message_pop32(msg, 
# 199 "subnode/SubnodePathfinder.c" 3 4
                                         ((void *)0)
# 199 "subnode/SubnodePathfinder.c"
                                             );
...
# 225 "subnode/SubnodePathfinder.c"
    ...
    (snq)->Identity_verifier = ((unsigned long) 0xf2f5d4bb849ab86eull);
    snq->pf = pf;
...
static void rcChange(struct ReachabilityCollector* rc,
                     ...
                     struct ReachabilityCollector_PeerInfo* pi)
{
    struct SubnodePathfinder_pvt* pf = (__extension__ ({ __typeof__((struct SubnodePathfinder_pvt*) rc->userData) Identity_ptr = ((struct SubnodePathfinder_pvt*) rc->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (259), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
...
# 348 "subnode/SubnodePathfinder.c" 3 4
                                               ((void *)0)
# 348 "subnode/SubnodePathfinder.c"
                                                   );
    return Iface_next(&pf->pub.eventIf, msg);
}
...
# 361 "subnode/SubnodePathfinder.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (361), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; })); }));
    Message_push32(msg, PFChan_Pathfinder_CTRL_SENDMSG, 
# 362 "subnode/SubnodePathfinder.c" 3 4
                                                       ((void *)0)
# 362 "subnode/SubnodePathfinder.c"
                                                           );
    return Iface_next(&pf->pub.eventIf, msg);
}
...
static void unsetupSessionPingReply(Dict* msg, struct Address* src, struct MsgCore_Promise* prom)
{
    struct UnsetupSessionPing* usp =
        (__extension__ ({ __typeof__((struct UnsetupSessionPing*) prom->userData) Identity_ptr = ((struct UnsetupSessionPing*) prom->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (380), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
    struct SubnodePathfinder_pvt* pf = (__extension__ ({ __typeof__(usp->pf) Identity_ptr = (usp->pf); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (381), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
...
static __attribute__ ((warn_unused_result)) struct Iface* unsetupSession(struct Message* msg, struct SubnodePathfinder_pvt* pf)
{
    struct PFChan_Node node;
    Message_pop(msg, &node, 64, 
# 399 "subnode/SubnodePathfinder.c" 3 4
                                             ((void *)0)
# 399 "subnode/SubnodePathfinder.c"
                                                 );
...
# 410 "subnode/SubnodePathfinder.c"
    ...
    (usp)->Identity_verifier = ((unsigned long) 0xf2f5d4bb849ab86eull);
    usp->pf = pf;
...
static __attribute__ ((warn_unused_result)) struct Iface* linkState(struct Message* msg, struct SubnodePathfinder_pvt* pf)
{
    while (msg->length) {
        ...
        Message_pop(msg, &lse, 16, 
# 450 "subnode/SubnodePathfinder.c" 3 4
                                                           ((void *)0)
# 450 "subnode/SubnodePathfinder.c"
                                                               );
        ReachabilityCollector_updateBandwidthAndDrops(
            pf->pub.rc,
            ((uint32_t)__builtin_bswap32(((uint32_t)(lse.peerLabel_be)))),
            ((uint32_t)__builtin_bswap32(((uint32_t)(lse.sumOfPackets_be)))),
            ((uint32_t)__builtin_bswap32(((uint32_t)(lse.sumOfDrops_be)))),
            ((uint32_t)__builtin_bswap32(((uint32_t)(lse.sumOfKb_be))))
        );
    }
    return 
# 459 "subnode/SubnodePathfinder.c" 3 4
          ((void *)0)
# 459 "subnode/SubnodePathfinder.c"
              ;
}
...
# 465 "subnode/SubnodePathfinder.c" 3 4
       __builtin_offsetof (
# 465 "subnode/SubnodePathfinder.c"
       struct SubnodePathfinder_pvt
# 465 "subnode/SubnodePathfinder.c" 3 4
       , 
# 465 "subnode/SubnodePathfinder.c"
...
# 465 "subnode/SubnodePathfinder.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (465), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; })); }));
    do { if (!((msg->length >= ((56 + 12) + 4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (466), "(msg->length >= ((56 + 12) + 4))"); } } while (0);
    struct RouteHeader* rh = (struct RouteHeader*) msg->bytes;
    struct DataHeader* dh = (struct DataHeader*) &rh[1];
    do { if (!((DataHeader_getContentType(dh) == ContentType_CJDHT))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (469), "(DataHeader_getContentType(dh) == ContentType_CJDHT)"); } } while (0);
    do { if (!((!Bits_isZero(rh->publicKey, 32)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (470), "(!Bits_isZero(rh->publicKey, 32))"); } } while (0);
    do { if (!((rh->version_be))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (471), "(rh->version_be)"); } } while (0);
    do { if (!((rh->sh.label_be))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (472), "(rh->sh.label_be)"); } } while (0);
    Message_push32(msg, PFChan_Pathfinder_SENDMSG, 
# 473 "subnode/SubnodePathfinder.c" 3 4
                                                  ((void *)0)
# 473 "subnode/SubnodePathfinder.c"
                                                      );
    return Iface_next(&pf->pub.eventIf, msg);
}
...
# 480 "subnode/SubnodePathfinder.c" 3 4
       __builtin_offsetof (
# 480 "subnode/SubnodePathfinder.c"
       struct SubnodePathfinder_pvt
# 480 "subnode/SubnodePathfinder.c" 3 4
       , 
# 480 "subnode/SubnodePathfinder.c"
...
# 480 "subnode/SubnodePathfinder.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (480), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; })); }));
    enum PFChan_Core ev = Message_pop32(msg, 
# 481 "subnode/SubnodePathfinder.c" 3 4
                                            ((void *)0)
# 481 "subnode/SubnodePathfinder.c"
                                                );
    if (0 == pf->state) {
        do { if (!((ev == PFChan_Core_CONNECT))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (483), "(ev == PFChan_Core_CONNECT)"); } } while (0);
...
static void sendEvent(struct SubnodePathfinder_pvt* pf,
                      ...
                      int size)
{
    struct Allocator* alloc = Allocator__child((pf->alloc),"SubnodePathfinder.c",510);
    struct Message* msg = Message_new(0, 512+size, alloc);
    Message_push(msg, data, size, 
# 512 "subnode/SubnodePathfinder.c" 3 4
                                 ((void *)0)
# 512 "subnode/SubnodePathfinder.c"
                                     );
    Message_push32(msg, ev, 
# 513 "subnode/SubnodePathfinder.c" 3 4
                           ((void *)0)
# 513 "subnode/SubnodePathfinder.c"
                               );
    Iface_send(&pf->pub.eventIf, msg);
    Allocator__free((alloc),"SubnodePathfinder.c",515);
}

void SubnodePathfinder_start(struct SubnodePathfinder* sp)
{
    struct SubnodePathfinder_pvt* pf = (__extension__ ({ __typeof__((struct SubnodePathfinder_pvt*) sp) Identity_ptr = ((struct SubnodePathfinder_pvt*) sp); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (520), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
...
{
    struct SubnodePathfinder_pvt* pf = (__extension__ ({ __typeof__((struct SubnodePathfinder_pvt*) vsp) Identity_ptr = ((struct SubnodePathfinder_pvt*) vsp); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (551), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf2f5d4bb849ab86eull))"); } } while (0); Identity_ptr; }));
    struct Allocator* alloc = Allocator__child((pf->alloc),"SubnodePathfinder.c",552);
    struct Message* msgToCore = Message_new(0, 512, alloc);
    do { do { if (!((!msgToCore->currentIface))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SubnodePathfinder.c"), (554), "(!msgToCore->currentIface)"); } } while (0); struct Iface Iface_y = { .currentMsg = msgToCore }; msgToCore->currentIface = &Iface_y; struct Iface* Iface_x = sendNode(msgToCore, &pf->pub.snh->snodeAddr, 0, PFChan_Pathfinder_SNODE, pf); msgToCore->currentIface = 
# 554 "subnode/SubnodePathfinder.c" 3 4
   ((void *)0)
# 554 "subnode/SubnodePathfinder.c"
   ; if (Iface_x) { Iface_send(Iface_x, msgToCore); } } while (0);
    Allocator__free((alloc),"SubnodePathfinder.c",555);
}
...
struct SubnodePathfinder* SubnodePathfinder_new(struct Allocator* allocator,
                                                ...
                                                struct EncodingScheme* myScheme)
{
    struct Allocator* alloc = Allocator__child((allocator),"SubnodePathfinder.c",566);
    struct SubnodePathfinder_pvt* pf =
        Allocator__calloc((alloc),(sizeof(struct SubnodePathfinder_pvt)),(1),"SubnodePathfinder.c",568);
    (pf)->Identity_verifier = ((unsigned long) 0xf2f5d4bb849ab86eull);
    pf->alloc = alloc;
    pf->log = log;
    pf->base = base;
    pf->rand = rand;
    ...
    pf->queryMap.allocator = Allocator__child((alloc),"SubnodePathfinder.c",579);
    ...
    Timeout__setInterval((sendCurrentSupernode), (pf), (3000), (base), (alloc), "SubnodePathfinder.c", 588);

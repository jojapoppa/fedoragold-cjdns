...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07976134076595367;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09451053797240236;
...
struct Linker_x05177446140462627;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08874834398369975;
...
struct Linker_x08001098098417068;
...
struct Linker_x009180547977003983;
...
struct Linker_x023977316569335505;
...
struct Linker_x040600123952958356;
...
struct Linker_x019429170027495468;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05319641551736602;
...
struct Linker_x09929668208474256;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09823421801071048;
    ...
    int quiet)
{
    ...
    uint32_t selector = Message_pop32(fuzz, 
# 135 "test/testcjdroute.c" 3 4
                                           ((void *)0)
# 135 "test/testcjdroute.c"
                                               );

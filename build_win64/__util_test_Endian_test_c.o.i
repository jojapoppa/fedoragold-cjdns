# 1 "./util/test/Endian_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./util/test/Endian_test.c"
# 15 "./util/test/Endian_test.c"
# 1 "./util/Endian.h" 1
# 18 "./util/Endian.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x014468586742902612;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
void Assert_failure(const char* format, ...);
# 19 "./util/test/Endian_test.c" 2
...
int Endian_test_main(int argc, char** argv);int Endian_test_main(int argc, char** argv)
{
    printInfo();
    ...
    if (!0) {
        do { if (!((c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (40), "(c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; }))))"); } } while (0);
        do { if (!((c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (41), "(c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; }))))"); } } while (0);
        do { if (!((c == (c)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (42), "(c == (c))"); } } while (0);
        do { if (!((c == (c)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (43), "(c == (c))"); } } while (0);

        do { if (!((a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (45), "(a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa)))))"); } } while (0);
        do { if (!((a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (46), "(a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa)))))"); } } while (0);
        do { if (!((a == (a)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (47), "(a == (a))"); } } while (0);
        do { if (!((a == (a)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (48), "(a == (a))"); } } while (0);

        do { if (!((b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (50), "(b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb)))))"); } } while (0);
        do { if (!((b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (51), "(b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb)))))"); } } while (0);
        do { if (!((b == (b)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (52), "(b == (b))"); } } while (0);
        do { if (!((b == (b)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (53), "(b == (b))"); } } while (0);
    } else {
        do { if (!((c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(c))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (55), "(c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(c))); _x >> 8 | _x << 8; }))))"); } } while (0);
        do { if (!((c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(c))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (56), "(c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(c))); _x >> 8 | _x << 8; }))))"); } } while (0);
        do { if (!((c == (sc)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (57), "(c == (sc))"); } } while (0);
        do { if (!((c == (sc)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (58), "(c == (sc))"); } } while (0);

        do { if (!((a == ((uint32_t)__builtin_bswap32(((uint32_t)(a))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (60), "(a == ((uint32_t)__builtin_bswap32(((uint32_t)(a)))))"); } } while (0);
        do { if (!((a == ((uint32_t)__builtin_bswap32(((uint32_t)(a))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (61), "(a == ((uint32_t)__builtin_bswap32(((uint32_t)(a)))))"); } } while (0);
        do { if (!((a == (sa)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (62), "(a == (sa))"); } } while (0);
        do { if (!((a == (sa)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (63), "(a == (sa))"); } } while (0);

        do { if (!((b == ((uint64_t)__builtin_bswap64(((uint64_t)(b))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (65), "(b == ((uint64_t)__builtin_bswap64(((uint64_t)(b)))))"); } } while (0);
        do { if (!((b == ((uint64_t)__builtin_bswap64(((uint64_t)(b))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (66), "(b == ((uint64_t)__builtin_bswap64(((uint64_t)(b)))))"); } } while (0);
        do { if (!((b == (sb)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (67), "(b == (sb))"); } } while (0);
        do { if (!((b == (sb)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (68), "(b == (sb))"); } } while (0);
    }

    do { if (!((b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (71), "(b == ((uint64_t)__builtin_bswap64(((uint64_t)(sb)))))"); } } while (0);
    do { if (!((a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (72), "(a == ((uint32_t)__builtin_bswap32(((uint32_t)(sa)))))"); } } while (0);
    do { if (!((c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Endian_test.c"), (73), "(c == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(sc))); _x >> 8 | _x << 8; }))))"); } } while (0);
    return 0;
}

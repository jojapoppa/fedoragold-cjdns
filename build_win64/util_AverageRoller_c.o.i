...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0626114449474696;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x023371450107027258;
...
# 20 "./util/events/EventBase.h"
struct Linker_x008268219246167008;
...
struct Linker_x0012549124994452043;
...
struct Linker_x04968961978303321;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x03370731004120411;
...
struct Linker_x06269969659765622;
                                        ...
                                        struct Allocator* allocator)
{
    ...
    (roller)->Identity_verifier = ((unsigned long) 0xc829bedfe88b45d6ull);
    return &roller->pub;
}
...
{
    struct AverageRoller_pvt* roller = (__extension__ ({ __typeof__((struct AverageRoller_pvt*) averageRoller) Identity_ptr = ((struct AverageRoller_pvt*) averageRoller); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AverageRoller.c"), (43), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull))"); } } while (0); Identity_ptr; }));
...
uint32_t AverageRoller_updateAtTime(struct AverageRoller* averageRoller,
                                    ...
                                    const uint32_t newEntry)
{
    struct AverageRoller_pvt* roller = (__extension__ ({ __typeof__((struct AverageRoller_pvt*) averageRoller) Identity_ptr = ((struct AverageRoller_pvt*) averageRoller); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AverageRoller.c"), (59), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull))"); } } while (0); Identity_ptr; }));
    uint32_t index =
...
{
    struct AverageRoller_pvt* roller = (__extension__ ({ __typeof__((struct AverageRoller_pvt*) averageRoller) Identity_ptr = ((struct AverageRoller_pvt*) averageRoller); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AverageRoller.c"), (84), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc829bedfe88b45d6ull))"); } } while (0); Identity_ptr; }));

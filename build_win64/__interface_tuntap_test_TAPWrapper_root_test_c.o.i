# 1 "./interface/tuntap/test/TAPWrapper_root_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./interface/tuntap/test/TAPWrapper_root_test.c"
# 15 "./interface/tuntap/test/TAPWrapper_root_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0221332820857286;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08742902077510768;
...
struct Linker_x08321679020555481;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x006792022424134658;
...
struct Linker_x06157321773016751;
...
struct Linker_x048628736209788603;
...
# 20 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
...
struct Linker_x05851586983758315;
...
struct Linker_x0822299407303833;
...
void NetDev_setRoutes(const char* ifName,
                      ...
                      struct Except* eh);
# 21 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
# 1 "./test/RootTest.h" 1
# 18 "./test/RootTest.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05222994521244388;
...
int RootTest_TAPWrapper_root_test_main(int argc, char** argv);
int TAPWrapper_root_test_main(int argc, char** argv);int TAPWrapper_root_test_main(int argc, char** argv)
{
    int runIt = 0;
    int j = 0;
    ...
    if (runIt) {
        return RootTest_TAPWrapper_root_test_main(j,argv);
    } else {
        fprintf(
...
int RootTest_TAPWrapper_root_test_main(int argc, char** argv);
# 22 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07721154634466398;
...
struct Linker_x029824566721734813;
...
void TUNTools_echoTest(struct Sockaddr* udpBindTo,
                       ...
                       struct Log* logger,
                       struct Allocator* alloc);
# 23 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
# 1 "./interface/tuntap/TAPWrapper.h" 1
# 21 "./interface/tuntap/TAPWrapper.h"
# 1 "./wire/Ethernet.h" 1
# 23 "./wire/Ethernet.h"
struct Ethernet
{
...
struct Linker_x03238962479334102;
...
struct TAPWrapper* TAPWrapper_new(struct Iface* external,
                                  struct Log* log,
                                  struct Allocator* alloc);
# 24 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
# 1 "./interface/tuntap/NDPServer.h" 1
# 23 "./interface/tuntap/NDPServer.h"
struct Linker_x07723266777224402;
...
struct NDPServer* NDPServer_new(struct Iface* external,
                                ...
                                uint8_t localMac[6],
                                struct Allocator* alloc);
# 25 "./interface/tuntap/test/TAPWrapper_root_test.c" 2
# 1 "./interface/tuntap/ARPServer.h" 1
# 23 "./interface/tuntap/ARPServer.h"
struct Linker_x03238874852141187;
...
struct ARPServer* ARPServer_new(struct Iface* external,
                                ...
                                uint8_t localMac[6],
                                struct Allocator* alloc);
# 26 "./interface/tuntap/test/TAPWrapper_root_test.c" 2

int RootTest_TAPWrapper_root_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<20),"TAPWrapper_root_test.c",29);
    struct EventBase* base = EventBase_new(alloc);
    struct Log* log = FileWriterLog_new(
# 31 "./interface/tuntap/test/TAPWrapper_root_test.c" 3
                                       (__acrt_iob_func(1))
# 31 "./interface/tuntap/test/TAPWrapper_root_test.c"
                                             , alloc);
    ...
    struct Iface* tap = TUNInterface_new(
# 37 "./interface/tuntap/test/TAPWrapper_root_test.c" 3 4
                                        ((void *)0)
# 37 "./interface/tuntap/test/TAPWrapper_root_test.c"
                                            , assignedIfName, 1, base, log, 
# 37 "./interface/tuntap/test/TAPWrapper_root_test.c" 3 4
                                                                            ((void *)0)
# 37 "./interface/tuntap/test/TAPWrapper_root_test.c"
                                                                                , alloc);
    ...
    struct NDPServer* ndp = NDPServer_new(&tapWrapper->internal, log, "\xfc\x00\x00\x00\x00\x00", alloc);
    struct ARPServer* arp = ARPServer_new(&ndp->internal, log, "\xfc\x00\x00\x00\x00\x00", alloc);

    addrA->flags |= (1<<1);
    addrA->prefix = 126;
    NetDev_addAddress(assignedIfName, addrA, log, 
# 46 "./interface/tuntap/test/TAPWrapper_root_test.c" 3 4
                                                 ((void *)0)
# 46 "./interface/tuntap/test/TAPWrapper_root_test.c"
                                                     );

    TUNTools_echoTest(addrA, addrB, TUNTools_genericIP6Echo, &arp->internal, base, log, alloc);
    Allocator__free((alloc),"TAPWrapper_root_test.c",49);
    return 0;
}

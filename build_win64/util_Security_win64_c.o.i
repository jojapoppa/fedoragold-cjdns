# 1 "util/Security_win64.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "util/Security_win64.c"
# 15 "util/Security_win64.c"
# 1 "./benc/Dict.h" 1
# 18 "./benc/Dict.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08055249766893311;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x030615731089919085;
...
struct Linker_x0628346371166008;
...
# 16 "util/Security_win64.c" 2
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x026323379019516224;
...
struct Linker_x06492714892059674;
...
# 17 "util/Security_win64.c" 2
# 1 "./exception/Except.h" 1
# 20 "./exception/Except.h"
struct Linker_x07214329959454517;
...
# 18 "util/Security_win64.c" 2
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08491673647524633;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 19 "util/Security_win64.c" 2
# 1 "./util/Security.h" 1
# 22 "./util/Security.h"
# 1 "./util/events/EventBase.h" 1
# 20 "./util/events/EventBase.h"
struct Linker_x04968359288900277;
...
# 23 "./util/Security.h" 2
    ...
    struct Linker_x06515946382719651;
...
# 20 "util/Security_win64.c" 2

# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x009737039510256995;
...
# 22 "util/Security_win64.c" 2

# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x013924261467125154;
...
# 26 "util/Security_win64.c" 2


# 27 "util/Security_win64.c"
Dict* Security_getUser(char* userName, struct Allocator* retAlloc)
{
...
# 38 "util/Security_win64.c" 3 4
                     _Bool 
# 38 "util/Security_win64.c"
                          keepNetAdmin,
                      struct Log* logger,
                      struct Except* eh,
                      struct Allocator* alloc)
...
void Security_setupComplete(struct Security* security)
{
    struct Security_pvt* sec = (__extension__ ({ __typeof__((struct Security_pvt*) security) Identity_ptr = ((struct Security_pvt*) security); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x10f86d02c9050e57ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Security_win64.c"), (71), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x10f86d02c9050e57ull))"); } } while (0); Identity_ptr; }));
    sec->pub.setupComplete = 1;
    Allocator__free((sec->setupAlloc),"Security_win64.c",73);
}

static void fail(void* vSec)
{
    struct Security_pvt* sec = (__extension__ ({ __typeof__((struct Security_pvt*) vSec) Identity_ptr = ((struct Security_pvt*) vSec); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x10f86d02c9050e57ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Security_win64.c"), (78), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x10f86d02c9050e57ull))"); } } while (0); Identity_ptr; }));
    do { if (sec->log && Log_Level_CRITICAL >= Log_Level_DEBUG) { Log_print(sec->log, Log_Level_CRITICAL, "Security_win64.c", 79, "Security_setupComplete() not called in time, exiting"); } } while (0);
    _exit(232);
}

struct Security* Security_new(struct Allocator* alloc, struct Log* log, struct EventBase* base)
{
    struct Security_pvt* sec = Allocator__calloc((alloc),(sizeof(struct Security_pvt)),(1),"Security_win64.c",85);
    (sec)->Identity_verifier = ((unsigned long) 0x10f86d02c9050e57ull);
    sec->setupAlloc = Allocator__child((alloc),"Security_win64.c",87);
    Timeout__setInterval((fail), (sec), (20000), (base), (sec->setupAlloc), "Security_win64.c", 88);
    sec->log = log;
    return &sec->pub;
}
...
struct Security_Permissions* Security_checkPermissions(struct Allocator* alloc, struct Except* eh)
{
    struct Security_Permissions* out =
        Allocator__calloc((alloc),(sizeof(struct Security_Permissions)),(1),"Security_win64.c",96);
    return out;
}

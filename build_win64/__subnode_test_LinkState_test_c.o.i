...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07745021916993602;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x069406383121419;
...
struct Linker_x018566253077504946;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x034621089956281925;
...
struct Linker_x043886056851192223;
...
struct Linker_x007240183711432224;
...
struct Linker_x040169098896212985;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x01488290209954397;
...
struct Linker_x03504139947826077;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0968555899200265;
...
struct Linker_x09168004151720928;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x04579621008846313;
# 32 "./util/Hex.h"
...
static void applyStateUpdates(struct LinkState* local, struct Message* msg)
{
    ...
    Message_shift(msg, -length, 
# 84 "./subnode/test/LinkState_test.c" 3 4
                               ((void *)0)
# 84 "./subnode/test/LinkState_test.c"
                                   );

# 1 "util/GlobalConfig.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "util/GlobalConfig.c"
# 15 "util/GlobalConfig.c"
# 1 "./util/GlobalConfig.h" 1
# 18 "./util/GlobalConfig.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
# 1 "./benc/Object.h" 1
# 18 "./benc/Object.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0004277213747234665;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08920172355776161;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x06795809753397626;
...
struct Linker_x05010467644963277;
...
# 19 "./util/GlobalConfig.h" 2


struct Linker_x08796567818426788;
...
String* GlobalConfig_getTunName(struct GlobalConfig* conf)
{
    struct GlobalConfig_pvt* ctx = (__extension__ ({ __typeof__((struct GlobalConfig_pvt*) conf) Identity_ptr = ((struct GlobalConfig_pvt*) conf); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc8383a2317b12d33ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("GlobalConfig.c"), (27), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc8383a2317b12d33ull))"); } } while (0); Identity_ptr; }));
    return ctx->tunName;
}

void GlobalConfig_setTunName(struct GlobalConfig* conf, String* name)
{
    struct GlobalConfig_pvt* ctx = (__extension__ ({ __typeof__((struct GlobalConfig_pvt*) conf) Identity_ptr = ((struct GlobalConfig_pvt*) conf); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc8383a2317b12d33ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("GlobalConfig.c"), (33), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc8383a2317b12d33ull))"); } } while (0); Identity_ptr; }));

    ctx->tunName = ((name) ? String_newBinary(name->bytes, name->len, ctx->alloc) : 
# 35 "util/GlobalConfig.c" 3 4
                  ((void *)0)
# 35 "util/GlobalConfig.c"
                  );
}

struct GlobalConfig* GlobalConfig_new(struct Allocator* alloc)
{
    struct GlobalConfig_pvt* gcp = Allocator__calloc((alloc),(sizeof(struct GlobalConfig_pvt)),(1),"GlobalConfig.c",40);
    (gcp)->Identity_verifier = ((unsigned long) 0xc8383a2317b12d33ull);
    gcp->alloc = alloc;
    return &gcp->pub;
}

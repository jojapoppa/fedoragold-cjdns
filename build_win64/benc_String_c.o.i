...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07902407356126191;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0867822366286197;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x028625449230554834;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05921926695759867;
...
struct Linker_x04453259236797844;
...
String* String_newBinary(const char* bytes, unsigned long length, struct Allocator* allocator)
{
    char* copy = Allocator__malloc((allocator),(length + 1),"String.c",32);

    copy[length] = '\0';
    if (bytes != 
# 35 "benc/String.c" 3 4
                ((void *)0)
# 35 "benc/String.c"
                    ) {
        Bits__memcpy(copy,bytes,length,"String.c",36);
    } else {
        __builtin_memset(copy,'\0',length);
    }
    String* string = Allocator__malloc((allocator),(sizeof(String)),"String.c",40);
    string->len = length;
    string->bytes = copy;
    return string;
}
...
# 85 "benc/String.c"
    ...
    return a->len == b->len && (__builtin_memcmp(a->bytes,b->bytes,a->len) == 0);
}

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03515257177235267;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09021450513462435;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x00805998451925467;
...
struct Linker_x09061277195113995;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x03068510840820644;
...
struct Linker_x013377447680084265;
...
struct Linker_x06489056845974384;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x05534367751905944;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x09108147601299581;
...
struct Linker_x04393254330781935;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0039987147867988515;
...
struct Linker_x09603625095492445;
...
# 21 "./util/ArrayList.h"
struct Linker_x09576373154099005;
...
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (189), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
    addSomething(rp, destination, rp->exceptions6, rp->exceptions4);
}

void RouteGen_addPrefix(struct RouteGen* rg, struct Sockaddr* destination)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (195), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
    addSomething(rp, destination, rp->prefixes6, rp->prefixes4);
}

void RouteGen_addLocalPrefix(struct RouteGen* rg, struct Sockaddr* destination)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (201), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
Dict* RouteGen_getPrefixes(struct RouteGen* rg, struct Allocator* alloc)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (230), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
    return getSomething(rp, alloc, rp->prefixes6, rp->prefixes4);
}

Dict* RouteGen_getLocalPrefixes(struct RouteGen* rg, struct Allocator* alloc)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (236), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
    return getSomething(rp, alloc, rp->localPrefixes6, rp->localPrefixes4);
}

Dict* RouteGen_getExceptions(struct RouteGen* rg, struct Allocator* alloc)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (242), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
# 278 "tunnel/RouteGen.c"
    RouteGen_removePrefix(struct RouteGen* rg, struct Sockaddr* toRemove)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (280), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
# 284 "tunnel/RouteGen.c"
    RouteGen_removeLocalPrefix(struct RouteGen* rg, struct Sockaddr* toRemove)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (286), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
# 290 "tunnel/RouteGen.c"
    RouteGen_removeException(struct RouteGen* rg, struct Sockaddr* toRemove)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (292), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
Dict* RouteGen_getGeneratedRoutes(struct RouteGen* rg, struct Allocator* alloc)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (633), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
...
void RouteGen_commit(struct RouteGen* rg,
                     ...
                     struct Except* eh)
{
    struct RouteGen_pvt* rp = (__extension__ ({ __typeof__((struct RouteGen_pvt*) rg) Identity_ptr = ((struct RouteGen_pvt*) rg); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouteGen.c"), (643), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x901fc07e20613aa4ull))"); } } while (0); Identity_ptr; }));
    struct Prefix46* p46 = getGeneratedRoutes(rp, tempAlloc);
    struct Sockaddr** prefixSet =
        Allocator__calloc((tempAlloc),(sizeof(char*)),(p46->prefix4->length + p46->prefix6->length),"RouteGen.c",646);
    int prefixNum = 0;
...
struct RouteGen* RouteGen_new(struct Allocator* allocator, struct Log* log)
{
    ...
    rp->log = log;
    rp->alloc = alloc;
    (rp)->Identity_verifier = ((unsigned long) 0x901fc07e20613aa4ull);

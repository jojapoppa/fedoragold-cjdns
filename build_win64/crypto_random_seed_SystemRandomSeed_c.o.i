# 1 "crypto/random/seed/SystemRandomSeed.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "crypto/random/seed/SystemRandomSeed.c"
# 15 "crypto/random/seed/SystemRandomSeed.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x04391710057710072;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x020018453155259763;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07737778429609401;
...
struct Linker_x0894946598460705;
...
# 16 "crypto/random/seed/SystemRandomSeed.c" 2


# 1 "./crypto/random/seed/RandomSeedProvider.h" 1
# 18 "./crypto/random/seed/RandomSeedProvider.h"

# 19 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/RtlGenRandomSeed.h" 1
# 24 "./crypto/random/seed/RtlGenRandomSeed.h"
    struct Linker_x03648655737519233;
    struct RandomSeed* RtlGenRandomSeed_new(struct Allocator* alloc);
    
# 20 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/BsdKernArndSysctlRandomSeed.h" 1
# 21 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/DevUrandomRandomSeed.h" 1
# 24 "./crypto/random/seed/DevUrandomRandomSeed.h"
    struct Linker_x0024709164124042893;
    struct RandomSeed* DevUrandomRandomSeed_new(struct Allocator* alloc);
    
# 22 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/LinuxRandomUuidSysctlRandomSeed.h" 1
# 23 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/ProcSysKernelRandomUuidRandomSeed.h" 1
# 24 "crypto/random/seed/SystemRandomSeed.c" 2
# 1 "./crypto/random/seed/GetEntropyRandomSeed.h" 1
# 25 "crypto/random/seed/SystemRandomSeed.c" 2
...
struct Linker_x07131678841232876;
...
struct RandomSeed* SystemRandomSeed_new(RandomSeed_Provider* additionalProviders,
                                        ...
                                        struct Log* logger,
                                        struct Allocator* alloc);
# 26 "crypto/random/seed/SystemRandomSeed.c" 2

static RandomSeed_Provider PROVIDERS[] = { RtlGenRandomSeed_new,DevUrandomRandomSeed_new };
...
struct RandomSeed* SystemRandomSeed_new(RandomSeed_Provider* additionalProviders,
                                        ...
                                        struct Allocator* alloc)
{
    int providerCount = ((int)(sizeof(PROVIDERS) / sizeof(RandomSeed_Provider))) + additionalProviderCount;

    RandomSeed_Provider* allProviders =
        Allocator__calloc((alloc),(sizeof(RandomSeed_Provider)),(providerCount+1),"SystemRandomSeed.c",38);
    int i = 0;

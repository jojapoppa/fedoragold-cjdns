# 1 "./util/test/Base10_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./util/test/Base10_test.c"
# 16 "./util/test/Base10_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06235662994765032;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09590314201322232;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x003650649036597842;
...
struct Linker_x025418110228440405;
...
struct Linker_x07556944570878559;
...
# 19 "./util/test/Base10_test.c" 2
# 1 "./wire/Message.h" 1
# 22 "./wire/Message.h"
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09440738554546488;
...
# 20 "./util/test/Base10_test.c" 2
# 1 "./util/Base10.h" 1
# 21 "./util/Base10.h"
struct Linker_x045810814649780496;
...
# 21 "./util/test/Base10_test.c" 2

# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08683757310863107;
...
# 25 "./util/test/Base10_test.c" 2


# 26 "./util/test/Base10_test.c"
int Base10_test_main(int argc, char** argv);int Base10_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"Base10_test.c",28);
    struct Random* rand = Random_new(alloc, 
# 29 "./util/test/Base10_test.c" 3 4
                                           ((void *)0)
# 29 "./util/test/Base10_test.c"
                                               , 
# 29 "./util/test/Base10_test.c" 3 4
                                                 ((void *)0)
# 29 "./util/test/Base10_test.c"
    ...
    for (int i = 0; i < 1000; i++) {
        ...
        Message_reset(msg);
        Message_push(msg, 
# 37 "./util/test/Base10_test.c" 3 4
                         ((void *)0)
# 37 "./util/test/Base10_test.c"
                             , 32, 
# 37 "./util/test/Base10_test.c" 3 4
                                   ((void *)0)
# 37 "./util/test/Base10_test.c"
        ...
        Base10_write(msg, num, 
# 41 "./util/test/Base10_test.c" 3 4
                              ((void *)0)
# 41 "./util/test/Base10_test.c"
                                  );

        snprintf(buff, 31, "%lld", num);

        do { if (!((msg->length == (int)CString_strlen(buff)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Base10_test.c"), (45), "(msg->length == (int)CString_strlen(buff))"); } } while (0);
        do { if (!((!__builtin_memcmp(msg->bytes,buff,msg->length)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Base10_test.c"), (46), "(!__builtin_memcmp(msg->bytes,buff,msg->length))"); } } while (0);

        int64_t read = Base10_read(msg, 
# 48 "./util/test/Base10_test.c" 3 4
                                       ((void *)0)
# 48 "./util/test/Base10_test.c"
                                           );
        do { if (!((read == num))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Base10_test.c"), (49), "(read == num)"); } } while (0);
        do { if (!((msg->length == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Base10_test.c"), (50), "(msg->length == 0)"); } } while (0);
    }

    Allocator__free((alloc),"Base10_test.c",53);
    return 0;
}

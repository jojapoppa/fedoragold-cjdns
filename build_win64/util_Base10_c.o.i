...
struct Linker_x020690640573840802;
...
# 20 "./util/Assert.h"
struct Linker_x03150142315939868;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x08354840565273869;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05491883767403916;
...
struct Linker_x09329297250453654;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08689672319403652;
...
# 47 "util/Base10.c"
    ...
    if (chr >= '0' && chr <= '9') {
        ...
        Message_push8(msg, chr, eh);
        Except__throw("Base10.c", 65, eh, "No base10 characters found");
    }
}
...
int Base10_fromString(uint8_t* str, int64_t* numOut)
{
    ...
    *numOut = Base10_read(&msg, 
# 82 "util/Base10.c" 3 4
                               ((void *)0)
# 82 "util/Base10.c"
                                   );
    return 0;

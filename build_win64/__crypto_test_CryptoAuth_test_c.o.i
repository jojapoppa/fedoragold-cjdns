...
# 1 "<command-line>"
# 1 "./crypto/test/CryptoAuth_test.c"
# 15 "./crypto/test/CryptoAuth_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x023996980279970836;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x008337527383875631;
...
struct Linker_x014753205212884613;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x017138273873033194;
...
struct Linker_x00364222491203241;
...
struct Linker_x003165533567648349;
...
# 16 "./crypto/test/CryptoAuth_test.c" 2
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x010080911398013681;
...
struct Linker_x08813310774321521;
...
# 21 "./util/ArrayList.h"
struct Linker_x03877993975830505;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x03626043650627693;
...
struct Linker_x028922944220161995;
...
struct Linker_x07467526552781629;
...
# 23 "./crypto/test/CryptoAuth_test.c" 2

# 1 "./util/log/FileWriterLog.h" 1
# 21 "./util/log/FileWriterLog.h"
struct Linker_x0295389558650587;
...
# 25 "./crypto/test/CryptoAuth_test.c" 2
...
# 26 "./crypto/test/CryptoAuth_test.c" 2
# 39 "./crypto/test/CryptoAuth_test.c"
struct Context
{
...
static struct Context* init(uint8_t* privateKeyA,
                            ...
                            uint8_t* publicKeyB)
{
    struct Allocator* alloc = MallocAllocator__new((1048576),"CryptoAuth_test.c",59);
    struct Context* ctx = Allocator__calloc((alloc),(sizeof(struct Context)),(1),"CryptoAuth_test.c",60);
    ctx->alloc = alloc;
    struct Log* logger = ctx->log = FileWriterLog_new(
# 62 "./crypto/test/CryptoAuth_test.c" 3
                                                     (__acrt_iob_func(1))
# 62 "./crypto/test/CryptoAuth_test.c"
                                                           , alloc);
    struct Random* rand = ctx->rand = Random_new(alloc, logger, 
# 63 "./crypto/test/CryptoAuth_test.c" 3 4
                                                               ((void *)0)
# 63 "./crypto/test/CryptoAuth_test.c"
                                                                   );
    struct EventBase* base = ctx->base = EventBase_new(alloc);

    ctx->ca1 = CryptoAuth_new(alloc, privateKeyA, base, logger, rand);
    ctx->sess1 = CryptoAuth_newSession(ctx->ca1, alloc, publicKeyB, 
# 67 "./crypto/test/CryptoAuth_test.c" 3 4
                                                                   0
# 67 "./crypto/test/CryptoAuth_test.c"
                                                                        , "cif1");

    ctx->ca2 = CryptoAuth_new(alloc, privateKeyB, base, logger, rand);
    if (password) {
        String* passStr = (&(String) { .bytes = password, .len = CString_strlen(password) });
        CryptoAuth_setAuth(passStr, 
# 72 "./crypto/test/CryptoAuth_test.c" 3 4
                                   ((void *)0)
# 72 "./crypto/test/CryptoAuth_test.c"
                                       , ctx->sess1);
        CryptoAuth_addUser(passStr, String_new("This represents a user", alloc), ctx->ca2);
    }
    ctx->sess2 = CryptoAuth_newSession(ctx->ca2, alloc, publicKeyA, 
# 75 "./crypto/test/CryptoAuth_test.c" 3 4
                                                                   0
# 75 "./crypto/test/CryptoAuth_test.c"
                                                                        , "cif2");
...
{
    return init("\x53\xff\x22\xb2\xeb\x94\xce\x8c\x5f\x18\x52\xc0\xf5\x57\xeb\x90\x1f\x06\x7e\x52\x73\xd5\x41\xe0\xa2\x1e\x14\x3c\x20\xdf\xf9\xda", "\xe3\xff\x75\xaf\x6e\x44\x14\x49\x4d\xf2\x2f\x20\x0f\xfe\xaa\x56\xe7\x97\x6d\x99\x1d\x33\xcc\x87\xf5\x24\x27\xe2\x7f\x83\x23\x5d", 
# 82 "./crypto/test/CryptoAuth_test.c" 3 4
                                          ((void *)0)
# 82 "./crypto/test/CryptoAuth_test.c"
                                              , "\xb7\x1c\x4f\x43\xe3\xd4\xb1\x87\x9b\x50\x65\xd4\x4a\x1c\xb4\x3e\xaf\x07\xdd\xba\x96\xde\x6a\x72\xca\x76\x1c\x4e\xf4\xbd\x29\x88", "\x27\xc3\x03\xcd\xc1\xf9\x6e\x4b\x28\xd5\x1c\x75\x13\x0a\xff\x6c\xad\x52\x09\x8f\x2d\x75\x26\x15\xb7\xb6\x50\x9e\xd6\xa8\x94\x77");
}
...
static struct Message* encryptMsg(struct Context* ctx,
                                  ...
                                  const char* x)
{
    struct Allocator* alloc = Allocator__child((ctx->alloc),"CryptoAuth_test.c",89);
    int len = (((CString_strlen(x)+1) / 8) + 1) * 8;
    struct Message* msg = Message_new(len, 120, alloc);
    CString_strcpy(msg->bytes, x);
    msg->length = CString_strlen(x);
    msg->bytes[msg->length] = 0;
    do { if (!((!CryptoAuth_encrypt(encryptWith, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (95), "(!CryptoAuth_encrypt(encryptWith, msg))"); } } while (0);
    do { if (!((msg->length > ((int)CString_strlen(x) + 4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (96), "(msg->length > ((int)CString_strlen(x) + 4))"); } } while (0);
    return msg;
}
                       ...
                       const char* x)
{
    if (!x) {
        ...
        do { if (!((CryptoAuth_decrypt(decryptWith, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (107), "(CryptoAuth_decrypt(decryptWith, msg))"); } } while (0);
    } else {
        do { if (!((!CryptoAuth_decrypt(decryptWith, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (109), "(!CryptoAuth_decrypt(decryptWith, msg))"); } } while (0);
...
static void sendToIf1(struct Context* ctx, const char* x)
{
    ...
    Allocator__free((msg->alloc),"CryptoAuth_test.c",123);
}
...
static void sendToIf2(struct Context* ctx, const char* x)
{
    ...
    Allocator__free((msg->alloc),"CryptoAuth_test.c",130);
}
...
static void normal()
{
    ...
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",140);
}
...
static void repeatKey()
{
    ...
    sendToIf2(ctx, "hai");
    sendToIf1(ctx, "goodbye");
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",151);
}
...
static void repeatHello()
{
    ...
    sendToIf2(ctx, "hai");
    sendToIf1(ctx, "goodbye");
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",162);
}
...
static void chatter()
{
    ...
    sendToIf2(ctx, "hai");
    sendToIf1(ctx, "goodbye");
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",181);
}

static void auth()
{
    struct Context* ctx = init("\x53\xff\x22\xb2\xeb\x94\xce\x8c\x5f\x18\x52\xc0\xf5\x57\xeb\x90\x1f\x06\x7e\x52\x73\xd5\x41\xe0\xa2\x1e\x14\x3c\x20\xdf\xf9\xda", "\xe3\xff\x75\xaf\x6e\x44\x14\x49\x4d\xf2\x2f\x20\x0f\xfe\xaa\x56\xe7\x97\x6d\x99\x1d\x33\xcc\x87\xf5\x24\x27\xe2\x7f\x83\x23\x5d", "password", "\xb7\x1c\x4f\x43\xe3\xd4\xb1\x87\x9b\x50\x65\xd4\x4a\x1c\xb4\x3e\xaf\x07\xdd\xba\x96\xde\x6a\x72\xca\x76\x1c\x4e\xf4\xbd\x29\x88", "\x27\xc3\x03\xcd\xc1\xf9\x6e\x4b\x28\xd5\x1c\x75\x13\x0a\xff\x6c\xad\x52\x09\x8f\x2d\x75\x26\x15\xb7\xb6\x50\x9e\xd6\xa8\x94\x77");
    sendToIf2(ctx, "hello world");
    sendToIf1(ctx, "hello cjdns");
    sendToIf2(ctx, "hai");
    sendToIf1(ctx, "goodbye");
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",191);
}
...
static void replayKeyPacket(int scenario)
{
    ...
    if (scenario == 1) {
        ...
        decryptMsg(ctx, toReplay, ctx->sess1, 
# 206 "./crypto/test/CryptoAuth_test.c" 3 4
                                             ((void *)0)
# 206 "./crypto/test/CryptoAuth_test.c"
                                                 );
    }
    ...
    if (scenario == 2) {
        decryptMsg(ctx, toReplay, ctx->sess1, 
# 212 "./crypto/test/CryptoAuth_test.c" 3 4
                                             ((void *)0)
# 212 "./crypto/test/CryptoAuth_test.c"
                                                 );
    }
    ...
    if (scenario == 3) {
        ...
        decryptMsg(ctx, toReplay, ctx->sess1, 
# 219 "./crypto/test/CryptoAuth_test.c" 3 4
                                             ((void *)0)
# 219 "./crypto/test/CryptoAuth_test.c"
                                                 );
    }

    Allocator__free((ctx->alloc),"CryptoAuth_test.c",222);
}
...
{
    struct Context* ctx = simpleInit();
    Bits__memcpy(ctx->sess2->herPublicKey,ctx->ca1->publicKey,32,"CryptoAuth_test.c",233);
    ...
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",246);
}
...
static void reset()
{
    ...
    do { if (!((CryptoAuth_getState(ctx->sess1) == CryptoAuth_State_ESTABLISHED))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (257), "(CryptoAuth_getState(ctx->sess1) == CryptoAuth_State_ESTABLISHED)"); } } while (0);
    do { if (!((CryptoAuth_getState(ctx->sess2) == CryptoAuth_State_ESTABLISHED))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (258), "(CryptoAuth_getState(ctx->sess2) == CryptoAuth_State_ESTABLISHED)"); } } while (0);

    CryptoAuth_reset(ctx->sess1);


    decryptMsg(ctx, encryptMsg(ctx, ctx->sess2, "will be lost"), ctx->sess1, 
# 263 "./crypto/test/CryptoAuth_test.c" 3 4
                                                                            ((void *)0)
# 263 "./crypto/test/CryptoAuth_test.c"
                                                                                );
    decryptMsg(ctx, encryptMsg(ctx, ctx->sess2, "lost"), ctx->sess1, 
# 264 "./crypto/test/CryptoAuth_test.c" 3 4
                                                                    ((void *)0)
# 264 "./crypto/test/CryptoAuth_test.c"
                                                                        );
    ...
    do { if (!((CryptoAuth_getState(ctx->sess1) == CryptoAuth_State_ESTABLISHED))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (274), "(CryptoAuth_getState(ctx->sess1) == CryptoAuth_State_ESTABLISHED)"); } } while (0);
    do { if (!((CryptoAuth_getState(ctx->sess2) == CryptoAuth_State_ESTABLISHED))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_test.c"), (275), "(CryptoAuth_getState(ctx->sess2) == CryptoAuth_State_ESTABLISHED)"); } } while (0);

    Allocator__free((ctx->alloc),"CryptoAuth_test.c",277);
}
...
static void twoKeyPackets(int scenario)
{
    ...
    if (scenario == 1) {
        ...
        sendToIf2(ctx, "initial data packet");
        sendToIf1(ctx, "second data packet");
        decryptMsg(ctx, key2, ctx->sess1, 
# 301 "./crypto/test/CryptoAuth_test.c" 3 4
                                         ((void *)0)
# 301 "./crypto/test/CryptoAuth_test.c"
                                             );
    }
    Allocator__free((ctx->alloc),"CryptoAuth_test.c",303);
}

int CryptoAuth_test_main(int argc, char** argv);int CryptoAuth_test_main(int argc, char** argv)
{
    normal();
    repeatKey();
    repeatHello();

# 1 "interface/tuntap/TUNInterface_win64.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/tuntap/TUNInterface_win64.c"
# 15 "interface/tuntap/TUNInterface_win64.c"
...
struct Linker_x018366387502870607;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x025261903413689724;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x02963375165207658;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07496560459665338;
...
# 16 "interface/tuntap/TUNInterface_win64.c" 2
...
struct Linker_x06252344041462248;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08929601858492457;
...
struct Linker_x03772378061975217;
...
struct Iface* TUNInterface_new(const char* interfaceName,
                                   ...
                                   struct Except* eh,
                                   struct Allocator* alloc);
# 17 "interface/tuntap/TUNInterface_win64.c" 2
# 1 "./interface/tuntap/windows/TAPInterface.h" 1
# 24 "./interface/tuntap/windows/TAPInterface.h"
struct Linker_x02253670371925658;
...
struct TAPInterface* TAPInterface_new(const char* preferredName,
                                      ...
                                      struct EventBase* base,
                                      struct Allocator* alloc);
# 18 "interface/tuntap/TUNInterface_win64.c" 2
...
struct Linker_x0566692747888776;
...
struct TAPWrapper* TAPWrapper_new(struct Iface* external,
                                  struct Log* log,
                                  struct Allocator* alloc);
# 19 "interface/tuntap/TUNInterface_win64.c" 2
# 1 "./interface/tuntap/NDPServer.h" 1
# 23 "./interface/tuntap/NDPServer.h"
struct Linker_x0206772699240529;
...
struct NDPServer* NDPServer_new(struct Iface* external,
                                ...
                                uint8_t localMac[6],
                                struct Allocator* alloc);
# 20 "interface/tuntap/TUNInterface_win64.c" 2
# 1 "./interface/tuntap/ARPServer.h" 1
# 23 "./interface/tuntap/ARPServer.h"
struct Linker_x05642942137685176;
...
struct ARPServer* ARPServer_new(struct Iface* external,
                                ...
                                uint8_t localMac[6],
                                struct Allocator* alloc);
# 21 "interface/tuntap/TUNInterface_win64.c" 2
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05992695995849289;
...
# 22 "interface/tuntap/TUNInterface_win64.c" 2
                                   ...
                                   struct Allocator* alloc)
{
    ...
    if (!tap) {
        return 
# 33 "interface/tuntap/TUNInterface_win64.c" 3 4
              ((void *)0)
# 33 "interface/tuntap/TUNInterface_win64.c"
                  ;
    }

    CString_safeStrncpy(assignedInterfaceName, tap->assignedName, 256);
    if (isTapMode) { return &tap->generic; }
    struct TAPWrapper* tapWrapper = TAPWrapper_new(&tap->generic, logger, alloc);
    struct NDPServer* ndp =
        NDPServer_new(&tapWrapper->internal, logger, "\xfc\x00\x00\x00\x00\x00", alloc);
    struct ARPServer* arp =
        ARPServer_new(&ndp->internal, logger, "\xfc\x00\x00\x00\x00\x00", alloc);
    return &arp->internal;
}

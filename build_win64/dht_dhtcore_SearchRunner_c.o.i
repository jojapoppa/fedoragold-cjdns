...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08262290823682406;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x032379758151480686;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05236849730469344;
...
struct Linker_x09234925774400631;
...
struct Linker_x05524214314492601;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x08677769594134841;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x039552475787618;
...
struct Linker_x06522382647617879;
...
struct Linker_x06662890793777947;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x06226137401155634;
...
struct Linker_x09251533790374462;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x014542069198877794;
...
struct Linker_x098825201728165;
...
struct Linker_x07959581619311769;
...
struct Linker_x08197808067624859;
...
struct Linker_x041975765313159186;
...
struct Linker_x09612185495995909;
...
struct Linker_x003247171585051212;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x003381205806005738;
...
struct Linker_x009003722361498978;
...
struct Linker_x07569723369195012;
...
void ReplySerializer_serialize(struct Address_List* addrs,
                               ...
                               struct Allocator* alloc);
# 22 "dht/dhtcore/SearchRunner.c" 2
...
struct Linker_x019327936724488426;
...
# 25 "dht/dhtcore/SearchRunner.c" 2
...
struct Linker_x09464683010243065;
...
# 30 "dht/dhtcore/SearchRunner.c" 2
...
# 116 "dht/dhtcore/SearchRunner.c"
static inline 
# 116 "dht/dhtcore/SearchRunner.c" 3 4
             _Bool 
# 116 "dht/dhtcore/SearchRunner.c"
                  isDuplicateEntry(struct Address_List* list, uint32_t index)
{
    for (int i = index+1; i < list->length; i++) {
        if (__builtin_memcmp(&list->elems[i].key,&list->elems[i].key,32) == 0) {
            return 
# 120 "dht/dhtcore/SearchRunner.c" 3 4
                  1
# 120 "dht/dhtcore/SearchRunner.c"
                      ;
        }
    }
    return 
# 123 "dht/dhtcore/SearchRunner.c" 3 4
          0
# 123 "dht/dhtcore/SearchRunner.c"
               ;
}
                                ...
                                Dict* result)
{
    struct SearchRunner_Search* search =
        (__extension__ ({ __typeof__((struct SearchRunner_Search*)promise->userData) Identity_ptr = ((struct SearchRunner_Search*)promise->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (134), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));
...
# 146 "dht/dhtcore/SearchRunner.c" 3 4
                                                                   1
# 146 "dht/dhtcore/SearchRunner.c"
                                                                       , promise->alloc);

    struct Address* best = 
# 148 "dht/dhtcore/SearchRunner.c" 3 4
                          ((void *)0)
# 148 "dht/dhtcore/SearchRunner.c"
                              ;
    ...
    for (int i = 0; nodeList && i < nodeList->length; i++) {
        ...
        if (!nn) {
            RumorMill__addNode((search->runner->rumorMill), (&nodeList->elems[i]), "SearchRunner.c", 170);
        }
...
{
    struct SearchRunner_Search* search =
        (__extension__ ({ __typeof__((struct SearchRunner_Search*)promise->userData) Identity_ptr = ((struct SearchRunner_Search*)promise->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (200), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));
...
static void searchStep(struct SearchRunner_Search* search)
{
    struct SearchRunner_pvt* ctx = (__extension__ ({ __typeof__((struct SearchRunner_pvt*)search->runner) Identity_ptr = ((struct SearchRunner_pvt*)search->runner); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (218), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));
...
# 229 "dht/dhtcore/SearchRunner.c" 3 4
                                    ((void *)0)
# 229 "dht/dhtcore/SearchRunner.c"
                                        ) {
...
# 235 "dht/dhtcore/SearchRunner.c" 3 4
                                                 ((void *)0)
# 235 "dht/dhtcore/SearchRunner.c"
                                                     , 
# 235 "dht/dhtcore/SearchRunner.c" 3 4
                                                       ((void *)0)
# 235 "dht/dhtcore/SearchRunner.c"
        ...
        Allocator__free((search->pub.alloc),"SearchRunner.c",237);
        return;
    }

    Bits__memcpy(&search->lastNodeAsked,&nextSearchNode->address,sizeof(struct Address),"SearchRunner.c",241);
...
{
    struct SearchRunner_Search* search = (__extension__ ({ __typeof__((struct SearchRunner_Search*) vsearch) Identity_ptr = ((struct SearchRunner_Search*) vsearch); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (266), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));
...
{
    struct SearchRunner_Search* search =
        (__extension__ ({ __typeof__((struct SearchRunner_Search*)job->userData) Identity_ptr = ((struct SearchRunner_Search*)job->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (278), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));

    *search->thisSearch = search->nextSearch;
    if (search->nextSearch) {
        search->nextSearch->thisSearch = search->thisSearch;
    }
    do { if (!((search->runner->searches > 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (284), "(search->runner->searches > 0)"); } } while (0);
...
struct SearchRunner_SearchData* SearchRunner_showActiveSearch(struct SearchRunner* searchRunner,
                                                              ...
                                                              struct Allocator* alloc)
{
    struct SearchRunner_pvt* runner = (__extension__ ({ __typeof__((struct SearchRunner_pvt*)searchRunner) Identity_ptr = ((struct SearchRunner_pvt*)searchRunner); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (293), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));
    ...
    struct SearchRunner_SearchData* out =
        Allocator__calloc((alloc),(sizeof(struct SearchRunner_SearchData)),(1),"SearchRunner.c",301);

    if (search) {
        Bits__memcpy(out->target,&search->target.ip6.bytes,16,"SearchRunner.c",304);
        Bits__memcpy(&out->lastNodeAsked,&search->lastNodeAsked,sizeof(struct Address),"SearchRunner.c",305);
...
struct RouterModule_Promise* SearchRunner_search(uint8_t target[16],
                                                 ...
                                                 struct Allocator* allocator)
{
    struct SearchRunner_pvt* runner = (__extension__ ({ __typeof__((struct SearchRunner_pvt*)searchRunner) Identity_ptr = ((struct SearchRunner_pvt*)searchRunner); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SearchRunner.c"), (319), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8ca338db8eb6e593ull))"); } } while (0); Identity_ptr; }));

    if (runner->searches > runner->maxConcurrentSearches) {
        do { if (runner->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(runner->logger, Log_Level_DEBUG, "SearchRunner.c", 322, "Skipping search because there are already [%d] searches active", runner->searches); } } while (0)
                                   ;
        return 
# 324 "dht/dhtcore/SearchRunner.c" 3 4
              ((void *)0)
# 324 "dht/dhtcore/SearchRunner.c"
                  ;
    }
    ...
    struct Allocator* alloc = Allocator__child((allocator),"SearchRunner.c",334);

    struct Address targetAddr = { .path = 0 };
    Bits__memcpy(targetAddr.ip6.bytes,target,16,"SearchRunner.c",337);
    ...
    if (nodes->size == 0) {
        do { if (runner->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(runner->logger, Log_Level_DEBUG, "SearchRunner.c", 347, "No nodes available for beginning search"); } } while (0);
        Allocator__free((alloc),"SearchRunner.c",348);
        return 
# 349 "dht/dhtcore/SearchRunner.c" 3 4
              ((void *)0)
# 349 "dht/dhtcore/SearchRunner.c"
                  ;
    }
    ...
    struct SearchRunner_Search* search = Allocator__clone((alloc),((&(struct SearchRunner_Search) { .pub = { .alloc = alloc }, .runner = runner, .search = sss, .maxRequests = maxRequests, .maxRequestsIfFound = maxRequestsIfFound })),sizeof(*((&(struct SearchRunner_Search) { .pub = { .alloc = alloc }, .runner = runner, .search = sss, .maxRequests = maxRequests, .maxRequestsIfFound = maxRequestsIfFound }))),"SearchRunner.c",358)
       ...
       ;
    (search)->Identity_verifier = ((unsigned long) 0x8ca338db8eb6e593ull);
    runner->searches++;
    Allocator__onFree((alloc), (searchOnFree), (search), "SearchRunner.c", 369);
    Bits__memcpy(&search->target,&targetAddr,sizeof(struct Address),"SearchRunner.c",370);
    ...
    search->continueSearchTimeout =
        Timeout__setTimeout((searchNextNode), (search), (0), (runner->eventBase), (alloc), "SearchRunner.c", 383);
                                      ...
                                      struct Allocator* allocator)
{
    ...
    Bits__memcpy(out->myAddress,myAddress,16,"SearchRunner.c",406);
    (out)->Identity_verifier = ((unsigned long) 0x8ca338db8eb6e593ull);

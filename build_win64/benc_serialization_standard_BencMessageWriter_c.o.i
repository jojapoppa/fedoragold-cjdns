...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06876908383418872;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03533430709925809;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08175130054639788;
...
struct Linker_x004728745416980318;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x012565745977876674;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x006283260088184428;
...
struct Linker_x017909625472624513;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x008070706461511801;
...
struct Linker_x08840080479225458;
...
# 1 "./util/Base10.h" 1
# 21 "./util/Base10.h"
struct Linker_x03819602336447203;
...
void BencMessageWriter_write(Dict* toWrite, struct Message* msg, struct Except* eh)
{
    ...
    do { if (!((Message_pop8(msg, eh) == 'd'))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BencMessageWriter.c"), (88), "(Message_pop8(msg, eh) == 'd')"); } } while (0);
    do { if (!((msg->bytes[0] != 'e' && "Can't serialize empty messages"))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BencMessageWriter.c"), (89), "(msg->bytes[0] != 'e' && \"Can't serialize empty messages\")"); } } while (0);
    do { if (!((msg->bytes[0] >= '1' && msg->bytes[0] <= '9'))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BencMessageWriter.c"), (90), "(msg->bytes[0] >= '1' && msg->bytes[0] <= '9')"); } } while (0);

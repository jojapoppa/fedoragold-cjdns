...
struct Linker_x007283046527908632;
...
struct Linker_x018978221105550785;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0711695854196235;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x073951473170796;
...
struct Linker_x020773830042055996;
...
struct Linker_x03094473819182213;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x028589634465439917;
...
struct Linker_x06243809223514751;
...
struct Linker_x05283796896290873;
...
struct Linker_x07120417694465782;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x06297358904971726;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x023142107759979358;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x07853098929190572;
...
struct Linker_x004058271830010107;
...
struct Linker_x034826218850961177;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x06872450277838162;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x04042244046292196;
...
struct Linker_x016977839906028414;
...
struct Linker_x0689616493871865;
...
struct Linker_x040048567766954424;
...
struct Linker_x011710504083972739;
...
struct Linker_x08729487777329334;
...
struct Linker_x0796163912808898;
...
struct Linker_x02856117160153422;
...
struct Linker_x008778175778477393;
...
struct Linker_x08479212606024957;
...
# 19 "./util/AddrTools.h"
struct Linker_x006636611107417134;
...
struct Linker_x07361599829267753;
...
int SupernodeHunter_addSnode(struct SupernodeHunter* snh, struct Address* snodeAddr)
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) snh) Identity_ptr = ((struct SupernodeHunter_pvt*) snh); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (81), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
...
int SupernodeHunter_listSnodes(struct SupernodeHunter* snh,
                               ...
                               struct Allocator* alloc)
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) snh) Identity_ptr = ((struct SupernodeHunter_pvt*) snh); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (94), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
...
int SupernodeHunter_removeSnode(struct SupernodeHunter* snh, struct Address* toRemove)
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) snh) Identity_ptr = ((struct SupernodeHunter_pvt*) snh); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (105), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
    int length0 = snp->authorizedSnodes->length;
...
{
    struct Query* q = (__extension__ ({ __typeof__((struct Query*) prom->userData) Identity_ptr = ((struct Query*) prom->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (128), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__(q->snp) Identity_ptr = (q->snp); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (129), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
...
static void adoptSupernode(struct SupernodeHunter_pvt* snp, struct Address* candidate)
{
    ...
    (q)->Identity_verifier = ((unsigned long) 0xf061f77b92de7493ull);
    q->snp = snp;
...
{
    struct Query* q = (__extension__ ({ __typeof__((struct Query*) prom->userData) Identity_ptr = ((struct Query*) prom->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (180), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__(q->snp) Identity_ptr = (q->snp); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (181), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
...
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) userData) Identity_ptr = ((struct SupernodeHunter_pvt*) userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (308), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
    char* err = "";
    switch (resp->res) {
...
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) vsn) Identity_ptr = ((struct SupernodeHunter_pvt*) vsn); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (324), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
...
static void onSnodeUnreachable(struct SupernodeHunter* snh,
                               ...
                               int64_t snodeRecvTime)
{
    struct SupernodeHunter_pvt* snp = (__extension__ ({ __typeof__((struct SupernodeHunter_pvt*) snh) Identity_ptr = ((struct SupernodeHunter_pvt*) snh); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter.c"), (365), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf061f77b92de7493ull))"); } } while (0); Identity_ptr; }));
                                            ...
                                            struct ReachabilityCollector* rc)
{
    ...
    (out)->Identity_verifier = ((unsigned long) 0xf061f77b92de7493ull);

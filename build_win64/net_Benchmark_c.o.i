...
# 16 "net/Benchmark.c" 2
# 1 "./net/Benchmark.h" 1
# 18 "./net/Benchmark.h"
# 1 "./util/Linker.h" 1
# 19 "./net/Benchmark.h" 2

# 19 "./net/Benchmark.h"
struct Linker_x07734436908924893;

void Benchmark_runAll(void);
# 17 "net/Benchmark.c" 2
...
struct Linker_x0050662316288078824;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06965030132131693;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x09734139129999533;
...
struct Linker_x09277947650941467;
...
struct Linker_x09897529016334776;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x06979047456458594;
...
struct Linker_x01467277472631887;
...
struct Linker_x009147010969007696;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x08321901566230478;
...
struct Linker_x09801621048394353;
...
# 24 "net/Benchmark.c" 2
# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x07984413278835267;
...
# 21 "./util/ArrayList.h"
struct Linker_x009002032454550313;
...
struct Linker_x08572695927536769;
...
struct Linker_x017165519513127991;
...
struct Linker_x02369458565805227;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x010102785172059003;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x04769464231032703;
...
struct Linker_x063179680598408;
...
struct Linker_x023986478442888526;
...
struct Linker_x035601827209038706;
...
struct Linker_x01838107022564528;
...
struct Linker_x016404453343263148;
...
struct Linker_x020285776112051468;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0917376055243128;
...
struct Linker_x07636922395430745;
...
struct Linker_x08910194736960693;
...
struct Linker_x08598277861913288;
...
struct Linker_x014134708555694098;
...
# 22 "./net/TUNAdapter.h"
struct Linker_x03284743040164655;
...
struct Linker_x02735805631894175;
...
{
    do { if (!((!ctx->benchName))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (45), "(!ctx->benchName)"); } } while (0);
    ctx->benchName = benchName;
    ctx->itemName = itemName;
    ctx->items = items;
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 49, "----- Begin %s benchmark -----", benchName); } } while (0);
...
static void done(struct Context* ctx)
{
    ...
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 61, " "); } } while (0);
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 62, "---------------------------------------------------------------"); } } while (0);
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 63, "Benchmark %s in %dms. %d %s per second", ctx->benchName, (int)time, (int)kbps, ctx->itemName); } } while (0)
                                                            ;
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 65, "---------------------------------------------------------------"); } } while (0);
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 66, " "); } } while (0);
    do { if (!((ctx->benchName))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (67), "(ctx->benchName)"); } } while (0);
    ctx->benchName = 
# 68 "net/Benchmark.c" 3 4
                    ((void *)0)
# 68 "net/Benchmark.c"
                        ;
}
...
{
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 73, "Setting up salsa20/poly1305 benchmark (encryption and decryption only)"); } } while (0);
    struct Allocator* alloc = Allocator__child((ctx->alloc),"Benchmark.c",74);
    struct CryptoAuth* ca1 = CryptoAuth_new(alloc, 
# 75 "net/Benchmark.c" 3 4
                                                  ((void *)0)
# 75 "net/Benchmark.c"
                                                      , ctx->base, ctx->log, ctx->rand);
    struct CryptoAuth* ca2 = CryptoAuth_new(alloc, 
# 76 "net/Benchmark.c" 3 4
                                                  ((void *)0)
# 76 "net/Benchmark.c"
                                                      , ctx->base, ctx->log, ctx->rand);

    struct CryptoAuth_Session* sess1 =
        CryptoAuth_newSession(ca1, alloc, ca2->publicKey, 
# 79 "net/Benchmark.c" 3 4
                                                         0
# 79 "net/Benchmark.c"
                                                              , "bench");
    struct CryptoAuth_Session* sess2 =
        CryptoAuth_newSession(ca2, alloc, ca1->publicKey, 
# 81 "net/Benchmark.c" 3 4
                                                         0
# 81 "net/Benchmark.c"
                                                              , "bench");
    ...
    for (int i = 0; i < 2; i++) {
        do { if (!((!CryptoAuth_encrypt(sess1, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (90), "(!CryptoAuth_encrypt(sess1, msg))"); } } while (0);
        do { if (!((!CryptoAuth_decrypt(sess2, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (91), "(!CryptoAuth_decrypt(sess2, msg))"); } } while (0);
        do { if (!((!CryptoAuth_encrypt(sess2, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (92), "(!CryptoAuth_encrypt(sess2, msg))"); } } while (0);
        do { if (!((!CryptoAuth_decrypt(sess1, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (93), "(!CryptoAuth_decrypt(sess1, msg))"); } } while (0);
    }

    begin(ctx, "salsa20/poly1305", (count * size * 8) / 1024, "kilobits");
    for (int i = 0; i < count; i++) {
        do { if (!((!CryptoAuth_encrypt(sess1, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (98), "(!CryptoAuth_encrypt(sess1, msg))"); } } while (0);
        do { if (!((!CryptoAuth_decrypt(sess2, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (99), "(!CryptoAuth_decrypt(sess2, msg))"); } } while (0);
    }
    done(ctx);
    Allocator__free((alloc),"Benchmark.c",102);
}
...
static __attribute__ ((warn_unused_result)) struct Iface* aliceToBob(struct Message* msg, struct Iface* aliceIf)
{
    struct SwitchingContext* sc =
        (__extension__ ({ const __typeof__(((struct SwitchingContext*)0)->aliceIf)*__mptr = (aliceIf); (__extension__ ({ __typeof__((struct SwitchingContext*)((char*)__mptr - 
# 121 "net/Benchmark.c" 3 4
       __builtin_offsetof (
# 121 "net/Benchmark.c"
       struct SwitchingContext
# 121 "net/Benchmark.c" 3 4
...
# 121 "net/Benchmark.c"
       )) Identity_ptr = ((struct SwitchingContext*)((char*)__mptr - 
# 121 "net/Benchmark.c" 3 4
       __builtin_offsetof (
# 121 "net/Benchmark.c"
       struct SwitchingContext
...
# 121 "net/Benchmark.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (121), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull))"); } } while (0); Identity_ptr; })); }));
    return Iface_next(&sc->bobIf, msg);
}

static __attribute__ ((warn_unused_result)) struct Iface* bobToAlice(struct Message* msg, struct Iface* bobIf)
{
    struct SwitchingContext* sc =
        (__extension__ ({ const __typeof__(((struct SwitchingContext*)0)->bobIf)*__mptr = (bobIf); (__extension__ ({ __typeof__((struct SwitchingContext*)((char*)__mptr - 
# 128 "net/Benchmark.c" 3 4
       __builtin_offsetof (
# 128 "net/Benchmark.c"
       struct SwitchingContext
# 128 "net/Benchmark.c" 3 4
...
# 128 "net/Benchmark.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (128), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull))"); } } while (0); Identity_ptr; })); }));
    return Iface_next(&sc->aliceIf, msg);
}

static __attribute__ ((warn_unused_result)) struct Iface* aliceCtrlRecv(struct Message* msg, struct Iface* aliceCtrlIf)
{
    struct SwitchingContext* sc =
        (__extension__ ({ const __typeof__(((struct SwitchingContext*)0)->aliceCtrlIf)*__mptr = (aliceCtrlIf); (__extension__ ({ __typeof__((struct SwitchingContext*)((char*)__mptr - 
# 135 "net/Benchmark.c" 3 4
       __builtin_offsetof (
# 135 "net/Benchmark.c"
       struct SwitchingContext
# 135 "net/Benchmark.c" 3 4
...
# 135 "net/Benchmark.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (135), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6f86391c0007bc24ull))"); } } while (0); Identity_ptr; })); }));

    sc->msgCount++;
    return 
# 138 "net/Benchmark.c" 3 4
          ((void *)0)
# 138 "net/Benchmark.c"
              ;
}
...
{
    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 143, "switching ... Setting up salsa20/poly1305 benchmark       (encryption and decryption only)"); } } while (0)
                                        ;
    struct Allocator* alloc = Allocator__child((ctx->alloc),"Benchmark.c",145);;
    uint8_t ipv6[16];
    uint8_t publicKey[32];
    ...
    struct SwitchingContext* sc = Allocator__calloc((alloc),(sizeof(struct SwitchingContext)),(1),"Benchmark.c",153);
    (sc)->Identity_verifier = ((unsigned long) 0x6f86391c0007bc24ull);
    sc->benchmarkCtx = ctx;
    ...
    struct InterfaceController_Iface* aliceIci =
        InterfaceController_newIface(alice->ifController, (&(String) { .bytes = "alice", .len = CString_strlen("alice") }), alloc);
    ...
    struct InterfaceController_Iface* bobIci =
        InterfaceController_newIface(bob->ifController, (&(String) { .bytes = "bob", .len = CString_strlen("bob") }), alloc);
    Iface_plumb(&sc->bobIf, &bobIci->addrIf);

    CryptoAuth_addUser((&(String) { .bytes = "abcdefg123", .len = CString_strlen("abcdefg123") }), (&(String) { .bytes = "TEST", .len = CString_strlen("TEST") }), bob->ca);
...
# 179 "net/Benchmark.c" 3 4
                                               ((void *)0)
# 179 "net/Benchmark.c"
                                                   ,
                                                
# 180 "net/Benchmark.c" 3 4
                                               ((void *)0)
# 180 "net/Benchmark.c"
                                                   ,
                                                alloc);
    do { if (!((!ret))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (182), "(!ret)"); } } while (0);
    ...
    struct Message* msg = Message_new(8 + 4, 256, alloc);
...
# 192 "net/Benchmark.c"
    ...
    rh->sh.label_be = ((uint64_t)__builtin_bswap64(((uint64_t)(0x13))));
    rh->flags |= (1<<1);
    ...
    for (int i = 1; i < count; i++) {
        rh->flags &= ~1;
        ping->magic = ((uint32_t)__builtin_bswap32(((uint32_t)(0x09f91102))));
        ch->type_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(3))); _x >> 8 | _x << 8; })));
        ch->checksum_be = 0;
        ch->checksum_be = Checksum_engine((void*)ch, 8 + 4);

        Iface_send(&sc->aliceCtrlIf, msg);

        do { if (!((msg->bytes == (void*)rh))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (211), "(msg->bytes == (void*)rh)"); } } while (0);
        do { if (!((sc->msgCount == i))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (212), "(sc->msgCount == i)"); } } while (0);
        do { if (!((ping->magic == ((uint32_t)__builtin_bswap32(((uint32_t)(0x9d74e35b))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (213), "(ping->magic == ((uint32_t)__builtin_bswap32(((uint32_t)(0x9d74e35b)))))"); } } while (0);
        do { if (!((ch->type_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(4))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (214), "(ch->type_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(4))); _x >> 8 | _x << 8; }))))"); } } while (0);
        do { if (!((!Checksum_engine((void*)ch, 8 + 4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Benchmark.c"), (215), "(!Checksum_engine((void*)ch, 8 + 4))"); } } while (0);
    }

    done(ctx);

    do { if (ctx->log && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(ctx->log, Log_Level_INFO, "Benchmark.c", 220, "DONE"); } } while (0);
    Allocator__free((alloc),"Benchmark.c",221);
}


void Benchmark_runAll(void)
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"Benchmark.c",227);
    struct Context* ctx = Allocator__calloc((alloc),(sizeof(struct Context)),(1),"Benchmark.c",228);
    (ctx)->Identity_verifier = ((unsigned long) 0x6f86391c0007bc24ull);
    ctx->alloc = alloc;
    ctx->base = EventBase_new(alloc);
    struct Log* log = ctx->log = FileWriterLog_new(
# 232 "net/Benchmark.c" 3
                                                  (__acrt_iob_func(1))
# 232 "net/Benchmark.c"
                                                        , alloc);
    ctx->rand = Random_new(alloc, log, 
# 233 "net/Benchmark.c" 3 4
                                      ((void *)0)
# 233 "net/Benchmark.c"
                                          );

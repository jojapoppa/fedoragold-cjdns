# 1 "benc/serialization/json/JsonBencSerializer.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "benc/serialization/json/JsonBencSerializer.c"
# 15 "benc/serialization/json/JsonBencSerializer.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x034256550348156023;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0120814361581431;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 16 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./io/Reader.h" 1
# 18 "./io/Reader.h"
...
# 17 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./io/Writer.h" 1
# 23 "./io/Writer.h"
struct Writer {
# 35 "./io/Writer.h"
...
# 18 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./benc/Dict.h" 1
# 19 "./benc/Dict.h"
# 1 "./benc/Object.h" 1
# 18 "./benc/Object.h"
...
struct Linker_x042151506244556103;
...
# 19 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x03980429266408285;
...
# 20 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x012178541736483961;
...
struct Linker_x009717379416443173;
...
# 21 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./benc/serialization/BencSerializer.h" 1
# 22 "./benc/serialization/BencSerializer.h"
...
# 22 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./benc/serialization/json/JsonBencSerializer.h" 1
# 20 "./benc/serialization/json/JsonBencSerializer.h"
struct Linker_x03388670489802066;

const struct BencSerializer* JsonBencSerializer_get(void);
# 23 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x040661204405126083;
...
# 24 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07146464869158049;
# 32 "./util/Hex.h"
...
# 25 "benc/serialization/json/JsonBencSerializer.c" 2
...
# 27 "benc/serialization/json/JsonBencSerializer.c" 2
...
# 30 "benc/serialization/json/JsonBencSerializer.c" 2
# 1 "/usr/share/mingw-w64/include/errno.h" 1 3
# 31 "benc/serialization/json/JsonBencSerializer.c" 2


# 32 "benc/serialization/json/JsonBencSerializer.c"
...
# 57 "benc/serialization/json/JsonBencSerializer.c"
                               ...
                               const String* string)
{
    ...
    for (i = 0; i < string->len; i++) {
        ...
        if (chr < 126 && chr > 31 && chr != '\\' && chr != '"') {
            ...
            ((writer)->write((writer), (buffer), (1)));
        } else {
            snprintf(buffer, 5, "\\x%.2X", chr);
            ((writer)->write((writer), (buffer), (4)));
        }
    }
...
static inline int readUntil(uint8_t target, struct Reader* reader)
{
    uint8_t nextChar;
    do {
        if ((reader)->read((reader), ((char*)&nextChar), (1))) {
                              ...
                              String** output)
{
    ...
    int curSize = (1<<8);
    struct Allocator* localAllocator = Allocator__child((allocator),"JsonBencSerializer.c",114);
    uint8_t* buffer = Allocator__malloc((localAllocator),(curSize),"JsonBencSerializer.c",115);
    if (readUntil('"', reader) || (reader)->read((reader), (buffer), (1))) {
        printf("Unterminated string\n");
        Allocator__free((localAllocator),"JsonBencSerializer.c",118);
        return outOfContent();
    }
    for (int i = 0; i < (1<<20) - 1; i++) {
        if (buffer[i] == '\\') {
            ...
            uint8_t hex[2];
            if ((reader)->read((reader), ((char*)hex), (2))) {
                printf("Unexpected end of input parsing escape sequence\n");
                Allocator__free((localAllocator),"JsonBencSerializer.c",128);
                return outOfContent();
            }
            int byte = Hex_decodeByte(hex[0], hex[1]);
            if (byte == -1) {
                printf("Invalid escape \"%c%c\" after \"%.*s\"\n",hex[0],hex[1],i+1,buffer);
                Allocator__free((localAllocator),"JsonBencSerializer.c",134);
                return unparsable();
            }
            buffer[i] = (uint8_t) byte;
        } else if (buffer[i] == '"') {
            *output = String_newBinary((char*)buffer, i, allocator);
            Allocator__free((localAllocator),"JsonBencSerializer.c",140);
            return 0;
        }
        if (i == curSize - 1) {
            curSize <<= 1;
            buffer = Allocator__realloc((localAllocator),(buffer),(curSize),"JsonBencSerializer.c",145);
        }
        if ((reader)->read((reader), (buffer + i + 1), (1))) {
            if (i+1 <= 20) {
                printf("Unterminated string \"%.*s\"\n", i+1, buffer);
            } else {
                printf("Unterminated string starting with \"%.*s...\"\n", 20, buffer);
            }
            Allocator__free((localAllocator),"JsonBencSerializer.c",153);
            return outOfContent();
        }
    }

    printf("Maximum string length of %d bytes exceeded.\n",(1<<8));
    Allocator__free((localAllocator),"JsonBencSerializer.c",159);
    return unparsable();
                                ...
                                int64_t integer)
{
    ...
    snprintf(buffer, 32, "%" 
# 173 "benc/serialization/json/JsonBencSerializer.c" 3
                            "I64d"
# 173 "benc/serialization/json/JsonBencSerializer.c"
                                  , integer);

    return ((writer)->write((writer), (buffer), (CString_strlen(buffer))));
}
                            ...
                            int64_t* output)
{
    ...
    for (int i = 0; i < 21; i++) {
        int32_t status = (reader)->read((reader), (buffer + i), (0));
        if (i == 0 && buffer[i] == '-' && status == 0) {

            continue;
        }
        if (buffer[i] < '0' || buffer[i] > '9' || status != 0 ) {
            buffer[i] = '\0';
            int64_t out = strtol((char*)buffer, 
# 192 "benc/serialization/json/JsonBencSerializer.c" 3 4
                                               ((void *)0)
# 192 "benc/serialization/json/JsonBencSerializer.c"
                                                   , 10);
            ...
            if ((out == 
# 198 "benc/serialization/json/JsonBencSerializer.c" 3 4
                       9223372036854775807LL 
# 198 "benc/serialization/json/JsonBencSerializer.c"
                                 || out == 
# 198 "benc/serialization/json/JsonBencSerializer.c" 3 4
...
# 198 "benc/serialization/json/JsonBencSerializer.c"
                                                               == 
# 198 "benc/serialization/json/JsonBencSerializer.c" 3
                                                                  34
# 198 "benc/serialization/json/JsonBencSerializer.c"
                                                                        ) {
...
# 221 "benc/serialization/json/JsonBencSerializer.c"
                                        ...
                                        const List* list)
{
    ...
    while (entry != 
# 230 "benc/serialization/json/JsonBencSerializer.c" 3 4
                   ((void *)0)
# 230 "benc/serialization/json/JsonBencSerializer.c"
                       ) {
        padCounter = 0; while (32 < padSpaceCount + 2 + padCounter) { ((writer)->write((writer), (thirtyTwoSpaces), (32))); padCounter += 32; } ((writer)->write((writer), (thirtyTwoSpaces), (padSpaceCount + 2 - padCounter)));
        serializeGenericWithPadding(writer, padSpaceCount + 2, entry->elem);
        entry = entry->next;
        if (entry != 
# 234 "benc/serialization/json/JsonBencSerializer.c" 3 4
                    ((void *)0)
# 234 "benc/serialization/json/JsonBencSerializer.c"
                        ) {
            ((writer)->write((writer), (",\n"), (2)));
        }
    }
    ...
    ((writer)->write((writer), ("\n"), (1)));
    padCounter = 0; while (32 < padSpaceCount + padCounter) { ((writer)->write((writer), (thirtyTwoSpaces), (32))); padCounter += 32; } ((writer)->write((writer), (thirtyTwoSpaces), (padSpaceCount - padCounter)));
    return ((writer)->write((writer), ("]"), (1)));
}
...
{
    char chars[2];
    int ret = (reader)->read((reader), (&chars), (2));
    if (ret) {
    ...
    switch (chars[1]) {
        case '*':;
            do {
                readUntil('*', reader);
            } while (!(ret = (reader)->read((reader), (&chars), (1))) && chars[0] != '/');
            if (ret) {
                         ...
                         List* output)
{
    ...
    Object* element;
    struct List_Item* thisEntry = 
# 295 "benc/serialization/json/JsonBencSerializer.c" 3 4
                                 ((void *)0)
# 295 "benc/serialization/json/JsonBencSerializer.c"
                                     ;
    ...
    for (;;) {
        for (;;) {
            if ((reader)->read((reader), (&nextChar), (0)) != 0) {
        ...
        thisEntry = Allocator__malloc((allocator),(sizeof(struct List_Item)),"JsonBencSerializer.c",343);
        thisEntry->elem = element;
        thisEntry->next = 
# 345 "benc/serialization/json/JsonBencSerializer.c" 3 4
                         ((void *)0)
# 345 "benc/serialization/json/JsonBencSerializer.c"
                             ;
...
# 360 "benc/serialization/json/JsonBencSerializer.c"
                                              ...
                                              const Dict* dictionary)
{
    ...
    while (entry != 
# 367 "benc/serialization/json/JsonBencSerializer.c" 3 4
                   ((void *)0)
# 367 "benc/serialization/json/JsonBencSerializer.c"
                       ) {
        padCounter = 0; while (32 < padSpaceCount + 2 + padCounter) { ((writer)->write((writer), (thirtyTwoSpaces), (32))); padCounter += 32; } ((writer)->write((writer), (thirtyTwoSpaces), (padSpaceCount + 2 - padCounter)));
        serializeString(writer, entry->key);
        ((writer)->write((writer), (" : "), (3)));
        serializeGenericWithPadding(writer, padSpaceCount + 2, entry->val);
        entry = entry->next;
        if (entry != 
# 373 "benc/serialization/json/JsonBencSerializer.c" 3 4
                    ((void *)0)
# 373 "benc/serialization/json/JsonBencSerializer.c"
                        ) {
            ((writer)->write((writer), (",\n"), (2)));
        }
    }
...
# 400 "benc/serialization/json/JsonBencSerializer.c" 3 4
                              ((void *)0)
# 400 "benc/serialization/json/JsonBencSerializer.c"
                                  ;
    struct Dict_Entry* last = 
# 401 "benc/serialization/json/JsonBencSerializer.c" 3 4
                             ((void *)0)
# 401 "benc/serialization/json/JsonBencSerializer.c"
                                 ;
    int ret = 0;

    for (;;) {
        while (!ret) {
            ret = (reader)->read((reader), (&nextChar), (0));
            switch (nextChar) {
                case '"':
                    break;
        ...
        struct Dict_Entry* entry = Allocator__calloc((allocator),(sizeof(struct Dict_Entry)),(1),"JsonBencSerializer.c",443);
        entry->key = key;
        entry->val = value;
        if (last) {
            last->next = entry;
                            ...
                            Object** output)
{
    ...
    for (;;) {
        ret = (reader)->read((reader), (&firstChar), (0));
        switch (firstChar) {
            case ' ':
            case '\r':
            case '\n':
    ...
    Object* out = Allocator__malloc((allocator),(sizeof(Object)),"JsonBencSerializer.c",488);
    ...
    switch (firstChar) {
        ...
        case '[':;
            ...
            List* list = Allocator__calloc((allocator),(sizeof(List)),(1),"JsonBencSerializer.c",512);
        ...
        case '{':;
            ...
            Dict* dict = Allocator__calloc((allocator),(sizeof(Dict)),(1),"JsonBencSerializer.c",520);
        ...
        case '"':;
            ...
            String* string = 
# 528 "benc/serialization/json/JsonBencSerializer.c" 3 4
                            ((void *)0)
# 528 "benc/serialization/json/JsonBencSerializer.c"
                                ;
...
# 558 "benc/serialization/json/JsonBencSerializer.c"
static int32_t serializeGenericWithPadding(struct Writer* writer,
                                           size_t padSpaceCount,
                                           const Object* obj)
{

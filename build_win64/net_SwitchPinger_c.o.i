...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x00410281958883294;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x02077965354940079;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x046107663767700036;
...
struct Linker_x09611885821801334;
...
struct Linker_x03455412517187755;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x06444148736482407;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x0005340072555664488;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07635876684338196;
...
struct Linker_x04297542403177468;
...
struct Linker_x06643999829082092;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x045461980865467644;
...
struct Linker_x021251233466454367;
...
struct Linker_x07131595160602813;
...
# 1 "./util/Pinger.h" 1
# 24 "./util/Pinger.h"
struct Linker_x008127985439331531;
# 50 "./util/Pinger.h"
struct Pinger;
...
struct Linker_x039856588974992624;
...
{
    struct SwitchPinger_pvt* ctx = (__extension__ ({ __typeof__((struct SwitchPinger_pvt*) iface) Identity_ptr = ((struct SwitchPinger_pvt*) iface); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (84), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));
    struct RouteHeader rh;
    Message_pop(msg, &rh, (56 + 12), 
# 86 "net/SwitchPinger.c" 3 4
                                           ((void *)0)
# 86 "net/SwitchPinger.c"
                                               );
    ...
    if (ctrl->header.type_be == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(4))); _x >> 8 | _x << 8; })))) {
        Message_shift(msg, -4, 
# 92 "net/SwitchPinger.c" 3 4
                                                ((void *)0)
# 92 "net/SwitchPinger.c"
                                                    );
        ctx->error = 0;
        if (msg->length >= 8) {
...
# 99 "net/SwitchPinger.c"
            ...
            Message_shift(msg, -8, 
# 101 "net/SwitchPinger.c" 3 4
                                                         ((void *)0)
# 101 "net/SwitchPinger.c"
                                                             );
        } else {
...
# 104 "net/SwitchPinger.c"
        ...
        Message_shift(msg, -4, 
# 108 "net/SwitchPinger.c" 3 4
                                                ((void *)0)
# 108 "net/SwitchPinger.c"
                                                    );
        ctx->error = 0;
...
# 118 "net/SwitchPinger.c" 3 4
                                                            ((void *)0)
# 118 "net/SwitchPinger.c"
                                                                );
...
# 124 "net/SwitchPinger.c"
        ...
        Message_shift(msg, -4, 
# 128 "net/SwitchPinger.c" 3 4
                                                ((void *)0)
# 128 "net/SwitchPinger.c"
                                                    );
        ctx->error = 0;
        if (msg->length < 56) {
...
# 141 "net/SwitchPinger.c"
        ...
        Message_shift(msg, -56, 
# 150 "net/SwitchPinger.c" 3 4
                                                         ((void *)0)
# 150 "net/SwitchPinger.c"
                                                             );

    } else if (ctrl->header.type_be == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(2))); _x >> 8 | _x << 8; })))) {
        Message_shift(msg, -4, 
# 153 "net/SwitchPinger.c" 3 4
                                                ((void *)0)
# 153 "net/SwitchPinger.c"
                                                    );
...
# 157 "net/SwitchPinger.c"
        ...
        ctx->error = Message_pop32(msg, 
# 160 "net/SwitchPinger.c" 3 4
                                       ((void *)0)
# 160 "net/SwitchPinger.c"
                                           );
        Message_push32(msg, 0, 
# 161 "net/SwitchPinger.c" 3 4
                              ((void *)0)
# 161 "net/SwitchPinger.c"
                                  );

        Message_shift(msg, -(4 + 12), 
# 163 "net/SwitchPinger.c" 3 4
                                                                            ((void *)0)
# 163 "net/SwitchPinger.c"
                                                                                );
        ...
        Message_shift(msg, shift, 
# 182 "net/SwitchPinger.c" 3 4
                                 ((void *)0)
# 182 "net/SwitchPinger.c"
                                     );
...
{
    struct Ping* p = (__extension__ ({ __typeof__((struct Ping*) vping) Identity_ptr = ((struct Ping*) vping); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (197), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Ping* p = (__extension__ ({ __typeof__((struct Ping*) sendPingContext) Identity_ptr = ((struct Ping*) sendPingContext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (232), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));

    struct Message* msg = Message_new(0, data->len + 512, p->pub.pingAlloc);

    while (((uintptr_t)msg->bytes - data->len) % 4) {
        Message_push8(msg, 0, 
# 237 "net/SwitchPinger.c" 3 4
                             ((void *)0)
# 237 "net/SwitchPinger.c"
                                 );
    }
    msg->length = 0;

    Message_push(msg, data->bytes, data->len, 
# 241 "net/SwitchPinger.c" 3 4
                                             ((void *)0)
# 241 "net/SwitchPinger.c"
                                                 );
    ...
    if (p->pub.type == SwitchPinger_Type_KEYPING) {
        Message_push(msg, 
# 245 "net/SwitchPinger.c" 3 4
                         ((void *)0)
# 245 "net/SwitchPinger.c"
                             , 40, 
# 245 "net/SwitchPinger.c" 3 4
                                                            ((void *)0)
# 245 "net/SwitchPinger.c"
        ...
        Message_push(msg, 
# 251 "net/SwitchPinger.c" 3 4
                         ((void *)0)
# 251 "net/SwitchPinger.c"
                             , 8, 
# 251 "net/SwitchPinger.c" 3 4
                                                         ((void *)0)
# 251 "net/SwitchPinger.c"
        ...
        Message_push(msg, 
# 256 "net/SwitchPinger.c" 3 4
                         ((void *)0)
# 256 "net/SwitchPinger.c"
                             , 56, 
# 256 "net/SwitchPinger.c" 3 4
                                                             ((void *)0)
# 256 "net/SwitchPinger.c"
    ...
    Message_shift(msg, 4, 
# 269 "net/SwitchPinger.c" 3 4
                                           ((void *)0)
# 269 "net/SwitchPinger.c"
                                               );
    struct Control* ctrl = (struct Control*) msg->bytes;
...
# 289 "net/SwitchPinger.c" 3 4
                                            ((void *)0)
# 289 "net/SwitchPinger.c"
                                                );
...
{
    struct Ping* ping = (__extension__ ({ __typeof__((struct Ping*)job->userData) Identity_ptr = ((struct Ping*)job->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (330), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));
    struct SwitchPinger_pvt* ctx = (__extension__ ({ __typeof__(ping->context) Identity_ptr = (ping->context); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (331), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));
...
{
    struct SwitchPinger_pvt* ctx = (__extension__ ({ __typeof__((struct SwitchPinger_pvt*)context) Identity_ptr = ((struct SwitchPinger_pvt*)context); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SwitchPinger.c"), (344), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xa4c70d0457219183ull))"); } } while (0); Identity_ptr; }));
...
# 367 "net/SwitchPinger.c"
       ;
    (ping)->Identity_verifier = ((unsigned long) 0xa4c70d0457219183ull);
...
# 395 "net/SwitchPinger.c"
                                        ;
    (sp)->Identity_verifier = ((unsigned long) 0xa4c70d0457219183ull);
    return &sp->pub;
}

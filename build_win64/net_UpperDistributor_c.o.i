...
struct Linker_x07912878301083028;
...
struct Linker_x07441203052246563;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06161042183979668;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08796255601129592;
...
struct Linker_x02547507322590088;
...
struct Linker_x05843793513666247;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x019729338544939035;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09795279027453094;
...
struct Linker_x09344339193437403;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x002151180029494948;
...
struct Linker_x09785056229755105;
...
struct Linker_x08469288491083897;
...
struct Linker_x02891647706994447;
...
struct Linker_x07538038121873982;
...
# 21 "./util/ArrayList.h"
struct Linker_x09660663004269994;
...
struct Linker_x000012377394913221096;
...
struct Linker_x0021892310429425077;
...
struct Linker_x07899969985828164;
...
{
    Message_pop(msg, 
# 59 "net/UpperDistributor.c" 3 4
                    ((void *)0)
# 59 "net/UpperDistributor.c"
                        , (56 + 12), 
# 59 "net/UpperDistributor.c" 3 4
                                            ((void *)0)
# 59 "net/UpperDistributor.c"
    ...
    Message_pop(msg, &dh, 4, 
# 61 "net/UpperDistributor.c" 3 4
                                          ((void *)0)
# 61 "net/UpperDistributor.c"
                                              );
...
# 88 "net/UpperDistributor.c"
    ...
    Message_pop(msg, 
# 90 "net/UpperDistributor.c" 3 4
                    ((void *)0)
# 90 "net/UpperDistributor.c"
                        , 8, 
# 90 "net/UpperDistributor.c" 3 4
                                                  ((void *)0)
# 90 "net/UpperDistributor.c"
                           ...
                           struct UpperDistributor_pvt* ud)
{
    ...
    for (int i = 0; i < (int)ud->handlers->count; i++) {
...

        {
            ...
            udpH.checksum_be = 0;
            Message_push(cmsg, &udpH, 8, 
# 122 "net/UpperDistributor.c" 3 4
                                                             ((void *)0)
# 122 "net/UpperDistributor.c"
                                                                 );
        ...
        }
        {
            ...
            Message_push(cmsg, &dh, 4, 
# 133 "net/UpperDistributor.c" 3 4
                                                    ((void *)0)
# 133 "net/UpperDistributor.c"
                                                        );
        }
        {
            ...
            Message_push(cmsg, &rh, (56 + 12), 
# 141 "net/UpperDistributor.c" 3 4
                                                     ((void *)0)
# 141 "net/UpperDistributor.c"
                                                         );
        }
...
# 162 "net/UpperDistributor.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (162), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; })); }));
    uint32_t messageType = Message_pop32(msg, 
# 163 "net/UpperDistributor.c" 3 4
                                             ((void *)0)
# 163 "net/UpperDistributor.c"
                                                 );
    do { if (!((messageType == PFChan_Pathfinder_SENDMSG || messageType == PFChan_Pathfinder_CTRL_SENDMSG))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (164), "(messageType == PFChan_Pathfinder_SENDMSG || messageType == PFChan_Pathfinder_CTRL_SENDMSG)"); } } while (0)
                                                      ;
    Message_pop32(msg, 
# 166 "net/UpperDistributor.c" 3 4
                      ((void *)0)
# 166 "net/UpperDistributor.c"
                          );
...
# 173 "net/UpperDistributor.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (173), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; })); }));
...
# 187 "net/UpperDistributor.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (187), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; })); }));
    return toSessionManagerIf(msg, ud);
}
...
# 194 "net/UpperDistributor.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (194), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; })); }));
...
# 206 "net/UpperDistributor.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (206), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; })); }));
...
# 222 "net/UpperDistributor.c" 3 4
                                       ((void *)0)
# 222 "net/UpperDistributor.c"
                                           );
        Message_push32(msg, PFChan_Core_MSG, 
# 223 "net/UpperDistributor.c" 3 4
                                            ((void *)0)
# 223 "net/UpperDistributor.c"
                                                );
...
{
    struct UpperDistributor_pvt* ud = (__extension__ ({ __typeof__((struct UpperDistributor_pvt*) upper) Identity_ptr = ((struct UpperDistributor_pvt*) upper); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (235), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; }));
    int index = Map_OfHandlers_indexForKey(&udpPort, ud->handlers);
    if (index < 0) {
        return -1;
    }
...
int UpperDistributor_listHandlers(struct UpperDistributor* ud,
                                  ...
                                  struct Allocator* alloc)
{
    struct UpperDistributor_pvt* udp = (__extension__ ({ __typeof__((struct UpperDistributor_pvt*) ud) Identity_ptr = ((struct UpperDistributor_pvt*) ud); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (250), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; }));
...
int UpperDistributor_registerHandler(struct UpperDistributor* upper,
                                     ...
                                     int udpPort)
{
    struct UpperDistributor_pvt* ud = (__extension__ ({ __typeof__((struct UpperDistributor_pvt*) upper) Identity_ptr = ((struct UpperDistributor_pvt*) upper); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UpperDistributor.c"), (267), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf3981774ab3a1fe4ull))"); } } while (0); Identity_ptr; }));
                                              ...
                                              struct Address* myAddress)
{
    ...
    (out)->Identity_verifier = ((unsigned long) 0xf3981774ab3a1fe4ull);

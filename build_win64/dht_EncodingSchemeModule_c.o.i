...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x032676356923469285;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05225974629451284;
...
struct Linker_x04304971467592309;
...
struct Linker_x06918608301376792;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04809625475902659;
...
struct Linker_x03955947630272989;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0024054182149800818;
...
struct Linker_x05592313010493455;
...
struct Linker_x08489972115900077;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x06193389411137129;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x006990673452112528;
...
struct Linker_x09242997591585151;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x044930948658276804;
...
struct Linker_x07348222448990276;
...
struct Linker_x08463435678296383;
...
struct Linker_x008727955305524948;
...
struct Linker_x02856943775289251;
...
static int handleIncoming(struct DHTMessage* message, void* vcontext)
{
    struct EncodingSchemeModule_pvt* ctx =
        (__extension__ ({ __typeof__((struct EncodingSchemeModule_pvt*) vcontext) Identity_ptr = ((struct EncodingSchemeModule_pvt*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xda3d5143018ba556ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EncodingSchemeModule.c"), (57), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xda3d5143018ba556ull))"); } } while (0); Identity_ptr; }));
...
{
    struct EncodingSchemeModule_pvt* ctx =
        (__extension__ ({ __typeof__((struct EncodingSchemeModule_pvt*) vcontext) Identity_ptr = ((struct EncodingSchemeModule_pvt*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xda3d5143018ba556ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EncodingSchemeModule.c"), (108), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xda3d5143018ba556ull))"); } } while (0); Identity_ptr; }));
...
# 147 "dht/EncodingSchemeModule.c"
           ;
    (ctx)->Identity_verifier = ((unsigned long) 0xda3d5143018ba556ull);

# 1 "dht/DHTModuleRegistry.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "dht/DHTModuleRegistry.c"
# 15 "dht/DHTModuleRegistry.c"
# 1 "./dht/DHTModule.h" 1
# 22 "./dht/DHTModule.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06482349962376497;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x009670083227596682;
...
struct Linker_x02216778567819062;
...
struct Linker_x021017137949664644;
...
struct DHTModuleRegistry* DHTModuleRegistry_new(struct Allocator* allocator)
{
    struct DHTModuleRegistry* reg =
        Allocator__calloc((allocator),(sizeof(struct DHTModuleRegistry)),(1),"DHTModuleRegistry.c",28);
    reg->allocator = allocator;
    reg->members = Allocator__calloc((allocator),(sizeof(char*)),(1),"DHTModuleRegistry.c",30);
    return reg;
}
...
int DHTModuleRegistry_register(struct DHTModule* module,
                               struct DHTModuleRegistry* registry)
{
    registry->members = Allocator__realloc((registry->allocator),(registry->members),(sizeof(char*) * (registry->memberCount + 2)),"DHTModuleRegistry.c",37)

                                                                                      ;

    registry->members[registry->memberCount] = module;
    registry->memberCount++;
    registry->members[registry->memberCount] = 
# 43 "dht/DHTModuleRegistry.c" 3 4
                                              ((void *)0)
# 43 "dht/DHTModuleRegistry.c"
                                                  ;
...
{
    do { if (!((module))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("DHTModuleRegistry.c"), (76), "(module)"); } } while (0);

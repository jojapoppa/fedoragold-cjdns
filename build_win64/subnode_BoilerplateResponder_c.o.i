# 1 "subnode/BoilerplateResponder.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "subnode/BoilerplateResponder.c"
# 15 "subnode/BoilerplateResponder.c"
# 1 "./subnode/BoilerplateResponder.h" 1
# 18 "./subnode/BoilerplateResponder.h"
# 1 "./benc/Dict.h" 1
# 18 "./benc/Dict.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03103668793126091;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x015054643485598018;
...
struct Linker_x040110557516988576;
...
# 19 "./subnode/BoilerplateResponder.h" 2
# 1 "./dht/Address.h" 1
# 18 "./dht/Address.h"
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x011858202895362102;
...
struct Linker_x006217272102354188;
...
struct Linker_x02613061436693733;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0279862056000981;
...
struct Linker_x005801011179018367;
...
struct Linker_x044042259262568817;
...
struct BoilerplateResponder* BoilerplateResponder_new(struct EncodingScheme* myScheme,
                                                      struct Allocator* alloc);
# 16 "subnode/BoilerplateResponder.c" 2
...
void BoilerplateResponder_addBoilerplate(struct BoilerplateResponder* br,
                                         ...
                                         struct Allocator* alloc)
{
    struct BoilerplateResponder_pvt* brp = (__extension__ ({ __typeof__((struct BoilerplateResponder_pvt*) br) Identity_ptr = ((struct BoilerplateResponder_pvt*) br); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6ec9ca98b697c88eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BoilerplateResponder.c"), (31), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6ec9ca98b697c88eull))"); } } while (0); Identity_ptr; }));
    Dict_putString(msgDict, String_new("es", alloc), brp->mySchemeStr, alloc);
    int encIdx = EncodingScheme_getFormNum(brp->myScheme, src->path);
    do { if (!((encIdx != -1))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BoilerplateResponder.c"), (34), "(encIdx != -1)"); } } while (0);
    Dict_putInt(msgDict, String_new("ei", alloc), encIdx, alloc);
}

struct BoilerplateResponder* BoilerplateResponder_new(struct EncodingScheme* myScheme,
                                                      struct Allocator* allocator)
{
    struct Allocator* alloc = Allocator__child((allocator),"BoilerplateResponder.c",41);
    struct BoilerplateResponder_pvt* brp =
        Allocator__calloc((alloc),(sizeof(struct BoilerplateResponder_pvt)),(1),"BoilerplateResponder.c",43);
    (brp)->Identity_verifier = ((unsigned long) 0x6ec9ca98b697c88eull);

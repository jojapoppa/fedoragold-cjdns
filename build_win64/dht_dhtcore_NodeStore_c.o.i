...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08620349563612228;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x04384772385532145;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x02877097307996468;
...
struct Linker_x023132258900628622;
...
struct Linker_x06766570542408485;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0582469713626586;
...
struct Linker_x06588180379190642;
...
struct Linker_x06774290191933559;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08221243867288941;
...
struct Linker_x09718949962728438;
...
struct Linker_x037775969496008943;
...
struct Linker_x04429154649277254;
...
# 19 "./util/AddrTools.h"
struct Linker_x09628873012408865;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x021612753345573799;
...
struct Linker_x05680340595898368;
...
struct Linker_x04471256240696906;
...
{
    (__extension__ ({ __typeof__(lb) Identity_ptr = (lb); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (76), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
{
    (__extension__ ({ __typeof__(nb) Identity_ptr = (nb); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (96), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    int ret;
...
void NodeStore_unlinkNodes(struct NodeStore* nodeStore, struct Node_Link* link)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*) nodeStore) Identity_ptr = ((struct NodeStore_pvt*) nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (486), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Two* child = (__extension__ ({ __typeof__(link->child) Identity_ptr = (link->child); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (487), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Two* parent = (__extension__ ({ __typeof__(link->parent) Identity_ptr = (link->parent); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (488), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    _verify(store, 
...
# 584 "dht/dhtcore/NodeStore.c"
       ; (link) = PeerRBTree_RB_PREV(link)) {
            (__extension__ ({ __typeof__(link) Identity_ptr = (link); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (585), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
            if (link->child == child) {
    ...
    if (1) {
        ...
        struct Node_Link* link = (__extension__ ({ __typeof__(PeerRBTree_RB_FIND(&parent->peerTree, &dummy)) Identity_ptr = (PeerRBTree_RB_FIND(&parent->peerTree, &dummy)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (606), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
        if (link) {
    ...
    (link)->Identity_verifier = ((unsigned long) 0x9c1a0b14553b7ce2ull);
                               ...
                               struct NodeStore_pvt* store)
{
    ...
    struct Node_Link* nextLink =
        (__extension__ ({ __typeof__(PeerRBTree_RB_NFIND(&parentLink->child->peerTree, &tmpl)) Identity_ptr = (PeerRBTree_RB_NFIND(&parentLink->child->peerTree, &tmpl)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (731), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));


    while (nextLink && !LabelSplicer_routesThrough(label, nextLink->cannonicalLabel)) {
        nextLink = (__extension__ ({ __typeof__(PeerRBTree_RB_NEXT(nextLink)) Identity_ptr = (PeerRBTree_RB_NEXT(nextLink)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (735), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    }
...
static struct Node_Two* nodeForIp(struct NodeStore_pvt* store, uint8_t ip[16])
{
    ...
    (&fakeNode)->Identity_verifier = ((unsigned long) 0x9c1a0b14553b7ce2ull);
    Bits__memcpy(fakeNode.address.ip6.bytes,ip,16,"NodeStore.c",808);
    return (__extension__ ({ __typeof__(NodeRBTree_RB_FIND(&store->nodeTree, &fakeNode)) Identity_ptr = (NodeRBTree_RB_FIND(&store->nodeTree, &fakeNode)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (809), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
}
...
struct NodeList* NodeStore_getNodesForBucket(struct NodeStore* nodeStore,
                                             ...
                                             const uint32_t count)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1120), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
# 1164 "dht/dhtcore/NodeStore.c"
    ...
    for (uint32_t i = 0; i < nodeList->size; i++) {
        ...
        (__extension__ ({ __typeof__(nodeList->nodes[i]) Identity_ptr = (nodeList->nodes[i]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1168), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
# 1253 "dht/dhtcore/NodeStore.c"
   ; (link) = PeerRBTree_RB_NEXT(link)) {
        (__extension__ ({ __typeof__(link) Identity_ptr = (link); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1254), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
# 1354 "dht/dhtcore/NodeStore.c"
    ...
    if (!child) {
        ...
        (child)->Identity_verifier = ((unsigned long) 0x9c1a0b14553b7ce2ull);
    }
...
struct Node_Link* NodeStore_discoverNode(struct NodeStore* nodeStore,
                                         ...
                                         uint64_t milliseconds)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1457), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    store->disarmCheck++;
...
struct Node_Two* NodeStore_nodeForAddr(struct NodeStore* nodeStore, uint8_t addr[16])
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1468), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
struct Node_Two* NodeStore_closestNode(struct NodeStore* nodeStore, uint64_t path)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1483), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Link* out = 
...
# 1486 "dht/dhtcore/NodeStore.c"
                          ; }
    return (__extension__ ({ __typeof__(out->child) Identity_ptr = (out->child); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1487), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
}

struct Node_Link* NodeStore_linkForPath(struct NodeStore* nodeStore, uint64_t path)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1492), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Link* out = 
...
# 1495 "dht/dhtcore/NodeStore.c"
                                          ; }
    return (__extension__ ({ __typeof__(out) Identity_ptr = (out); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1496), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
}
...
struct Node_Link* NodeStore_firstHopInPath(struct NodeStore* nodeStore,
                                           ...
                                           struct Node_Link* startingPoint)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1504), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
uint64_t NodeStore_getRouteLabel(struct NodeStore* nodeStore,
                                 ...
                                 uint64_t pathParentToChild)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1529), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
uint64_t NodeStore_optimizePath(struct NodeStore* nodeStore, uint64_t path)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1553), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Link* linkToParent;
...
# 1629 "dht/dhtcore/NodeStore.c"
       ;
    (out)->Identity_verifier = ((unsigned long) 0x9c1a0b14553b7ce2ull);
    ...
    (selfNode)->Identity_verifier = ((unsigned long) 0x9c1a0b14553b7ce2ull);
...
struct Node_Two* NodeStore_dumpTable(struct NodeStore* nodeStore, uint32_t index)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1661), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
struct Node_Link* NodeStore_getNextLink(struct NodeStore* nodeStore, struct Node_Link* last)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1673), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    struct Node_Two* nn;
    struct Node_Link* next;

    if (!last) {
        nn = (__extension__ ({ __typeof__(NodeRBTree_RB_MINMAX(&store->nodeTree, -1)) Identity_ptr = (NodeRBTree_RB_MINMAX(&store->nodeTree, -1)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1678), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
        next = 
...
# 1679 "dht/dhtcore/NodeStore.c"
        ...
        next = (__extension__ ({ __typeof__(PeerRBTree_RB_NEXT(last)) Identity_ptr = (PeerRBTree_RB_NEXT(last)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1681), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
        if (next) { return next; }
        nn = (__extension__ ({ __typeof__(NodeRBTree_RB_NEXT(last->parent)) Identity_ptr = (NodeRBTree_RB_NEXT(last->parent)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1683), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    }
...
# 1687 "dht/dhtcore/NodeStore.c"
                             ; }
        next = (__extension__ ({ __typeof__(PeerRBTree_RB_MINMAX(&nn->peerTree, -1)) Identity_ptr = (PeerRBTree_RB_MINMAX(&nn->peerTree, -1)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1688), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
        nn = (__extension__ ({ __typeof__(NodeRBTree_RB_NEXT(nn)) Identity_ptr = (NodeRBTree_RB_NEXT(nn)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1689), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    }
    return next;
}
...
struct Node_Two* NodeStore_getNextNode(struct NodeStore* nodeStore, struct Node_Two* lastNode)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1696), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    if (!lastNode) {
        return (__extension__ ({ __typeof__(NodeRBTree_RB_MINMAX(&store->nodeTree, -1)) Identity_ptr = (NodeRBTree_RB_MINMAX(&store->nodeTree, -1)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1698), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    }
    return (__extension__ ({ __typeof__(NodeRBTree_RB_NEXT(lastNode)) Identity_ptr = (NodeRBTree_RB_NEXT(lastNode)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1700), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
}
...
struct Node_Two* NodeStore_getBest(struct NodeStore* nodeStore, uint8_t targetAddress[16])
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1745), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1769), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
# 1784 "dht/dhtcore/NodeStore.c"
    ...
    for (int i = 0; i < (int)out->size; i++) {
        (__extension__ ({ __typeof__(out->nodes[i]) Identity_ptr = (out->nodes[i]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1812), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
struct NodeList* NodeStore_getClosestNodes(struct NodeStore* nodeStore,
                                           ...
                                           struct Allocator* allocator)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1845), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    ...
    struct Node_Two* next = (__extension__ ({ __typeof__(NodeRBTree_RB_NFIND(&store->nodeTree, &fakeNode)) Identity_ptr = (NodeRBTree_RB_NFIND(&store->nodeTree, &fakeNode)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1854), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    if (!next) {
        next = (__extension__ ({ __typeof__(NodeRBTree_RB_MINMAX(&store->nodeTree, 1)) Identity_ptr = (NodeRBTree_RB_MINMAX(&store->nodeTree, 1)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1856), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    }
    if (!next) {
        out->size = 0;
        return out;
    ...
    struct Node_Two* prev = (__extension__ ({ __typeof__(NodeRBTree_RB_PREV(next)) Identity_ptr = (NodeRBTree_RB_PREV(next)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1863), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    int idx = out->size-1;
    ...
    while (idx > -1) {
        if (prev && (!next || Address_closest(targetAddress, &next->address, &prev->address) > 0)) {
            ...
            prev = (__extension__ ({ __typeof__(NodeRBTree_RB_PREV(prev)) Identity_ptr = (NodeRBTree_RB_PREV(prev)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1869), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
            continue;
        }
        if (next && (!prev || Address_closest(targetAddress, &next->address, &prev->address) < 0)) {
            ...
            next = (__extension__ ({ __typeof__(NodeRBTree_RB_NEXT(next)) Identity_ptr = (NodeRBTree_RB_NEXT(next)); do { if (!((!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1874), "(!Identity_ptr || Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
            continue;
        }
        break;
    }
    ...
    for (int i = 0; i < (int)out->size; i++) {
        (__extension__ ({ __typeof__(out->nodes[i]) Identity_ptr = (out->nodes[i]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1884), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
void NodeStore_disconnectedPeer(struct NodeStore* nodeStore, uint64_t path)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1894), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (1922), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    if (1) {
        uint8_t pathStr[20];
...
void NodeStore_pathResponse(struct NodeStore* nodeStore, uint64_t path, uint64_t milliseconds)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (2043), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
void NodeStore_pathTimeout(struct NodeStore* nodeStore, uint64_t path)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (2067), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
uint64_t NodeStore_timeSinceLastPing(struct NodeStore* nodeStore, struct Node_Two* node)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (2137), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
    uint64_t now = Time_currentTimeMilliseconds(store->eventBase);
...
# 2148 "dht/dhtcore/NodeStore.c"
    NodeStore_getFullVerify(struct NodeStore* nodeStore)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (2150), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));
...
# 2154 "dht/dhtcore/NodeStore.c"
                                                              fullVerify)
{
    struct NodeStore_pvt* store = (__extension__ ({ __typeof__((struct NodeStore_pvt*)nodeStore) Identity_ptr = ((struct NodeStore_pvt*)nodeStore); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("NodeStore.c"), (2156), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9c1a0b14553b7ce2ull))"); } } while (0); Identity_ptr; }));

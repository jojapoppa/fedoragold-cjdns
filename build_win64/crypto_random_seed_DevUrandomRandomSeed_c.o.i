# 1 "crypto/random/seed/DevUrandomRandomSeed.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "crypto/random/seed/DevUrandomRandomSeed.c"
# 15 "crypto/random/seed/DevUrandomRandomSeed.c"
# 1 "./crypto/random/seed/DevUrandomRandomSeed.h" 1
# 18 "./crypto/random/seed/DevUrandomRandomSeed.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x09165993831050938;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05118356133900785;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0025713510316189403;
...
struct Linker_x04481180981556925;
...
# 19 "./crypto/random/seed/DevUrandomRandomSeed.h" 2
# 1 "./crypto/random/seed/RandomSeedProvider.h" 1
# 18 "./crypto/random/seed/RandomSeedProvider.h"

# 20 "./crypto/random/seed/DevUrandomRandomSeed.h" 2




    struct Linker_x05978520125630584;
    struct RandomSeed* DevUrandomRandomSeed_new(struct Allocator* alloc);
    
# 16 "crypto/random/seed/DevUrandomRandomSeed.c" 2

# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x001210727681996926;
...
# 18 "crypto/random/seed/DevUrandomRandomSeed.c" 2
...
# 82 "/usr/share/mingw-w64/include/sys/types.h" 2 3
...
# 20 "crypto/random/seed/DevUrandomRandomSeed.c" 2
# 1 "/usr/share/mingw-w64/include/sys/stat.h" 1 3
# 14 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
#pragma pack(pop)
# 15 "/usr/share/mingw-w64/include/sys/stat.h" 2 3

#pragma pack(push,_CRT_PACKING)
# 58 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
# 59 "/usr/share/mingw-w64/include/sys/stat.h" 2 3
# 69 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
# 97 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
# 126 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
# 174 "/usr/share/mingw-w64/include/sys/stat.h" 3
int __attribute__((__cdecl__)) fstat(int _Desc,struct stat *_Stat);
# 185 "/usr/share/mingw-w64/include/sys/stat.h" 3
...
# 288 "/usr/share/mingw-w64/include/sys/stat.h" 3
#pragma pack(pop)
# 21 "crypto/random/seed/DevUrandomRandomSeed.c" 2
# 1 "/usr/share/mingw-w64/include/fcntl.h" 1 3
# 22 "crypto/random/seed/DevUrandomRandomSeed.c" 2
# 1 "/usr/share/mingw-w64/include/unistd.h" 1 3
# 11 "/usr/share/mingw-w64/include/unistd.h" 3
...
# 23 "crypto/random/seed/DevUrandomRandomSeed.c" 2
# 1 "/usr/share/mingw-w64/include/errno.h" 1 3
# 24 "crypto/random/seed/DevUrandomRandomSeed.c" 2





# 28 "crypto/random/seed/DevUrandomRandomSeed.c"
static int get(struct RandomSeed* randomSeed, uint64_t output[8])
{
    __builtin_memset(output,0,64);
    int fd = -1;
    int tries = 0;
    while ((fd = open("/dev/urandom", 
# 33 "crypto/random/seed/DevUrandomRandomSeed.c" 3
                                     0x0000
# 33 "crypto/random/seed/DevUrandomRandomSeed.c"
                                             , 0)) < 0) {
        if (++tries > 10 || 
# 34 "crypto/random/seed/DevUrandomRandomSeed.c" 3 4
                                  (*_errno()) 
# 34 "crypto/random/seed/DevUrandomRandomSeed.c"
                                        != 
# 34 "crypto/random/seed/DevUrandomRandomSeed.c" 3
                                           4
# 34 "crypto/random/seed/DevUrandomRandomSeed.c"
                                                ) {
            return -1;
...
struct RandomSeed* DevUrandomRandomSeed_new(struct Allocator* alloc)
{
    return Allocator__clone((alloc),((&(struct RandomSeed) { .get = get, .name = "/dev/urandom" })),sizeof(*((&(struct RandomSeed) { .get = get, .name = "/dev/urandom" }))),"DevUrandomRandomSeed.c",63)

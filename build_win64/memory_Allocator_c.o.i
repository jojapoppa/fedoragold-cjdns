...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05860754421627268;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x000333302490340448;
...
# 18 "memory/Allocator.c" 2
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x06580115260641044;
...
# 19 "memory/Allocator.c" 2
# 1 "./util/Defined.h" 1
# 20 "memory/Allocator.c" 2
...
static void writeUnroller(const struct Unroller* unroller)
{
    if (unroller) {
        ...
        fprintf(
# 34 "memory/Allocator.c" 3
               (__acrt_iob_func(2))
# 34 "memory/Allocator.c"
                     , "%s", unroller->content);
    }
}
                   ...
                   struct Unroller* unroller)
{
    ...
    fprintf(
# 44 "memory/Allocator.c" 3
           (__acrt_iob_func(2))
# 44 "memory/Allocator.c"
                 , "%s:%d [%lu] bytes%s\n",
            ident,
            context->pub.lineNum,
    ...
    while (allocation && includeAllocations) {
        ...
        fprintf(
# 60 "memory/Allocator.c" 3
               (__acrt_iob_func(2))
# 60 "memory/Allocator.c"
...
static void check(struct Allocator_pvt* alloc)
{
    ...
    uint64_t accounted = bytesAllocated((__extension__ ({ __typeof__((struct Allocator_pvt*)alloc->rootAlloc) Identity_ptr = ((struct Allocator_pvt*)alloc->rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (85), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; })));
    do { if (!((totalAllocated == accounted))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (86), "(totalAllocated == accounted)"); } } while (0);
}

void Allocator_snapshot(struct Allocator* allocator, int includeAllocations)
{

    struct Allocator_pvt* alloc = (__extension__ ({ __typeof__((struct Allocator_pvt*)allocator) Identity_ptr = ((struct Allocator_pvt*)allocator); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (92), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    struct Allocator_FirstCtx* rootAlloc = (__extension__ ({ __typeof__(alloc->rootAlloc) Identity_ptr = (alloc->rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (93), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    alloc = (__extension__ ({ __typeof__((struct Allocator_pvt*)rootAlloc) Identity_ptr = ((struct Allocator_pvt*)rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (94), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));

    fprintf(
# 96 "memory/Allocator.c" 3
           (__acrt_iob_func(2))
# 96 "memory/Allocator.c"
...
# 107 "memory/Allocator.c"
    ...
    fprintf(
# 111 "memory/Allocator.c" 3
           (__acrt_iob_func(2))
# 111 "memory/Allocator.c"
                 , "----- %scjdns memory snapshot -----\n", "end ");
}
                                  ...
                                  int lineNum)
{
    ...
    struct Allocator_FirstCtx* rootAlloc = (__extension__ ({ __typeof__(context->rootAlloc) Identity_ptr = (context->rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (162), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
# 172 "memory/Allocator.c" 3 4
                           ((void *)0)
# 172 "memory/Allocator.c"
                               ,
                            realSize,
                            &context->pub);
    if (alloc == 
# 175 "memory/Allocator.c" 3 4
                ((void *)0)
# 175 "memory/Allocator.c"
                    ) {
...
struct Allocator_Allocation* Allocator_getAllocation(struct Allocator* alloc, int allocNum)
{
    struct Allocator_pvt* ctx = (__extension__ ({ __typeof__((struct Allocator_pvt*)alloc) Identity_ptr = ((struct Allocator_pvt*)alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (190), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    if (allocNum < 0) {
        return 
# 192 "memory/Allocator.c" 3 4
              ((void *)0)
# 192 "memory/Allocator.c"
                  ;
    }
...
struct Allocator* Allocator_getChild(struct Allocator* alloc, int childNumber)
{
    struct Allocator_pvt* ctx = (__extension__ ({ __typeof__((struct Allocator_pvt*)alloc) Identity_ptr = ((struct Allocator_pvt*)alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (203), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    if (childNumber < 0) {
        return 
# 205 "memory/Allocator.c" 3 4
              ((void *)0)
# 205 "memory/Allocator.c"
                  ;
    }
...
{
    struct Allocator_pvt* context = (__extension__ ({ __typeof__(job->alloc) Identity_ptr = (job->alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (216), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
# 247 "memory/Allocator.c" 3 4
                                                                    ((void *)0)
# 247 "memory/Allocator.c"
                                                                        );
}
                          ...
                          void* providerCtx)
{
    ...
    (__extension__ ({ __typeof__(context->rootAlloc) Identity_ptr = (context->rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (259), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }))->spaceAvailable += context->allocatedHere;

    struct Allocator_Allocation_pvt* loc = context->allocations;
    while (loc != 
# 262 "memory/Allocator.c" 3 4
                 ((void *)0)
# 262 "memory/Allocator.c"
                     ) {
...
{
    do { if (!((child->parent == 
# 307 "memory/Allocator.c" 3 4
   ((void *)0)
# 307 "memory/Allocator.c"
   ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (307), "(child->parent == ((void *)0))"); } } while (0);
    do { if (!((child->lastSibling == 
# 308 "memory/Allocator.c" 3 4
   ((void *)0)
# 308 "memory/Allocator.c"
   ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (308), "(child->lastSibling == ((void *)0))"); } } while (0);
    do { if (!((child->nextSibling == 
# 309 "memory/Allocator.c" 3 4
   ((void *)0)
# 309 "memory/Allocator.c"
   ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (309), "(child->nextSibling == ((void *)0))"); } } while (0);
    do { if (!((parent != child))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (310), "(parent != child)"); } } while (0);
    if (1) {
        for (struct Allocator_pvt* c = parent->firstChild; c; c = c->nextSibling) {
            do { if (!((child != c))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (313), "(child != c)"); } } while (0);
        }
    }
...
{
    do { if (!((context->pub.isFreeing))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (407), "(context->pub.isFreeing)"); } } while (0);
    struct Allocator_pvt* child = context->firstChild;
    while (child) {

        struct Allocator_OnFreeJob_pvt** jobP = &rootToFree->onFree;
        while (*jobP != 
# 412 "memory/Allocator.c" 3 4
                       ((void *)0)
# 412 "memory/Allocator.c"
                           ) {
        ...
        *jobP = child->onFree;
        child->onFree = 
# 417 "memory/Allocator.c" 3 4
                       ((void *)0)
# 417 "memory/Allocator.c"
                           ;

        while (*jobP != 
# 419 "memory/Allocator.c" 3 4
                       ((void *)0)
# 419 "memory/Allocator.c"
                           ) {
            struct Allocator_OnFreeJob_pvt* job = *jobP;
...
static void doOnFreeJobs(struct Allocator_pvt* context)
{
    ...
    while (*jobP != 
# 435 "memory/Allocator.c" 3 4
                   ((void *)0)
# 435 "memory/Allocator.c"
                       ) {
        struct Allocator_OnFreeJob_pvt* job = *jobP;
        if (!job->pub.callback) {

            do { if (!((!removeJob(job)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (439), "(!removeJob(job))"); } } while (0);
            continue;
        } else if (!job->called) {
            if (job->pub.callback(&job->pub) != 10000) {
                do { if (!((!removeJob(job)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (443), "(!removeJob(job))"); } } while (0);
                continue;
            } else {
                job->called = 1;
            }
...
{
    do { if (!((context->pub.isFreeing))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (455), "(context->pub.isFreeing)"); } } while (0);
    ...
    struct Allocator_FirstCtx* rootAlloc = (__extension__ ({ __typeof__(context->rootAlloc) Identity_ptr = (context->rootAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (469), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
void Allocator_onFreeComplete(struct Allocator_OnFreeJob* onFreeJob)
{
    ...
    struct Allocator_pvt* context = (__extension__ ({ __typeof__(job->alloc) Identity_ptr = (job->alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (482), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
void Allocator__free(struct Allocator* alloc, const char* file, int line)
{
    struct Allocator_pvt* context = (__extension__ ({ __typeof__((struct Allocator_pvt*) alloc) Identity_ptr = ((struct Allocator_pvt*) alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (496), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    check(context);
    ...
    if (context->rootAlloc == (struct Allocator_FirstCtx*)context) {
        struct Allocator_FirstCtx* rootAlloc = (__extension__ ({ __typeof__((struct Allocator_FirstCtx*)context) Identity_ptr = ((struct Allocator_FirstCtx*)context); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (505), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
void* Allocator__malloc(struct Allocator* allocator,
                        ...
                        int lineNum)
{
    struct Allocator_pvt* ctx = (__extension__ ({ __typeof__((struct Allocator_pvt*) allocator) Identity_ptr = ((struct Allocator_pvt*) allocator); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (528), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
{
    if (original == 
# 551 "memory/Allocator.c" 3 4
                   ((void *)0)
# 551 "memory/Allocator.c"
                       ) {
        return Allocator__malloc(allocator, size, fileName, lineNum);
    }

    struct Allocator_pvt* context = (__extension__ ({ __typeof__((struct Allocator_pvt*) allocator) Identity_ptr = ((struct Allocator_pvt*) allocator); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (555), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    check(context);
    ...
    for (;;) {
        ...
        if (loc == 
# 562 "memory/Allocator.c" 3 4
                  ((void *)0)
# 562 "memory/Allocator.c"
                      ) {
            failure(context,
    ...
    if (size == 0) {
        ...
        *locPtr = nextLoc;
        ...
        check(context);
        return 
# 588 "memory/Allocator.c" 3 4
              ((void *)0)
# 588 "memory/Allocator.c"
                  ;
    }
    ...
    if (alloc == 
# 614 "memory/Allocator.c" 3 4
                ((void *)0)
# 614 "memory/Allocator.c"
                    ) {
                       ...
                       int lineNum)
{
    ...
    Bits__memcpy(pointer,toClone,length,"Allocator.c",634);
    return pointer;
}

struct Allocator* Allocator__child(struct Allocator* allocator, const char* file, int line)
{
    struct Allocator_pvt* parent = (__extension__ ({ __typeof__((struct Allocator_pvt*) allocator) Identity_ptr = ((struct Allocator_pvt*) allocator); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (640), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    check(parent);
    ...
    (&stackChild)->Identity_verifier = ((unsigned long) 0x46cf106755e95d82ull);
    ...
    Bits__memcpy(child,&stackChild,sizeof(struct Allocator_pvt),"Allocator.c",658);
...
int Allocator_cancelOnFree(struct Allocator_OnFreeJob* toRemove)
{
    ...
    struct Allocator_pvt* context = (__extension__ ({ __typeof__(job->alloc) Identity_ptr = (job->alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (670), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    struct Allocator_OnFreeJob_pvt** jobPtr = &(context->onFree);
    while (*jobPtr != 
# 672 "memory/Allocator.c" 3 4
                     ((void *)0)
# 672 "memory/Allocator.c"
                         ) {
        if (*jobPtr == job) {
            *jobPtr = (*jobPtr)->next;
            return 0;
                        ...
                        struct Allocator_pvt* maybeChild)
{
    ...
    if (maybeParent == 
# 689 "memory/Allocator.c" 3 4
                      ((void *)0) 
# 689 "memory/Allocator.c"
                           || maybeChild == 
# 689 "memory/Allocator.c" 3 4
                                            ((void *)0) 
# 689 "memory/Allocator.c"
...
void Allocator__disown(struct Allocator* parentAlloc,
                       ...
                       int lineNum)
{
    struct Allocator_pvt* parent = (__extension__ ({ __typeof__((struct Allocator_pvt*) parentAlloc) Identity_ptr = ((struct Allocator_pvt*) parentAlloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (711), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    struct Allocator_pvt* child = (__extension__ ({ __typeof__((struct Allocator_pvt*) allocToDisown) Identity_ptr = ((struct Allocator_pvt*) allocToDisown); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (712), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
void Allocator__adopt(struct Allocator* adoptedParent,
                      ...
                      int line)
{
    struct Allocator_pvt* parent = (__extension__ ({ __typeof__((struct Allocator_pvt*) adoptedParent) Identity_ptr = ((struct Allocator_pvt*) adoptedParent); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (737), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    struct Allocator_pvt* child = (__extension__ ({ __typeof__((struct Allocator_pvt*) childToAdopt) Identity_ptr = ((struct Allocator_pvt*) childToAdopt); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (738), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));

    if (parent->pub.isFreeing) { return; }
    do { if (!((!child->pub.isFreeing))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (741), "(!child->pub.isFreeing)"); } } while (0);
...
struct Allocator_OnFreeJob* Allocator__onFree(struct Allocator* alloc,
                                              ...
                                              int line)
{
    struct Allocator_pvt* context = (__extension__ ({ __typeof__((struct Allocator_pvt*) alloc) Identity_ptr = ((struct Allocator_pvt*) alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (777), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
    ...
    struct Allocator_OnFreeJob_pvt* newJob =
        Allocator__clone((alloc),((&(struct Allocator_OnFreeJob_pvt) { .pub = { .callback = callback, .userData = callbackContext }, .alloc = context, .file = file, .line = line })),sizeof(*((&(struct Allocator_OnFreeJob_pvt) { .pub = { .callback = callback, .userData = callbackContext }, .alloc = context, .file = file, .line = line }))),"Allocator.c",788)
           ...
           ;
    (newJob)->Identity_verifier = ((unsigned long) 0x46cf106755e95d82ull);

    struct Allocator_OnFreeJob_pvt* job = context->onFree;
    if (job == 
# 800 "memory/Allocator.c" 3 4
              ((void *)0)
# 800 "memory/Allocator.c"
                  ) {
        context->onFree = newJob;
    } else {
        while (job->next != 
# 803 "memory/Allocator.c" 3 4
                           ((void *)0)
# 803 "memory/Allocator.c"
                               ) {
            job = job->next;
        }
        job->next = newJob;
                                ...
                                int lineNum)
{
    if (sizeLimit == 0) {
        sizeLimit = 
# 818 "memory/Allocator.c" 3 4
                   9223372036854775807LL 
# 818 "memory/Allocator.c"
    ...
    struct Allocator_FirstCtx stackContext = {
        ...
        .context = {
            ...
            .canary = (unsigned long) ((uint64_t) 0xa004223d867bb141ull),
            .nextCanary = (unsigned long) ((uint64_t) 0x2fdce6a01e60e58eull),

        }
    };
    stackContext.maxSpace = stackContext.spaceAvailable;
    stackContext.context.rootAlloc = &stackContext;
    (&stackContext)->Identity_verifier = ((unsigned long) 0x46cf106755e95d82ull);
    (&stackContext.context)->Identity_verifier = ((unsigned long) 0x46cf106755e95d82ull);
...
unsigned long Allocator_bytesAllocated(struct Allocator* allocator)
{
    struct Allocator_pvt* context = (__extension__ ({ __typeof__((struct Allocator_pvt*) allocator) Identity_ptr = ((struct Allocator_pvt*) allocator); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (860), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));
...
void Allocator_setCanary(struct Allocator* alloc, unsigned long value)
{
        ...
        struct Allocator_pvt* context = (__extension__ ({ __typeof__((struct Allocator_pvt*) alloc) Identity_ptr = ((struct Allocator_pvt*) alloc); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Allocator.c"), (867), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x46cf106755e95d82ull))"); } } while (0); Identity_ptr; }));

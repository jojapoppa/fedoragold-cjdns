...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x09095268858356493;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06724271381045046;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08475571046719304;
...
struct Linker_x0030887884628819418;
...
struct Linker_x07841857048392991;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x09674213346355671;
...
struct Linker_x09248674195465996;
...
struct Linker_x000890933940087879;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x06368157168021551;
...
struct Linker_x026184166829818056;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09013315690779342;
...
struct Linker_x05602269209144246;
...
# 1 "./util/Order.h" 1
# 19 "./util/Order.h"
struct Linker_x012807528971178783;

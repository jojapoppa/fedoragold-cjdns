...
struct Linker_x012160004397037527;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x012033330750994331;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x003459694825706672;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09498276744712488;
...
# 24 "./interface/tuntap/SocketWrapper.h"
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x028520722554776734;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 25 "./interface/tuntap/SocketWrapper.h" 2

struct Linker_x01255785999433907;
...
struct Linker_x06494901077536366;
...
# 36 "interface/tuntap/SocketWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6ed0228f63e07c53ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SocketWrapper.c"), (36), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6ed0228f63e07c53ull))"); } } while (0); Identity_ptr; })); }));
...
# 40 "interface/tuntap/SocketWrapper.c"
    ...
    uint8_t type = Message_pop8(msg, 
# 44 "interface/tuntap/SocketWrapper.c" 3 4
                                    ((void *)0)
# 44 "interface/tuntap/SocketWrapper.c"
                                        );
    ...
    if (type == 0x0) {
        ...
        Message_pop32(msg, 
# 49 "interface/tuntap/SocketWrapper.c" 3 4
                          ((void *)0)
# 49 "interface/tuntap/SocketWrapper.c"
                              );
...
# 60 "interface/tuntap/SocketWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x6ed0228f63e07c53ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SocketWrapper.c"), (60), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x6ed0228f63e07c53ull))"); } } while (0); Identity_ptr; })); }));
...
# 68 "interface/tuntap/SocketWrapper.c" 3 4
                                    ((void *)0)
# 68 "interface/tuntap/SocketWrapper.c"
                                        );

    Message_push8(msg, 0x0, 
# 70 "interface/tuntap/SocketWrapper.c" 3 4
                                                     ((void *)0)
# 70 "interface/tuntap/SocketWrapper.c"
                                                         );
...
struct SocketWrapper* SocketWrapper_new(struct Allocator* alloc, struct Log* log)
{
    ...
    (context)->Identity_verifier = ((unsigned long) 0x6ed0228f63e07c53ull);

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08681710515796688;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09232267123367022;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09072354880096798;
...
struct Linker_x07243076252484599;
...
static int compare(const struct Entry* a, const struct Entry* b)
{
    ...
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) a->set) Identity_ptr = ((struct Set_pvt*) a->set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (76), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
...
int Set_addCopy(struct Set* _set, void* val, uint32_t size)
{
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) _set) Identity_ptr = ((struct Set_pvt*) _set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (170), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) _set) Identity_ptr = ((struct Set_pvt*) _set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (187), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
    uint32_t hashCode = set->hashCode(val);
    struct Entry* e = get(set, val, hashCode);
    if (!e) {
        struct Entry* e = newEntry(set);
...
void Set_iter(struct Set* _set, struct Set_Iter* iter)
{
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) _set) Identity_ptr = ((struct Set_pvt*) _set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (201), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) _set) Identity_ptr = ((struct Set_pvt*) _set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (224), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Set_pvt* set = (__extension__ ({ __typeof__((struct Set_pvt*) _set) Identity_ptr = ((struct Set_pvt*) _set); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Set.c"), (236), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1c85b92caa7c7a91ull))"); } } while (0); Identity_ptr; }));
    struct Entry* e = get(set, val, set->hashCode(val));
    void* out = 
# 238 "util/Set.c" 3 4
               ((void *)0)
...
struct Set* Set_new(struct Allocator* alloc, Set_HashCode_t hashCode, Set_Compare_t compare)
{
    ...
    (out)->Identity_verifier = ((unsigned long) 0x1c85b92caa7c7a91ull);
    out->alloc = alloc;
    out->compare = compare;

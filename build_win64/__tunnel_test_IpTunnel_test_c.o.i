...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07016463454626969;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03177399737914257;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0010146735036352439;
...
struct Linker_x0343941135834154;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x03561804318042503;
...
struct Linker_x04939786769075025;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x030463370995633343;
...
struct Linker_x024952100934361;
...
struct Linker_x08067914461457157;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x09989545896746634;
...
struct Linker_x012341821971310218;
...
struct Linker_x0584822001258229;
...
struct Linker_x08647142519103577;
...
struct Linker_x08840772667855414;
...
# 1 "./crypto/Key.h" 1
# 22 "./crypto/Key.h"
struct Linker_x037534908691753777;
...
struct Linker_x041100345259759985;
...
struct Linker_x07374052780695524;
...
struct Linker_x09568289966901387;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x09114872446588067;
...
struct Linker_x033631296520260534;
...
struct Linker_x08256769033663305;
...
{
    struct Context* ctx = (__extension__ ({ __typeof__(((struct IfaceContext*)iface)->ctx) Identity_ptr = (((struct IfaceContext*)iface)->ctx); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5d1e4d2e784776b0ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel_test.c"), (62), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5d1e4d2e784776b0ull))"); } } while (0); Identity_ptr; }));
...
# 67 "./tunnel/test/IpTunnel_test.c" 3 4
                                                                 ((void *)0)
# 67 "./tunnel/test/IpTunnel_test.c"
                                                                     );
...
# 75 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 75 "./tunnel/test/IpTunnel_test.c"
                                                       );
...
# 83 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 83 "./tunnel/test/IpTunnel_test.c"
                                                       );
...
{
    struct Context* ctx = (__extension__ ({ __typeof__(((struct IfaceContext*)iface)->ctx) Identity_ptr = (((struct IfaceContext*)iface)->ctx); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5d1e4d2e784776b0ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel_test.c"), (105), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5d1e4d2e784776b0ull))"); } } while (0); Identity_ptr; }));
    uint16_t type = TUNMessageType_pop(msg, 
# 106 "./tunnel/test/IpTunnel_test.c" 3 4
                                           ((void *)0)
# 106 "./tunnel/test/IpTunnel_test.c"
                                               );
...
# 111 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 111 "./tunnel/test/IpTunnel_test.c"
                                                       );
        ctx->called |= 4;
        ...
        Message_shift(msg, -20, 
# 117 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 117 "./tunnel/test/IpTunnel_test.c"
                                                       );
        ctx->called |= 1;
    } else {
...
{
    Message_shift(message, (56 + 12) + 4, 
# 128 "./tunnel/test/IpTunnel_test.c" 3 4
                                                              ((void *)0)
# 128 "./tunnel/test/IpTunnel_test.c"
                                                                  );
    struct RouteHeader* rh = (struct RouteHeader*) message->bytes;
                     ...
                     struct Context* ctx)
{
    ...
    Message_push(msg4, "hello world", 12, 
# 143 "./tunnel/test/IpTunnel_test.c" 3 4
                                         ((void *)0)
# 143 "./tunnel/test/IpTunnel_test.c"
                                             );
    Message_push(msg4, 
# 144 "./tunnel/test/IpTunnel_test.c" 3 4
                      ((void *)0)
# 144 "./tunnel/test/IpTunnel_test.c"
                          , 20, 
# 144 "./tunnel/test/IpTunnel_test.c" 3 4
                                                    ((void *)0)
# 144 "./tunnel/test/IpTunnel_test.c"
                     ...
                     struct Context* ctx)
{
    ...
    Message_push(msg6, "hello world", 12, 
# 168 "./tunnel/test/IpTunnel_test.c" 3 4
                                         ((void *)0)
# 168 "./tunnel/test/IpTunnel_test.c"
                                             );
    Message_push(msg6, 
# 169 "./tunnel/test/IpTunnel_test.c" 3 4
                      ((void *)0)
# 169 "./tunnel/test/IpTunnel_test.c"
                          , 40, 
# 169 "./tunnel/test/IpTunnel_test.c" 3 4
                                                    ((void *)0)
# 169 "./tunnel/test/IpTunnel_test.c"
...
# 207 "./tunnel/test/IpTunnel_test.c"
    ...
    BencMessageWriter_write(output, msg, 
# 218 "./tunnel/test/IpTunnel_test.c" 3 4
                                        ((void *)0)
# 218 "./tunnel/test/IpTunnel_test.c"
                                            );
...
# 241 "./tunnel/test/IpTunnel_test.c"
    ...
    Message_push(msg, 
# 262 "./tunnel/test/IpTunnel_test.c" 3 4
                     ((void *)0)
# 262 "./tunnel/test/IpTunnel_test.c"
                         , 8, 
# 262 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 262 "./tunnel/test/IpTunnel_test.c"
    ...
    *checksum = 0;
    ...
    Message_push(msg, 
# 271 "./tunnel/test/IpTunnel_test.c" 3 4
                     ((void *)0)
# 271 "./tunnel/test/IpTunnel_test.c"
                         , 40, 
# 271 "./tunnel/test/IpTunnel_test.c" 3 4
                                                   ((void *)0)
# 271 "./tunnel/test/IpTunnel_test.c"
...
# 373 "./tunnel/test/IpTunnel_test.c"
    ...
    (ctx)->Identity_verifier = ((unsigned long) 0x5d1e4d2e784776b0ull);
    ctx->alloc = alloc;
    ctx->log = logger;
    ctx->rand = rand;
    ctx->base = eb;

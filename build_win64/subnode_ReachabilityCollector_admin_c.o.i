...
struct Linker_x023019760699330893;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x06534274792475825;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x041169106662237986;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05553167090230566;
...
struct Linker_x06854680239363304;
...
struct Linker_x09621087216111865;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05109016724806998;
...
struct Linker_x05115361247316079;
...
struct Linker_x08078426339574498;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x08990460064224293;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x07381852003213705;
...
struct Linker_x06412996267319189;
...
struct Linker_x039627200051098876;
...
struct Linker_x07358525970334542;
...
struct Linker_x019536854434646211;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x098697692724469;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x06007853978315754;
...
struct Linker_x038481226909936783;
...
struct Linker_x039555425981144254;
...
struct Linker_x008064376705088061;
...
struct Linker_x08680706837738983;
...
struct Linker_x0153875811357439;
...
# 19 "./util/AddrTools.h"
struct Linker_x09275868958890319;
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x2c085edfa0ba1f90ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReachabilityCollector_admin.c"), (50), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x2c085edfa0ba1f90ull))"); } } while (0); Identity_ptr; }));
    int page = 0;
                                          ...
                                          struct Allocator* alloc)
{
    struct Context* ctx = Allocator__clone((alloc),((&(struct Context) { .admin = admin, .alloc = alloc, .rc = rc })),sizeof(*((&(struct Context) { .admin = admin, .alloc = alloc, .rc = rc }))),"ReachabilityCollector_admin.c",88)
       ...
       ;
    (ctx)->Identity_verifier = ((unsigned long) 0x2c085edfa0ba1f90ull);

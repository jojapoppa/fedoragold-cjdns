...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x022030590522347082;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x031553522295497527;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0081051588288787;
...
struct Linker_x0770718335008653;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x03595574097385459;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x02615964786565581;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06541508143017842;
...
struct Linker_x08272797266498197;
...
struct Linker_x07693581992102623;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x011264858108647302;
...
struct Linker_x009300961920108763;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x09087516162513605;
...
struct Linker_x0961524714361983;
...
struct Linker_x048872548599130416;
...
struct Linker_x06428623053484372;
...
struct Linker_x0012001146505600913;
...
struct Linker_x023806049292265596;
...
struct Linker_x00003121819019398231;
...
struct Linker_x06801177366840343;
...
struct Linker_x004995830181979599;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x06550668734770408;
...
struct Linker_x041575180825357805;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x0032202217261921184;
# 32 "./util/Hex.h"
...
# 1 "./util/Pinger.h" 1
# 24 "./util/Pinger.h"
struct Linker_x05990729427839696;
# 50 "./util/Pinger.h"
struct Pinger;
...
struct Linker_x06804514969577344;
...
struct Linker_x016594481736734057;
                                           ...
                                           struct NodeStore* nodeStore)
{
    ...
    (out)->Identity_verifier = ((unsigned long) 0x9a3a1db440708254ull);
    return out;
}
...
static int handleOutgoing(struct DHTMessage* message, void* vcontext)
{
    struct RouterModule* module = (__extension__ ({ __typeof__((struct RouterModule*) vcontext) Identity_ptr = ((struct RouterModule*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouterModule.c"), (375), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull))"); } } while (0); Identity_ptr; }));
...
{
    struct PingContext* pc = (__extension__ ({ __typeof__((struct PingContext*) vpingContext) Identity_ptr = ((struct PingContext*) vpingContext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouterModule.c"), (411), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull))"); } } while (0); Identity_ptr; }));
...
static int handleIncoming(struct DHTMessage* message, void* vcontext)
{
    ...
    struct RouterModule* module = (__extension__ ({ __typeof__((struct RouterModule*) vcontext) Identity_ptr = ((struct RouterModule*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouterModule.c"), (460), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull))"); } } while (0); Identity_ptr; }));
...
{
    struct PingContext* pctx = (__extension__ ({ __typeof__((struct PingContext*) vping) Identity_ptr = ((struct PingContext*) vping); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouterModule.c"), (473), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull))"); } } while (0); Identity_ptr; }));
...
# 563 "dht/dhtcore/RouterModule.c"
    ...
    struct PingContext* pctx = Allocator__clone((pp->pingAlloc),((&(struct PingContext) { .pub = { .alloc = pp->pingAlloc }, .router = module, .pp = pp })),sizeof(*((&(struct PingContext) { .pub = { .alloc = pp->pingAlloc }, .router = module, .pp = pp }))),"RouterModule.c",570)
       ...
       ;
    (pctx)->Identity_verifier = ((unsigned long) 0x9a3a1db440708254ull);
...
void RouterModule_sendMessage(struct RouterModule_Promise* promise, Dict* request)
{
    struct PingContext* pctx = (__extension__ ({ __typeof__((struct PingContext*)promise) Identity_ptr = ((struct PingContext*)promise); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("RouterModule.c"), (587), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9a3a1db440708254ull))"); } } while (0); Identity_ptr; }));

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x029461700169953065;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03078702439542702;
...
struct Linker_x07030761752644887;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07433265955922892;
...
struct Linker_x07381526626045027;
...
struct Linker_x09528396803793615;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x017316686429380046;
...
struct Linker_x043137825226636495;
...
# 21 "./util/ArrayList.h"
struct Linker_x003244063610725112;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09745142390819723;
...
struct Linker_x07591699074503473;
...
struct Linker_x05332426746966148;
...
# 22 "./switch/SwitchCore.h" 2

struct Linker_x04055287134379095;
...
struct Linker_x03310384130234778;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x07856323530939475;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x004550326859945075;
...
struct Linker_x06043765949781037;
...
struct Linker_x06771659977044988;
...
struct Linker_x06585086032659184;
...
struct Linker_x0856760486943031;
...
struct Linker_x09327614621643996;
...
struct Linker_x009748244363500014;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x05575727699059523;
...
struct Linker_x02526338194803257;
...
struct Linker_x014791394011349923;
...
struct Linker_x09658659580668512;
...
struct Linker_x045553393659090524;
...
# 22 "./net/TUNAdapter.h"
struct Linker_x02405686103890976;
...
struct Linker_x04151965814381202;
...
struct NetCore* NetCore_new(uint8_t* privateKey,
                            ...
                            struct Log* log)
{
    struct Allocator* alloc = Allocator__child((allocator),"NetCore.c",40);
    struct NetCore* nc = Allocator__calloc((alloc),(sizeof(struct NetCore)),(1),"NetCore.c",41);
    nc->alloc = alloc;
    nc->base = base;
    nc->rand = rand;
    nc->log = log;
    ...
    struct Address* myAddress = nc->myAddress =
        Allocator__calloc((alloc),(sizeof(struct Address)),(1),"NetCore.c",50);

    Bits__memcpy(myAddress->key,ca->publicKey,32,"NetCore.c",52);
    Address_getPrefix(myAddress);
    myAddress->protocolVersion = 20;
    myAddress->path = 1;

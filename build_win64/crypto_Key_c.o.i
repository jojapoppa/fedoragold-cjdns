...
# 1 "./util/Linker.h" 1
# 19 "./util/crypto.h" 2
struct Linker_x027536708423539236;
# 30 "./util/crypto.h"
...
struct Linker_x03274997184918693;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x036733958503786956;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x07243622878227205;
...
struct Linker_x021319807782168154;
...
struct Linker_x004137771543977675;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06710024070042662;
...
struct Linker_x07619604716711084;
...
struct Linker_x09861762089817676;
...
struct Linker_x09234582501286897;
...
struct Linker_x09483428113486936;
            ...
            struct Random* rand)
{
    for (;;) {
        ...
        crypto_scalarmult_base(publicKeyOut, privateKeyOut);
...
char* Key_parse_strerror(int error)
{
    switch (error) {
        case 0: return "none";
        case -1: return "key must be 52 characters long";
        case -2: return "key must end in .k";
        case -3: return "failed to base-32 decode key";
        case -4: return "not a valid cjdns public key";

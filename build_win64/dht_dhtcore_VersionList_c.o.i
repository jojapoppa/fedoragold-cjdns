...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x09985966955317538;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06974450881827161;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x09982981991450943;
...
struct Linker_x08594548012928307;
...
struct Linker_x001600517686980618;
...
# 16 "dht/dhtcore/VersionList.c" 2
...
# 18 "dht/dhtcore/VersionList.c" 2
# 1 "./io/Writer.h" 1
# 23 "./io/Writer.h"
struct Writer {
# 35 "./io/Writer.h"
...
# 19 "dht/dhtcore/VersionList.c" 2
# 1 "./io/ArrayWriter.h" 1
# 21 "./io/ArrayWriter.h"
struct Linker_x00491823102510518;
# 30 "./io/ArrayWriter.h"
struct Writer* ArrayWriter_new(void* writeTo,
                               unsigned long length,
                               struct Allocator* allocator);
# 20 "dht/dhtcore/VersionList.c" 2
# 1 "./io/ArrayReader.h" 1
# 21 "./io/ArrayReader.h"
struct Linker_x07560652739643814;
# 30 "./io/ArrayReader.h"
struct Reader* ArrayReader_new(const void* bufferToRead,
                               unsigned long length,
                               struct Allocator* allocator);
# 21 "dht/dhtcore/VersionList.c" 2
# 1 "./util/Endian.h" 1
# 22 "dht/dhtcore/VersionList.c" 2
...
# 23 "dht/dhtcore/VersionList.c" 2


# 24 "dht/dhtcore/VersionList.c"
struct VersionList* VersionList_parse(String* str, struct Allocator* alloc)
{
    const uint8_t numberSize = str->bytes[0];
    if (str->len < 1 || numberSize == 0 || numberSize > 4) {
        return 
# 28 "dht/dhtcore/VersionList.c" 3 4
              ((void *)0)
# 28 "dht/dhtcore/VersionList.c"
                  ;
    }
    ...
    if ((length * numberSize) != (str->len - 1)) {
        return 
# 34 "dht/dhtcore/VersionList.c" 3 4
              ((void *)0)
# 34 "dht/dhtcore/VersionList.c"
                  ;
    }
    ...
    for (int i = 0; i < (int)list->length; i++) {
        uint32_t ver = 0;
        (r)->read((r), ((uint8_t*) &ver), (numberSize));
        ver = ((uint32_t)__builtin_bswap32(((uint32_t)(ver))));
...
# 59 "dht/dhtcore/VersionList.c" 3 4
                                  ((void *)0)
# 59 "dht/dhtcore/VersionList.c"
                                      , (numberSize * list->length + 1), alloc);

    struct Writer* w = ArrayWriter_new(out->bytes, out->len, alloc);
    ((w)->write((w), (&numberSize), (1)));

    for (int i = 0; i < (int)list->length; i++) {
        uint32_t ver = list->versions[i] << ((4-numberSize) * 8);
        ver = ((uint32_t)__builtin_bswap32(((uint32_t)(ver))));
        ((w)->write((w), ((uint8_t*) &ver), (numberSize)));
    }
    ((w)->write((w), (&numberSize), (1)));
...
{
    struct VersionList* out = Allocator__clone((alloc),((&(struct VersionList) { .length = length, .alloc = alloc })),sizeof(*((&(struct VersionList) { .length = length, .alloc = alloc }))),"VersionList.c",76)


       ;
    out->versions = Allocator__calloc((alloc),(4),(length),"VersionList.c",80);
    return out;
}

# 1 "./util/test/Bits_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./util/test/Bits_test.c"
# 15 "./util/test/Bits_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02196414312223265;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x029495172498346833;
...
struct Linker_x09026638054476712;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x047398279902688434;
...
struct Linker_x031246510430887375;
...
struct Linker_x06186508374488482;
...
# 18 "./util/test/Bits_test.c" 2
# 1 "./util/Endian.h" 1
# 19 "./util/test/Bits_test.c" 2
...
# 22 "./util/test/Bits_test.c" 2



# 24 "./util/test/Bits_test.c"
static void log2x64(struct Random* rand)
{
    do { if (!((Bits_log2x64(1) == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (26), "(Bits_log2x64(1) == 0)"); } } while (0);
    do { if (!((Bits_log2x64_stupid(1) == Bits_log2x64(1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (27), "(Bits_log2x64_stupid(1) == Bits_log2x64(1))"); } } while (0);
    do { if (!((Bits_log2x64_stupid(0) == Bits_log2x64(0)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (28), "(Bits_log2x64_stupid(0) == Bits_log2x64(0))"); } } while (0);
    for (int i = 0; i < 1000; i++) {
        uint64_t num = Random_uint64(rand);
        do { if (!((Bits_log2x64_stupid(num) == Bits_log2x64(num)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (31), "(Bits_log2x64_stupid(num) == Bits_log2x64(num))"); } } while (0);
    }
}

int Bits_test_main(int argc, char** argv);int Bits_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((20000),"Bits_test.c",37);
    struct Random* rand = Random_new(alloc, 
# 38 "./util/test/Bits_test.c" 3 4
                                           ((void *)0)
# 38 "./util/test/Bits_test.c"
                                               , 
# 38 "./util/test/Bits_test.c" 3 4
                                                 ((void *)0)
# 38 "./util/test/Bits_test.c"
    ...
    printf("x = 0x%016" 
# 44 "./util/test/Bits_test.c" 3
                       "I64x" 
# 44 "./util/test/Bits_test.c"
                              "\n", x);

    do { if (!((Bits_bitReverse64(Bits_bitReverse64(x)) == x))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (46), "(Bits_bitReverse64(Bits_bitReverse64(x)) == x)"); } } while (0);
    do { if (!((Bits_bitReverse64(((uint64_t)__builtin_bswap64(((uint64_t)(Bits_bitReverse64(x)))))) == ((uint64_t)__builtin_bswap64(((uint64_t)(x))))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (47), "(Bits_bitReverse64(((uint64_t)__builtin_bswap64(((uint64_t)(Bits_bitReverse64(x)))))) == ((uint64_t)__builtin_bswap64(((uint64_t)(x)))))"); } } while (0)
                                                                                           ;
    do { if (!((Bits_bitReverse64(1) == ((uint64_t)1)<<63))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (49), "(Bits_bitReverse64(1) == ((uint64_t)1)<<63)"); } } while (0);
    do { if (!((Bits_bitReverse64(0) == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Bits_test.c"), (50), "(Bits_bitReverse64(0) == 0)"); } } while (0);

    Allocator__free((alloc),"Bits_test.c",52);
    return 0;
}

# 1 "./switch/test/LabelSplicer_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./switch/test/LabelSplicer_test.c"
# 15 "./switch/test/LabelSplicer_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02267030218317343;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06291579164126346;
...
# 16 "./switch/test/LabelSplicer_test.c" 2
# 1 "./util/Endian.h" 1
# 17 "./switch/test/LabelSplicer_test.c" 2
# 1 "./util/Constant.h" 1
# 33 "./util/Constant.h"

# 18 "./switch/test/LabelSplicer_test.c" 2
...
# 21 "./switch/test/LabelSplicer_test.c" 2
...
# 22 "./switch/test/LabelSplicer_test.c" 2


# 23 "./switch/test/LabelSplicer_test.c"
static void unsplice()
{
    do { if (!((0x13 == LabelSplicer_unsplice(0x13, 1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("LabelSplicer_test.c"), (25), "(0x13 == LabelSplicer_unsplice(0x13, 1))"); } } while (0);
}

static void splice()
{
    uint64_t goHere = ((uint16_t) 0x004ul);
    uint64_t viaHere = ((uint16_t) 0x004ul);
    uint64_t expected = ((uint16_t) 0x010ul);

    uint64_t out = LabelSplicer_splice(goHere, viaHere);

    printf("Splicing %" 
# 36 "./switch/test/LabelSplicer_test.c" 3
                       "I64u" 
# 36 "./switch/test/LabelSplicer_test.c"
                              " with %" 
# 36 "./switch/test/LabelSplicer_test.c" 3
                                        "I64u" 
# 36 "./switch/test/LabelSplicer_test.c"
...
# 36 "./switch/test/LabelSplicer_test.c"
    ...
    do { if (!((expected == out))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("LabelSplicer_test.c"), (39), "(expected == out)"); } } while (0);
}

static void routesThrough()
{
    uint64_t dst = ((uint64_t) 0x0000900aea95ca55ull);
    uint64_t mid = ((uint64_t) 0x000001652639c655ull);
    do { if (!((!LabelSplicer_routesThrough(dst, mid)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("LabelSplicer_test.c"), (46), "(!LabelSplicer_routesThrough(dst, mid))"); } } while (0);
    do { if (!((LabelSplicer_routesThrough(dst, 1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("LabelSplicer_test.c"), (47), "(LabelSplicer_routesThrough(dst, 1))"); } } while (0);
}

int LabelSplicer_test_main(int argc, char** argv);int LabelSplicer_test_main(int argc, char** argv)
{
    splice();
    routesThrough();
    unsplice();

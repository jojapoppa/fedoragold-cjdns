# 1 "interface/tuntap/AndroidWrapper.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/tuntap/AndroidWrapper.c"
# 15 "interface/tuntap/AndroidWrapper.c"
...
struct Linker_x023553448657062082;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x02125896021174929;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x0439408119143349;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x01297831723032965;
...
# 16 "interface/tuntap/AndroidWrapper.c" 2
# 1 "./interface/tuntap/AndroidWrapper.h" 1
# 20 "./interface/tuntap/AndroidWrapper.h"
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07757777241714163;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 21 "./interface/tuntap/AndroidWrapper.h" 2

struct Linker_x036461697198068466;
...
# 17 "interface/tuntap/AndroidWrapper.c" 2
# 1 "./util/platform/Sockaddr.h" 1
# 21 "./util/platform/Sockaddr.h"
struct Linker_x03171944335341852;
...
# 18 "interface/tuntap/AndroidWrapper.c" 2
...
# 22 "interface/tuntap/AndroidWrapper.c" 2
# 1 "./wire/Headers.h" 1
# 23 "./wire/Headers.h"
...
# 23 "interface/tuntap/AndroidWrapper.c" 2
...
# 25 "interface/tuntap/AndroidWrapper.c" 2
...
static __attribute__ ((warn_unused_result)) struct Iface* incomingFromWire(struct Message* msg, struct Iface* externalIf)
{
    struct AndroidWrapper_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct AndroidWrapper_pvt*)0)->pub.externalIf)*__mptr = (externalIf); (__extension__ ({ __typeof__((struct AndroidWrapper_pvt*)((char*)__mptr - 
# 42 "interface/tuntap/AndroidWrapper.c" 3 4
       __builtin_offsetof (
# 42 "interface/tuntap/AndroidWrapper.c"
       struct AndroidWrapper_pvt
# 42 "interface/tuntap/AndroidWrapper.c" 3 4
       , 
# 42 "interface/tuntap/AndroidWrapper.c"
...
# 42 "interface/tuntap/AndroidWrapper.c"
       )) Identity_ptr = ((struct AndroidWrapper_pvt*)((char*)__mptr - 
# 42 "interface/tuntap/AndroidWrapper.c" 3 4
       __builtin_offsetof (
# 42 "interface/tuntap/AndroidWrapper.c"
       struct AndroidWrapper_pvt
...
# 42 "interface/tuntap/AndroidWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1e8a85ef40a5f90full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AndroidWrapper.c"), (42), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1e8a85ef40a5f90full))"); } } while (0); Identity_ptr; })); }));

    if (!ctx->pub.internalIf.connectedIf) {
        do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "AndroidWrapper.c", 45, "DROP message for android tun not inited"); } } while (0);
        return 
# 46 "interface/tuntap/AndroidWrapper.c" 3 4
              ((void *)0)
# 46 "interface/tuntap/AndroidWrapper.c"
                  ;
    }
    ...
    if (version == 4) {
        ...
        do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "AndroidWrapper.c", 56, "Message is not IP/IPv6, dropped."); } } while (0);
        return 
# 57 "interface/tuntap/AndroidWrapper.c" 3 4
              ((void *)0)
# 57 "interface/tuntap/AndroidWrapper.c"
                  ;
    }

    Message_shift(msg, 4, 
# 60 "interface/tuntap/AndroidWrapper.c" 3 4
                         ((void *)0)
# 60 "interface/tuntap/AndroidWrapper.c"
                             );
...
{
    struct AndroidWrapper_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct AndroidWrapper_pvt*)0)->pub.internalIf)*__mptr = (internalIf); (__extension__ ({ __typeof__((struct AndroidWrapper_pvt*)((char*)__mptr - 
# 70 "interface/tuntap/AndroidWrapper.c" 3 4
       __builtin_offsetof (
# 70 "interface/tuntap/AndroidWrapper.c"
       struct AndroidWrapper_pvt
# 70 "interface/tuntap/AndroidWrapper.c" 3 4
       , 
# 70 "interface/tuntap/AndroidWrapper.c"
...
# 70 "interface/tuntap/AndroidWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x1e8a85ef40a5f90full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AndroidWrapper.c"), (70), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x1e8a85ef40a5f90full))"); } } while (0); Identity_ptr; })); }));

    if (!ctx->pub.externalIf.connectedIf) {
        do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "AndroidWrapper.c", 73, "DROP message for android tun not inited"); } } while (0);
        return 
# 74 "interface/tuntap/AndroidWrapper.c" 3 4
              ((void *)0)
# 74 "interface/tuntap/AndroidWrapper.c"
                  ;
    }

    Message_shift(msg, -4, 
# 77 "interface/tuntap/AndroidWrapper.c" 3 4
                          ((void *)0)
# 77 "interface/tuntap/AndroidWrapper.c"
                              );
...
struct AndroidWrapper* AndroidWrapper_new(struct Allocator* alloc, struct Log* log)
{
    struct AndroidWrapper_pvt* context =
        Allocator__calloc((alloc),(sizeof(struct AndroidWrapper_pvt)),(1),"AndroidWrapper.c",85);
    (context)->Identity_verifier = ((unsigned long) 0x1e8a85ef40a5f90full);

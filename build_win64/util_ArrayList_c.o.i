...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x004466825430374688;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x016154871365557089;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 19 "./util/ArrayList.h" 2


struct Linker_x04684166166891981;
...
# 17 "util/ArrayList.c" 2
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0893464637178196;
...
# 19 "util/ArrayList.c" 2

# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 1 3 4
# 1 "/usr/share/mingw-w64/include/stddef.h" 1 3 4
# 2 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 2 3 4
# 21 "util/ArrayList.c" 2
...
void* ArrayList_new(struct Allocator* alloc, int initialCapacity)
{
    struct ArrayList_pvt* l = Allocator__calloc((alloc),(sizeof(struct ArrayList_pvt)),(1),"ArrayList.c",37);
    l->elements = Allocator__calloc((alloc),(sizeof(char*)),(initialCapacity),"ArrayList.c",38);
    l->capacity = initialCapacity;
    l->alloc = alloc;
    (l)->Identity_verifier = ((unsigned long) 0x50b43bc697554a6full);
    return l;
}

void* ArrayList_get(struct ArrayList* vlist, int number)
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (47), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full))"); } } while (0); Identity_ptr; }));
    if (number >= list->length || number < 0) { return 
# 48 "util/ArrayList.c" 3 4
                                                      ((void *)0)
# 48 "util/ArrayList.c"
                                                          ; }
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (54), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full))"); } } while (0); Identity_ptr; }));
    if (number >= list->length) { return 
# 55 "util/ArrayList.c" 3 4
                                        ((void *)0)
# 55 "util/ArrayList.c"
                                            ; }
    void* out = list->elements[number];
    if (number < list->length - 1) {
        __builtin_memmove(&list->elements[number],&list->elements[number+1],sizeof(char*) * (list->length - number - 1))
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (68), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full))"); } } while (0); Identity_ptr; }));
    do { if (!((number >= 0 && number <= list->length))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (69), "(number >= 0 && number <= list->length)"); } } while (0);
    if (number >= list->capacity) {
        int capacity = list->capacity * 2;
        list->elements = Allocator__realloc((list->alloc),(list->elements),(capacity * sizeof(char*)),"ArrayList.c",72);
        for (int i = list->capacity; i < capacity; i++) {
            list->elements[i] = 
# 74 "util/ArrayList.c" 3 4
                               ((void *)0)
# 74 "util/ArrayList.c"
                                   ;
        }
...
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (85), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full))"); } } while (0); Identity_ptr; }));
    QSort(list->elements, list->length, sizeof(char*), compare);
}

void* ArrayList_clone(struct ArrayList* vlist, struct Allocator* alloc)
{
    struct ArrayList_pvt* list = (__extension__ ({ __typeof__((struct ArrayList_pvt*) vlist) Identity_ptr = ((struct ArrayList_pvt*) vlist); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ArrayList.c"), (91), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x50b43bc697554a6full))"); } } while (0); Identity_ptr; }));
    struct ArrayList_pvt* newlist = Allocator__clone((alloc),(list),sizeof(*(list)),"ArrayList.c",92);
    newlist->elements = Allocator__malloc((alloc),(list->capacity * sizeof(char*)),"ArrayList.c",93);
    Bits__memcpy(newlist->elements,list->elements,list->capacity * sizeof(char*),"ArrayList.c",94);
    newlist->alloc = alloc;
    return newlist;
}

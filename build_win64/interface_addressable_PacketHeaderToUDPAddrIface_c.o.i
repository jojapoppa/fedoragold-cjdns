# 1 "interface/addressable/PacketHeaderToUDPAddrIface.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/addressable/PacketHeaderToUDPAddrIface.c"
# 15 "interface/addressable/PacketHeaderToUDPAddrIface.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06981148894851315;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03652117535027801;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 16 "interface/addressable/PacketHeaderToUDPAddrIface.c" 2
# 1 "./interface/addressable/PacketHeaderToUDPAddrIface.h" 1
# 18 "./interface/addressable/PacketHeaderToUDPAddrIface.h"
...
# 20 "./exception/Except.h"
struct Linker_x07085151635419438;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09716706694220336;
...
# 19 "./interface/addressable/PacketHeaderToUDPAddrIface.h" 2
...
struct Linker_x010886073985125311;
...
# 20 "./interface/addressable/PacketHeaderToUDPAddrIface.h" 2



struct Linker_x007490573013605806;
...
struct PacketHeaderToUDPAddrIface* PacketHeaderToUDPAddrIface_new(struct Allocator* alloc,
                                                                  struct Sockaddr* addr);
# 17 "interface/addressable/PacketHeaderToUDPAddrIface.c" 2
...
# 21 "interface/addressable/PacketHeaderToUDPAddrIface.c" 2
# 1 "./wire/Headers.h" 1
# 23 "./wire/Headers.h"
...
# 22 "interface/addressable/PacketHeaderToUDPAddrIface.c" 2
...
# 24 "interface/addressable/PacketHeaderToUDPAddrIface.c" 2
...
static __attribute__ ((warn_unused_result)) struct Iface* incomingFromUdpIf(struct Message* message, struct Iface* udpIf)
{
    struct PacketHeaderToUDPAddrIface_pvt* context =
        (__extension__ ({ const __typeof__(((struct PacketHeaderToUDPAddrIface_pvt*)0)->pub.udpIf.iface)*__mptr = (udpIf); (__extension__ ({ __typeof__((struct PacketHeaderToUDPAddrIface_pvt*)((char*)__mptr - 
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       __builtin_offsetof (
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       struct PacketHeaderToUDPAddrIface_pvt
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       , 
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
...
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )) Identity_ptr = ((struct PacketHeaderToUDPAddrIface_pvt*)((char*)__mptr - 
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       __builtin_offsetof (
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       struct PacketHeaderToUDPAddrIface_pvt
...
# 34 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x2d6d0d82ca8881f0ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (34), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x2d6d0d82ca8881f0ull))"); } } while (0); Identity_ptr; })); }));

    struct Sockaddr_storage ss;
    Message_pop(message, &ss, context->pub.udpIf.addr->addrLen, 
# 37 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                                                               ((void *)0)
# 37 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                                                                   );
    struct Sockaddr* addr = &ss.addr;

    struct Headers_UDPHeader udp;
    udp.srcPort_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(Sockaddr_getPort(context->pub.udpIf.addr)))); _x >> 8 | _x << 8; })));
    udp.destPort_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(Sockaddr_getPort(addr)))); _x >> 8 | _x << 8; })));
    udp.length_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(message->length + 8))); _x >> 8 | _x << 8; })));
    udp.checksum_be = 0;
    Message_push(message, &udp, sizeof(struct Headers_UDPHeader), 
# 45 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                                                                 ((void *)0)
# 45 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                                                                     );
    ...
    ip.payloadLength_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(message->length))); _x >> 8 | _x << 8; })));
    (((uint8_t*) &ip)[0] |= ( (sizeof(*&ip) == 20) ? 4 : 6 ) << 4);
    uint8_t* addrPtr = 
# 53 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                      ((void *)0)
# 53 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                          ;
    do { if (!((Sockaddr_getAddress(addr, &addrPtr) == 16))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (54), "(Sockaddr_getAddress(addr, &addrPtr) == 16)"); } } while (0);
    Bits__memcpy(ip.destinationAddr,addrPtr,16,"PacketHeaderToUDPAddrIface.c",55);
    do { if (!((Sockaddr_getAddress(context->pub.udpIf.addr, &addrPtr) == 16))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (56), "(Sockaddr_getAddress(context->pub.udpIf.addr, &addrPtr) == 16)"); } } while (0);
    Bits__memcpy(ip.sourceAddr,addrPtr,16,"PacketHeaderToUDPAddrIface.c",57);
...
# 62 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                                                                ((void *)0)
# 62 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                                                                    );

    return Iface_next(&context->pub.headerIf, message);
}

static __attribute__ ((warn_unused_result)) struct Iface* incomingFromHeaderIf(struct Message* message, struct Iface* iface)
{
    struct PacketHeaderToUDPAddrIface_pvt* context =
        (__extension__ ({ __typeof__((struct PacketHeaderToUDPAddrIface_pvt*) ((uint8_t*)(iface) - 
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       __builtin_offsetof (
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       struct PacketHeaderToUDPAddrIface
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       , 
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
...
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )) Identity_ptr = ((struct PacketHeaderToUDPAddrIface_pvt*) ((uint8_t*)(iface) - 
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
       __builtin_offsetof (
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       struct PacketHeaderToUDPAddrIface
...
# 70 "interface/addressable/PacketHeaderToUDPAddrIface.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x2d6d0d82ca8881f0ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (70), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x2d6d0d82ca8881f0ull))"); } } while (0); Identity_ptr; }))
                                                                                        ;

    if (message->length < 40 + 8) {

        return 
# 75 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
              ((void *)0)
# 75 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                  ;
    }
    ...
    if (ip->nextHeader != 17) {
        return 
# 82 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
              ((void *)0)
# 82 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                  ;
    }

    struct Allocator* alloc = Allocator__child((message->alloc),"PacketHeaderToUDPAddrIface.c",85);
    struct Sockaddr* addr = Sockaddr_clone(context->pub.udpIf.addr, alloc);
    uint8_t* addrPtr = 
# 87 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                      ((void *)0)
# 87 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                          ;
    do { if (!((Sockaddr_getAddress(addr, &addrPtr) == 16))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PacketHeaderToUDPAddrIface.c"), (88), "(Sockaddr_getAddress(addr, &addrPtr) == 16)"); } } while (0);
    Bits__memcpy(addrPtr,ip->sourceAddr,16,"PacketHeaderToUDPAddrIface.c",89);

    struct Headers_UDPHeader* udp = (struct Headers_UDPHeader*) (&ip[1]);
    Sockaddr_setPort(addr, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(udp->srcPort_be))); _x >> 8 | _x << 8; }))));

    if (Sockaddr_getPort(context->pub.udpIf.addr) != ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(udp->destPort_be))); _x >> 8 | _x << 8; })))) {

        return 
# 96 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
              ((void *)0)
# 96 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                  ;
    }

    Message_shift(message, -(40 + 8), 
# 99 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                                                                              ((void *)0)
# 99 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                                                                                  );
    Message_push(message, addr, addr->addrLen, 
# 100 "interface/addressable/PacketHeaderToUDPAddrIface.c" 3 4
                                              ((void *)0)
# 100 "interface/addressable/PacketHeaderToUDPAddrIface.c"
                                                  );
...
{
    struct PacketHeaderToUDPAddrIface_pvt* context =
        Allocator__calloc((alloc),(sizeof(struct PacketHeaderToUDPAddrIface_pvt)),(1),"PacketHeaderToUDPAddrIface.c",109);
    (context)->Identity_verifier = ((unsigned long) 0x2d6d0d82ca8881f0ull);

# 1 "interface/addressable/AddrIfaceAdapter.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/addressable/AddrIfaceAdapter.c"
# 15 "interface/addressable/AddrIfaceAdapter.c"
# 1 "./interface/addressable/AddrIfaceAdapter.h" 1
# 18 "./interface/addressable/AddrIfaceAdapter.h"
...
struct Linker_x06561376473289398;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x09198057221458804;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x014198230028010772;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x08163891320928962;
...
struct Linker_x08639027124252159;
...
# 19 "./interface/addressable/AddrIfaceAdapter.h" 2


struct Linker_x06473124829559935;
...
# 16 "interface/addressable/AddrIfaceAdapter.c" 2
# 26 "interface/addressable/AddrIfaceAdapter.c"
...
static __attribute__ ((warn_unused_result)) struct Iface* incomingFromAddrIf(struct Message* msg, struct Iface* addrIf)
{
    struct AddrIfaceAdapter_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct AddrIfaceAdapter_pvt*)0)->pub.generic.iface)*__mptr = (addrIf); (__extension__ ({ __typeof__((struct AddrIfaceAdapter_pvt*)((char*)__mptr - 
# 35 "interface/addressable/AddrIfaceAdapter.c" 3 4
       __builtin_offsetof (
# 35 "interface/addressable/AddrIfaceAdapter.c"
       struct AddrIfaceAdapter_pvt
# 35 "interface/addressable/AddrIfaceAdapter.c" 3 4
       , 
# 35 "interface/addressable/AddrIfaceAdapter.c"
...
# 35 "interface/addressable/AddrIfaceAdapter.c"
       )) Identity_ptr = ((struct AddrIfaceAdapter_pvt*)((char*)__mptr - 
# 35 "interface/addressable/AddrIfaceAdapter.c" 3 4
       __builtin_offsetof (
# 35 "interface/addressable/AddrIfaceAdapter.c"
       struct AddrIfaceAdapter_pvt
...
# 35 "interface/addressable/AddrIfaceAdapter.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9926cc36e39b3547ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AddrIfaceAdapter.c"), (35), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9926cc36e39b3547ull))"); } } while (0); Identity_ptr; })); }));

    Message_shift(msg, -(ctx->pub.generic.addr->addrLen), 
# 37 "interface/addressable/AddrIfaceAdapter.c" 3 4
                                                         ((void *)0)
# 37 "interface/addressable/AddrIfaceAdapter.c"
                                                             );
    return Iface_next(&ctx->pub.inputIf, msg);
}

static __attribute__ ((warn_unused_result)) struct Iface* incomingFromInputIf(struct Message* msg, struct Iface* inputIf)
{
    struct AddrIfaceAdapter_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct AddrIfaceAdapter_pvt*)0)->pub.inputIf)*__mptr = (inputIf); (__extension__ ({ __typeof__((struct AddrIfaceAdapter_pvt*)((char*)__mptr - 
# 44 "interface/addressable/AddrIfaceAdapter.c" 3 4
       __builtin_offsetof (
# 44 "interface/addressable/AddrIfaceAdapter.c"
       struct AddrIfaceAdapter_pvt
# 44 "interface/addressable/AddrIfaceAdapter.c" 3 4
       , 
# 44 "interface/addressable/AddrIfaceAdapter.c"
...
# 44 "interface/addressable/AddrIfaceAdapter.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x9926cc36e39b3547ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("AddrIfaceAdapter.c"), (44), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x9926cc36e39b3547ull))"); } } while (0); Identity_ptr; })); }));

    Message_push(msg, ctx->pub.generic.addr, ctx->pub.generic.addr->addrLen, 
# 46 "interface/addressable/AddrIfaceAdapter.c" 3 4
                                                                            ((void *)0)
# 46 "interface/addressable/AddrIfaceAdapter.c"
                                                                                );
...
struct AddrIfaceAdapter* AddrIfaceAdapter_new(struct Allocator* alloc)
{
    struct AddrIfaceAdapter_pvt* context =
        Allocator__calloc((alloc),(sizeof(struct AddrIfaceAdapter_pvt)),(1),"AddrIfaceAdapter.c",53);
    context->pub.generic.addr = Sockaddr_clone((0 ? Sockaddr_LOOPBACK_be : Sockaddr_LOOPBACK_le), alloc);
    ...
    (context)->Identity_verifier = ((unsigned long) 0x9926cc36e39b3547ull);
    return &context->pub;
}

# 1 "./dht/dhtcore/test/VersionList_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./dht/dhtcore/test/VersionList_test.c"
# 15 "./dht/dhtcore/test/VersionList_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06765772091627793;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07663376893775393;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x01817456338615493;
...
struct Linker_x05770038317996269;
...
struct Linker_x03762303567852656;
...
# 17 "./dht/dhtcore/test/VersionList_test.c" 2
# 1 "./dht/dhtcore/VersionList.h" 1
# 18 "./dht/dhtcore/VersionList.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
# 1 "./benc/Object.h" 1
# 18 "./benc/Object.h"
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x03732588483303896;
...
struct Linker_x09391036102972814;
...
# 19 "./dht/dhtcore/VersionList.h" 2


struct Linker_x05320807903826021;
...
# 18 "./dht/dhtcore/test/VersionList_test.c" 2

# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x06410002622092887;
# 32 "./util/Hex.h"
...
# 20 "./dht/dhtcore/test/VersionList_test.c" 2

# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 1 3 4
# 1 "/usr/share/mingw-w64/include/stddef.h" 1 3 4
# 2 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 2 3 4
# 22 "./dht/dhtcore/test/VersionList_test.c" 2
...
# 23 "./dht/dhtcore/test/VersionList_test.c" 2


# 24 "./dht/dhtcore/test/VersionList_test.c"
int VersionList_test_main(int argc, char** argv);int VersionList_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<20),"VersionList_test.c",26);
    struct Random* rand = Random_new(alloc, 
# 27 "./dht/dhtcore/test/VersionList_test.c" 3 4
                                           ((void *)0)
# 27 "./dht/dhtcore/test/VersionList_test.c"
                                               , 
# 27 "./dht/dhtcore/test/VersionList_test.c" 3 4
                                                 ((void *)0)
# 27 "./dht/dhtcore/test/VersionList_test.c"
...
# 32 "./dht/dhtcore/test/VersionList_test.c" 3 4
                                                0xffffffffU 
# 32 "./dht/dhtcore/test/VersionList_test.c"
                                                           >> ((4-bytes) * 8);
            if (max < 2) {
                max += 2;
            }
            ...
            uint8_t* buff = Allocator__malloc((alloc),((str->len+1) * 2 + 1),"VersionList_test.c",43);
            ...
            do { if (!((vl->length == vl2->length && vl->length == count))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("VersionList_test.c"), (49), "(vl->length == vl2->length && vl->length == count)"); } } while (0);
            for (uint32_t i = 0; i < count; i++) {
                printf("[%d] [%d]\n", vl2->versions[i], vl->versions[i]);
                do { if (!((vl2->versions[i] == vl->versions[i]))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("VersionList_test.c"), (52), "(vl2->versions[i] == vl->versions[i])"); } } while (0);
            }
        }
    }

    Allocator__free((alloc),"VersionList_test.c",57);
    return 0;
}

# 1 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
# 15 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
# 1 "./interface/tuntap/TUNInterface.h" 1
# 18 "./interface/tuntap/TUNInterface.h"
# 1 "./util/events/EventBase.h" 1
# 18 "./util/events/EventBase.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03087210399602045;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08341069334227806;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 19 "./util/events/EventBase.h" 2

struct Linker_x009091683621131952;
...
# 19 "./interface/tuntap/TUNInterface.h" 2
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05509381194490359;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 20 "./interface/tuntap/TUNInterface.h" 2
# 1 "./exception/Except.h" 1
# 20 "./exception/Except.h"
struct Linker_x017762687556290668;
...
# 21 "./interface/tuntap/TUNInterface.h" 2


struct Linker_x040860528190078327;
# 49 "./interface/tuntap/TUNInterface.h"
struct Iface* TUNInterface_new(const char* interfaceName,
                                   char assignedInterfaceName[256],
                                   int isTapMode,
                                   struct EventBase* base,
                                   struct Log* logger,
                                   struct Except* eh,
                                   struct Allocator* alloc);
# 16 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
...
# 21 "./util/Bits.h"
struct Linker_x05371375715949174;
...
# 22 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x03559891215274922;
...
# 23 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./wire/Ethernet.h" 1
# 23 "./wire/Ethernet.h"
struct Ethernet
{
...
# 24 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./wire/Headers.h" 1
# 23 "./wire/Headers.h"
...
# 25 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./util/platform/netdev/NetDev.h" 1
# 20 "./util/platform/netdev/NetDev.h"
# 1 "./util/platform/Sockaddr.h" 1
# 21 "./util/platform/Sockaddr.h"
struct Linker_x003998552139807621;
...
# 21 "./util/platform/netdev/NetDev.h" 2

struct Linker_x08445919658523917;
...
void NetDev_setRoutes(const char* ifName,
                      ...
                      struct Except* eh);
# 26 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./test/RootTest.h" 1
# 18 "./test/RootTest.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x07853475792804412;
...
int RootTest_TUNInterface_ipv4_root_test_main(int argc, char** argv);
int TUNInterface_ipv4_root_test_main(int argc, char** argv);int TUNInterface_ipv4_root_test_main(int argc, char** argv)
{
    int runIt = 0;
    int j = 0;
    ...
    if (runIt) {
        return RootTest_TUNInterface_ipv4_root_test_main(j,argv);
    } else {
        fprintf(
# 47 "./test/RootTest.h" 3
               (__acrt_iob_func(2))
# 47 "./test/RootTest.h"
                     , "\nRoot test %s disabled, use [%s %s +roottest] to include it\n",
                "TUNInterface_ipv4_root_test",
                (argc > 0) ? argv[0] : "",
                "TUNInterface_ipv4_root_test");
    }
    return 0;
...
int RootTest_TUNInterface_ipv4_root_test_main(int argc, char** argv);
# 27 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2
# 1 "./interface/tuntap/test/TUNTools.h" 1
# 18 "./interface/tuntap/test/TUNTools.h"
...
# 19 "./interface/tuntap/test/TUNTools.h" 2





struct Linker_x05094664808852905;

struct TUNTools;

typedef __attribute__ ((warn_unused_result)) struct Iface* (* TUNTools_Callback)(struct Message* msg, struct TUNTools* tt);

__attribute__ ((warn_unused_result)) struct Iface* TUNTools_genericIP6Echo(struct Message* msg, struct TUNTools* tt);
...
void TUNTools_echoTest(struct Sockaddr* udpBindTo,
                       ...
                       struct Log* logger,
                       struct Allocator* alloc);
# 28 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 2


static const uint8_t testAddrA[4] = {11, 0, 0, 1};
static const uint8_t testAddrB[4] = {11, 0, 0, 2};

static __attribute__ ((warn_unused_result)) struct Iface* receiveMessageTUN(struct Message* msg, struct TUNTools* tt)
{
    uint16_t ethertype = TUNMessageType_pop(msg, 
# 35 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3 4
                                                ((void *)0)
# 35 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                                    );
    if (ethertype != ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x0800))); _x >> 8 | _x << 8; })))) {
        do { if (tt->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(tt->log, Log_Level_DEBUG, "TUNInterface_ipv4_root_test.c", 37, "Spurious packet with ethertype [%u]\n", ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(ethertype))); _x >> 8 | _x << 8; })))); } } while (0)
                                                      ;
        return 0;
    }
    ...
    do { if (!((msg->length == 20 + 8 + 12))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("TUNInterface_ipv4_root_test.c"), (44), "(msg->length == 20 + 8 + 12)"); } } while (0);

    do { if (!((!__builtin_memcmp(header->destAddr,testAddrB,4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("TUNInterface_ipv4_root_test.c"), (46), "(!__builtin_memcmp(header->destAddr,testAddrB,4))"); } } while (0);
    do { if (!((!__builtin_memcmp(header->sourceAddr,testAddrA,4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("TUNInterface_ipv4_root_test.c"), (47), "(!__builtin_memcmp(header->sourceAddr,testAddrA,4))"); } } while (0);

    Bits__memcpy(header->destAddr,testAddrA,4,"TUNInterface_ipv4_root_test.c",49);
    Bits__memcpy(header->sourceAddr,testAddrB,4,"TUNInterface_ipv4_root_test.c",50);

    TUNMessageType_push(msg, ethertype, 
# 52 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3 4
                                       ((void *)0)
# 52 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                           );
...
int RootTest_TUNInterface_ipv4_root_test_main(int argc, char** argv)
{
    ...
    struct Allocator* alloc = MallocAllocator__new((1<<20),"TUNInterface_ipv4_root_test.c",64);
    struct EventBase* base = EventBase_new(alloc);
    struct Log* logger = FileWriterLog_new(
# 66 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3
                                          (__acrt_iob_func(1))
# 66 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                                , alloc);
    ...
    char assignedIfName[256];
    struct Iface* tun = TUNInterface_new(
# 72 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3 4
                                        ((void *)0)
# 72 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                            , assignedIfName, 0, base, logger, 
# 72 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3 4
                                                                               ((void *)0)
# 72 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                                                                   , alloc);
    addrA->flags |= (1<<1);
    addrA->prefix = 30;
    NetDev_addAddress(assignedIfName, addrA, logger, 
# 75 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c" 3 4
                                                    ((void *)0)
# 75 "./interface/tuntap/test/TUNInterface_ipv4_root_test.c"
                                                        );

    TUNTools_echoTest(addrA, addrB, receiveMessageTUN, tun, base, logger, alloc);
    Allocator__free((alloc),"TUNInterface_ipv4_root_test.c",78);
    return 0;
}

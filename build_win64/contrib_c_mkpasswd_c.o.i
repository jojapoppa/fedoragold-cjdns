# 1 "contrib/c/mkpasswd.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "contrib/c/mkpasswd.c"
# 15 "contrib/c/mkpasswd.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x04816153792233968;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07535858235965855;
...
struct Linker_x05293304038067264;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x033678741233459597;
...
struct Linker_x06725906716925893;
...
struct Linker_x07955613002201047;
...
# 21 "contrib/c/mkpasswd.c" 2


# 22 "contrib/c/mkpasswd.c"
int main()
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"mkpasswd.c",24);
    struct Random* rand = Random_new(alloc, 
# 25 "contrib/c/mkpasswd.c" 3 4
                                           ((void *)0)
# 25 "contrib/c/mkpasswd.c"
                                               , 
# 25 "contrib/c/mkpasswd.c" 3 4
                                                 ((void *)0)
# 25 "contrib/c/mkpasswd.c"

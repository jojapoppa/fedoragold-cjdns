# 1 "./dht/test/DHTModules_handleIncoming_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./dht/test/DHTModules_handleIncoming_test.c"
# 15 "./dht/test/DHTModules_handleIncoming_test.c"
# 1 "./dht/DHTModule.h" 1
# 22 "./dht/DHTModule.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0023043823846196743;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07499535346382384;
...
struct Linker_x07835628916112467;
...
# 16 "./dht/test/DHTModules_handleIncoming_test.c" 2
...
struct Linker_x005192863014035143;
...
# 21 "./dht/test/DHTModules_handleIncoming_test.c" 2


# 22 "./dht/test/DHTModules_handleIncoming_test.c"
struct Context
{
...
static int testInputHandler()
{
    ...
    struct Allocator* allocator = MallocAllocator__new((2048),"DHTModules_handleIncoming_test.c",66);
    ...
    if (context.ret == -1) {
        ...
        Allocator__free((allocator),"DHTModules_handleIncoming_test.c",86);
        return 0;
    }
    return -1;
}

int DHTModules_handleIncoming_test_main(int argc, char** argv);int DHTModules_handleIncoming_test_main(int argc, char** argv)
{

# 1 "util/log/FileWriterLog.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "util/log/FileWriterLog.c"
# 15 "util/log/FileWriterLog.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02436692220763388;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05654022693109002;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0004035395990646284;
...
struct Linker_x003286974709666457;
...
# 16 "util/log/FileWriterLog.c" 2
# 1 "./util/log/WriterLog.h" 1
# 19 "./util/log/WriterLog.h"
# 1 "./io/Writer.h" 1
# 18 "./io/Writer.h"
...
# 18 "util/log/FileWriterLog.c" 2

# 1 "./io/FileWriter.h" 1
# 21 "./io/FileWriter.h"
struct Linker_x047703859997249176;
# 30 "./io/FileWriter.h"
struct Writer* FileWriter_new(FILE* writeTo, struct Allocator* allocator);
# 20 "util/log/FileWriterLog.c" 2

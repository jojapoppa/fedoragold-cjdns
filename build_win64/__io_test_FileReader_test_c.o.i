# 1 "./io/test/FileReader_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./io/test/FileReader_test.c"
# 15 "./io/test/FileReader_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0921915525609805;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x02847944696404734;
...
struct Linker_x06329744768135281;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x023789740683471505;
...
struct Linker_x03643150034803466;
...
struct Linker_x012447535748491201;
...
# 16 "./io/test/FileReader_test.c" 2
# 1 "./io/Reader.h" 1
# 23 "./io/Reader.h"
struct Reader {
# 33 "./io/Reader.h"
...
# 17 "./io/test/FileReader_test.c" 2
# 1 "./io/FileReader.h" 1
# 21 "./io/FileReader.h"
struct Linker_x02652693631836114;
...
# 22 "./io/test/FileReader_test.c" 2



# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stdbool.h" 1 3 4
# 26 "./io/test/FileReader_test.c" 2

int FileReader_test_main(int argc, char** argv);int FileReader_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((2048),"FileReader_test.c",29);
    struct Random* rand = Random_new(alloc, 
# 30 "./io/test/FileReader_test.c" 3 4
                                           ((void *)0)
# 30 "./io/test/FileReader_test.c"
                                               , 
# 30 "./io/test/FileReader_test.c" 3 4
                                                 ((void *)0)
# 30 "./io/test/FileReader_test.c"
    ...
    (r)->read((r), (buffer2), (128));
    (r)->skip((r), (128));
    (r)->read((r), (buffer2+128), (128));
    (r)->skip((r), (512));
    (r)->read((r), (buffer2+128+128), (256));
    (r)->skip((r), (300));
    (r)->read((r), (buffer2+128+128+256), (128));

    do { if (!((r->bytesRead == 128+128+128+512+256+300+128))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("FileReader_test.c"), (54), "(r->bytesRead == 128+128+128+512+256+300+128)"); } } while (0);
    ...
    do { if (!((!__builtin_memcmp(ptr1,ptr2,128)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("FileReader_test.c"), (62), "(!__builtin_memcmp(ptr1,ptr2,128))"); } } while (0); ptr1 += 128; ptr2 += 128;
    ptr1 += 128;
    do { if (!((!__builtin_memcmp(ptr1,ptr2,128)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("FileReader_test.c"), (64), "(!__builtin_memcmp(ptr1,ptr2,128))"); } } while (0); ptr1 += 128; ptr2 += 128;
    ptr1 += 512;
    do { if (!((!__builtin_memcmp(ptr1,ptr2,256)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("FileReader_test.c"), (66), "(!__builtin_memcmp(ptr1,ptr2,256))"); } } while (0); ptr1 += 256; ptr2 += 256;
    ptr1 += 300;
    do { if (!((!__builtin_memcmp(ptr1,ptr2,128)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("FileReader_test.c"), (68), "(!__builtin_memcmp(ptr1,ptr2,128))"); } } while (0); ptr1 += 128; ptr2 += 128;

    Allocator__free((alloc),"FileReader_test.c",70);
    return 0;
}

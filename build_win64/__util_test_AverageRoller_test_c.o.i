# 1 "./util/test/AverageRoller_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./util/test/AverageRoller_test.c"
# 15 "./util/test/AverageRoller_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x014419451335314593;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07575665077721019;
...
# 20 "./util/events/EventBase.h"
struct Linker_x05498457559066099;
...
struct Linker_x005151758384346938;
...
# 17 "./util/test/AverageRoller_test.c" 2
# 1 "./util/AverageRoller_pvt.h" 1
# 21 "./util/AverageRoller_pvt.h"
struct Linker_x0720743258257351;
...
# 18 "./util/test/AverageRoller_test.c" 2
...
# 21 "./util/test/AverageRoller_test.c" 2


# 22 "./util/test/AverageRoller_test.c"
int AverageRoller_test_main(int argc, char** argv);int AverageRoller_test_main(int argc, char** argv)
{


    const uint32_t testData[13][3] =
        {
    ...
    struct Allocator* allocator = MallocAllocator__new((4096),"AverageRoller_test.c",49);
    ...
    Allocator__free((allocator),"AverageRoller_test.c",72);
    return ret;
}

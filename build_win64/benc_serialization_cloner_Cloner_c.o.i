# 1 "benc/serialization/cloner/Cloner.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "benc/serialization/cloner/Cloner.c"
# 15 "benc/serialization/cloner/Cloner.c"
# 1 "./benc/serialization/cloner/Cloner.h" 1
# 18 "./benc/serialization/cloner/Cloner.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03279123621000317;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x024558396552592732;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 19 "./benc/serialization/cloner/Cloner.h" 2
# 1 "./benc/List.h" 1
# 19 "./benc/List.h"
# 1 "./benc/Object.h" 1
# 18 "./benc/Object.h"
...
struct Linker_x09060124165412238;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x09628237129610897;
...
# 21 "./benc/serialization/cloner/Cloner.h" 2
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08266637042697453;
...
struct Linker_x026986553919884915;
...
# 22 "./benc/serialization/cloner/Cloner.h" 2

struct Linker_x0052044435069808825;
...
# 16 "benc/serialization/cloner/Cloner.c" 2
...
{
    if (!orig) { return 
# 25 "benc/serialization/cloner/Cloner.c" 3 4
                       ((void *)0)
# 25 "benc/serialization/cloner/Cloner.c"
                           ; }
    struct List_Item* out = Allocator__malloc((alloc),(sizeof(struct List_Item)),"Cloner.c",26);
...
{
    if (!orig) { return 
# 34 "benc/serialization/cloner/Cloner.c" 3 4
                       ((void *)0)
# 34 "benc/serialization/cloner/Cloner.c"
                           ; }
    struct Dict_Entry* out = Allocator__malloc((alloc),(sizeof(struct Dict_Entry)),"Cloner.c",35);
    out->key = ((orig->key) ? String_newBinary(orig->key->bytes, orig->key->len, alloc) : 
# 36 "benc/serialization/cloner/Cloner.c" 3 4
              ((void *)0)
# 36 "benc/serialization/cloner/Cloner.c"
              );
...
static Object* clone(Object* orig, struct Allocator* alloc)
{
    Object* out = Allocator__malloc((alloc),(sizeof(Object)),"Cloner.c",44);
    out->type = orig->type;
    switch (orig->type) {
        case Object_INTEGER: out->as.number = orig->as.number; break;
        case Object_STRING: out->as.string = ((orig->as.string) ? String_newBinary(orig->as.string->bytes, orig->as.string->len, alloc) : 
# 48 "benc/serialization/cloner/Cloner.c" 3 4
                                            ((void *)0)
# 48 "benc/serialization/cloner/Cloner.c"
                                            ); break;
        ...
        default: do { if (!((0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Cloner.c"), (51), "(0)"); } } while (0);
    }
    return out;
}
...
Dict* Cloner_cloneDict(Dict* orig, struct Allocator* alloc)
{
    Dict* out = Allocator__malloc((alloc),(sizeof(Dict)),"Cloner.c",58);
...
List* Cloner_cloneList(List* orig, struct Allocator* alloc)
{
    List* out = Allocator__malloc((alloc),(sizeof(List)),"Cloner.c",65);

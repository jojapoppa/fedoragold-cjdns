# 1 "./dht/test/DHTModules_handleOutgoing_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./dht/test/DHTModules_handleOutgoing_test.c"
# 15 "./dht/test/DHTModules_handleOutgoing_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x04619743655797883;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08114195767814325;
...
struct Linker_x05127433500596339;
...
# 16 "./dht/test/DHTModules_handleOutgoing_test.c" 2
# 1 "./dht/DHTModule.h" 1
# 29 "./dht/DHTModule.h"
struct DHTModule;
struct DHTModule {
...
# 17 "./dht/test/DHTModules_handleOutgoing_test.c" 2
...
struct Linker_x03755721321007448;
...
# 22 "./dht/test/DHTModules_handleOutgoing_test.c" 2


# 23 "./dht/test/DHTModules_handleOutgoing_test.c"
struct Context
{
...
static int testOutputHandler()
{
    ...
    struct Allocator* allocator = MallocAllocator__new((2048),"DHTModules_handleOutgoing_test.c",56);
    ...
    if (context.ret == -1) {
        ...
        Allocator__free((allocator),"DHTModules_handleOutgoing_test.c",71);
        return 0;
    }
    return -1;
}

int DHTModules_handleOutgoing_test_main(int argc, char** argv);int DHTModules_handleOutgoing_test_main(int argc, char** argv)
{

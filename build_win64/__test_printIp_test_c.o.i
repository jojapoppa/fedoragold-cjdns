# 1 "./test/printIp_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./test/printIp_test.c"
# 16 "./test/printIp_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x008004622058046373;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x008090038381876763;
...
struct Linker_x09019189333940765;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05547781855267044;
...
struct Linker_x04924835075552312;
...
struct Linker_x08198423539457966;
...
# 19 "./test/printIp_test.c" 2

# 1 "./util/AddrTools.h" 1
# 19 "./util/AddrTools.h"
struct Linker_x03442985049871732;
...
# 21 "./test/printIp_test.c" 2

# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x04110515686444174;
...
# 23 "./test/printIp_test.c" 2



int printIp_test_main(int argc, char** argv);int printIp_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"printIp_test.c",28);
    struct Random* rand = Random_new(alloc, 
# 29 "./test/printIp_test.c" 3 4
                                           ((void *)0)
# 29 "./test/printIp_test.c"
                                               , 
# 29 "./test/printIp_test.c" 3 4
                                                 ((void *)0)
# 29 "./test/printIp_test.c"
...
# 30 "./test/printIp_test.c" 3
                                       (__acrt_iob_func(1))
# 30 "./test/printIp_test.c"
                                             , alloc);
    ...
    for (int i = 0; i < 1024; ++i) {
        ...
        do { if (log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(log, Log_Level_DEBUG, "printIp_test.c", 53, "print/parse %s", printedIp); } } while (0);

        do { if (!((0 == __builtin_memcmp(ip,ipFromFull,16)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("printIp_test.c"), (55), "(0 == __builtin_memcmp(ip,ipFromFull,16))"); } } while (0);
        do { if (!((0 == __builtin_memcmp(ipFromFull,ipFromShort,16)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("printIp_test.c"), (56), "(0 == __builtin_memcmp(ipFromFull,ipFromShort,16))"); } } while (0);
    }
    Allocator__free((alloc),"printIp_test.c",58);
    return 0;
}

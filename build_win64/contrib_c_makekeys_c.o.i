# 1 "contrib/c/makekeys.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "contrib/c/makekeys.c"
# 15 "contrib/c/makekeys.c"
# 1 "./crypto/Key.h" 1
# 18 "./crypto/Key.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x0926596734739948;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09684845951851553;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x02255193992520066;
...
struct Linker_x04054807898975412;
...
struct Linker_x06960391617147461;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06876210682271484;
...
struct Linker_x06351985758658676;
...
struct Linker_x04600407740725312;
...
struct Linker_x01820741546772715;
...
# 19 "contrib/c/makekeys.c" 2
# 1 "./util/AddrTools.h" 1
# 19 "./util/AddrTools.h"
struct Linker_x019636433267494469;
...
# 21 "contrib/c/makekeys.c" 2
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07920579207721041;
# 32 "./util/Hex.h"
...
# 18 "/usr/share/mingw-w64/include/signal.h" 3
 typedef int sig_atomic_t;
# 48 "/usr/share/mingw-w64/include/signal.h" 3
  typedef void (*__p_sig_fn_t)(int);
# 57 "/usr/share/mingw-w64/include/signal.h" 3
...
# 25 "contrib/c/makekeys.c" 2


# 26 "contrib/c/makekeys.c"
int main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"makekeys.c",28);
    struct Random* rand = Random_new(alloc, 
# 29 "contrib/c/makekeys.c" 3 4
                                           ((void *)0)
# 29 "contrib/c/makekeys.c"
                                               , 
# 29 "contrib/c/makekeys.c" 3 4
                                                 ((void *)0)
# 29 "contrib/c/makekeys.c"
    ...
    for (;;) {
        ...
        fflush(
# 50 "contrib/c/makekeys.c" 3
              (__acrt_iob_func(1))
# 50 "contrib/c/makekeys.c"
                    );
    }
    return 0;
}

# 1 "interface/tuntap/BSDMessageTypeWrapper.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/tuntap/BSDMessageTypeWrapper.c"
# 15 "interface/tuntap/BSDMessageTypeWrapper.c"
...
struct Linker_x06211111488360039;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x02506617332141756;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x043359388862281745;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07411125367708347;
...
struct Linker_x005886822750713572;
...
# 17 "interface/tuntap/BSDMessageTypeWrapper.c" 2
# 1 "./util/platform/Sockaddr.h" 1
# 21 "./util/platform/Sockaddr.h"
struct Linker_x08289462363341422;
...
# 18 "interface/tuntap/BSDMessageTypeWrapper.c" 2
...
# 22 "interface/tuntap/BSDMessageTypeWrapper.c" 2
...
# 24 "interface/tuntap/BSDMessageTypeWrapper.c" 2
...
static __attribute__ ((warn_unused_result)) struct Iface* receiveMessage(struct Message* msg, struct Iface* wireSide)
{
    struct BSDMessageTypeWrapper_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct BSDMessageTypeWrapper_pvt*)0)->pub.wireSide)*__mptr = (wireSide); (__extension__ ({ __typeof__((struct BSDMessageTypeWrapper_pvt*)((char*)__mptr - 
# 43 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
       __builtin_offsetof (
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
       struct BSDMessageTypeWrapper_pvt
# 43 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
       , 
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
...
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
       )) Identity_ptr = ((struct BSDMessageTypeWrapper_pvt*)((char*)__mptr - 
# 43 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
       __builtin_offsetof (
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
       struct BSDMessageTypeWrapper_pvt
...
# 43 "interface/tuntap/BSDMessageTypeWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x45b5208b725a4370ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (43), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x45b5208b725a4370ull))"); } } while (0); Identity_ptr; })); }));
    ...
    if (afType_be == ctx->afInet_be) {
        ethertype = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x0800))); _x >> 8 | _x << 8; })));
    } else if (afType_be == ctx->afInet6_be) {
        ethertype = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; })));
    } else {
        do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "BSDMessageTypeWrapper.c", 54, "Message of unhandled aftype [0x%04x]", ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(afType_be))); _x >> 8 | _x << 8; })))); } } while (0)
                                                      ;
        return 0;
    }
...
static __attribute__ ((warn_unused_result)) struct Iface* sendMessage(struct Message* msg, struct Iface* inside)
{
    struct BSDMessageTypeWrapper_pvt* ctx =
        (__extension__ ({ const __typeof__(((struct BSDMessageTypeWrapper_pvt*)0)->pub.inside)*__mptr = (inside); (__extension__ ({ __typeof__((struct BSDMessageTypeWrapper_pvt*)((char*)__mptr - 
# 67 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
       __builtin_offsetof (
# 67 "interface/tuntap/BSDMessageTypeWrapper.c"
       struct BSDMessageTypeWrapper_pvt
# 67 "interface/tuntap/BSDMessageTypeWrapper.c" 3 4
       , 
# 67 "interface/tuntap/BSDMessageTypeWrapper.c"
...
# 67 "interface/tuntap/BSDMessageTypeWrapper.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x45b5208b725a4370ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (67), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x45b5208b725a4370ull))"); } } while (0); Identity_ptr; })); }));

    do { if (!((msg->length >= 4))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (69), "(msg->length >= 4)"); } } while (0);
    ...
    } else if (ethertype == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x0800))); _x >> 8 | _x << 8; })))) {
        afType_be = ctx->afInet_be;
    } else {
        do { if (!((!"Unsupported ethertype"))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("BSDMessageTypeWrapper.c"), (78), "(!\"Unsupported ethertype\")"); } } while (0);
    }
    ((uint16_t*) msg->bytes)[0] = 0;
...
struct BSDMessageTypeWrapper* BSDMessageTypeWrapper_new(struct Allocator* alloc, struct Log* log)
{
    struct BSDMessageTypeWrapper_pvt* context =
        Allocator__calloc((alloc),(sizeof(struct BSDMessageTypeWrapper_pvt)),(1),"BSDMessageTypeWrapper.c",89);
    (context)->Identity_verifier = ((unsigned long) 0x45b5208b725a4370ull);
    context->pub.wireSide.send = receiveMessage;
    context->pub.inside.send = sendMessage;
    context->afInet6_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(Sockaddr_AF_INET6))); _x >> 8 | _x << 8; })));
    context->afInet_be = ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(Sockaddr_AF_INET))); _x >> 8 | _x << 8; })));
    context->logger = log;

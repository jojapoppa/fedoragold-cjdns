# 1 "./crypto/test/CryptoAuth_fuzz_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./crypto/test/CryptoAuth_fuzz_test.c"
# 15 "./crypto/test/CryptoAuth_fuzz_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x07540428495133871;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x033166720148585815;
...
struct Linker_x05755218304014988;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0012872669683312132;
...
struct Linker_x09042246986109221;
...
struct Linker_x09805445775112198;
...
# 16 "./crypto/test/CryptoAuth_fuzz_test.c" 2
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x045787449283045056;
...
struct Linker_x07261620467233623;
...
# 21 "./util/ArrayList.h"
struct Linker_x032745353101628694;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09266637289547222;
...
struct Linker_x018201712194091546;
...
struct Linker_x008432651190552365;
...
# 23 "./crypto/test/CryptoAuth_fuzz_test.c" 2

# 1 "./util/log/FileWriterLog.h" 1
# 21 "./util/log/FileWriterLog.h"
struct Linker_x045660749926454214;
...
# 28 "./crypto/test/CryptoAuth_fuzz_test.c" 2
# 1 "./test/FuzzTest.h" 1
# 22 "./test/FuzzTest.h"
void CryptoAuth_fuzz_test_FUZZ_MAIN(void* vctx, struct Message* fuzz);
void* CryptoAuth_fuzz_test_FUZZ_INIT(struct Allocator* alloc, struct Random* rand);
# 29 "./crypto/test/CryptoAuth_fuzz_test.c" 2
...
# 73 "./crypto/test/CryptoAuth_fuzz_test.c"
static 
# 73 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
      _Bool 
# 73 "./crypto/test/CryptoAuth_fuzz_test.c"
           maybe(struct Context* ctx, uint32_t chanceIsOneInWhat)
{
...
{
    if ((node) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 80, "(nodeA) " "%s", ("RESET")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 80, "(nodeB) " "%s", ("RESET")); } } while (0); };
...
static 
# 89 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
      _Bool 
# 89 "./crypto/test/CryptoAuth_fuzz_test.c"
           isMutableBit(int bitNum)
{

    if (bitNum == 31) {
        return 
# 93 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
              1
# 93 "./crypto/test/CryptoAuth_fuzz_test.c"
                  ;
    }

    if (bitNum >= 40 && bitNum <= 127) {
        return 
# 97 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
              1
# 97 "./crypto/test/CryptoAuth_fuzz_test.c"
                  ;
    }
    ...
    if (bitNum == 568) {
        return 
# 102 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
              1
# 102 "./crypto/test/CryptoAuth_fuzz_test.c"
                  ;
    }


    return 
# 106 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
          0
# 106 "./crypto/test/CryptoAuth_fuzz_test.c"
               ;
}

static void flipBit(struct Message* msg, uint32_t bitNum)
{
    do { if (!((msg->length * 8 > (int)bitNum))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (111), "(msg->length * 8 > (int)bitNum)"); } } while (0);
...
static void flipMutableBit(struct Context* ctx, struct Node* from, struct Message* msg)
{
    uint32_t bitNum;
    do {
        bitNum = Random_uint8(ctx->rand) % (127 + 1);
    } while (!isMutableBit(bitNum));
    if (from == &ctx->nodeA) { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 121, "(nodeA) " "FLIPPING MUTABLE BIT %u", bitNum); } } while (0); } else { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 121, "(nodeB) " "FLIPPING MUTABLE BIT %u", bitNum); } } while (0); };
    flipBit(msg, bitNum);
}
...
static void flipImmutableBit(struct Context* ctx, struct Node* from, struct Message* msg)
{
    ...
    if (from == &ctx->nodeA) { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 131, "(nodeA) " "FLIPPING IMMUTABLE BIT %u", bitNum); } } while (0); } else { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 131, "(nodeB) " "FLIPPING IMMUTABLE BIT %u", bitNum); } } while (0); };
    flipBit(msg, bitNum);
}
...
static int queuedMessageCount(struct Node* node)
{
    ...
    for (struct DelayedMsg* dm = node->delayedMsgs; dm; dm = dm->next) {
        do { if (!((!dm->next || dm->next->sendAfter >= dm->sendAfter))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (139), "(!dm->next || dm->next->sendAfter >= dm->sendAfter)"); } } while (0);
        i++;
    }
    return i;
}
...
static void duplicate(struct Context* ctx, struct Node* from, struct Message* msg)
{
    if (queuedMessageCount(from) > 500) {
        if ((from) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 148, "(nodeA) " "%s", ("OOM can't duplicate")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 148, "(nodeB) " "%s", ("OOM can't duplicate")); } } while (0); };
        return;
    }
    if ((from) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 151, "(nodeA) " "%s", ("DUPLICATE")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 151, "(nodeB) " "%s", ("DUPLICATE")); } } while (0); };
    struct Allocator* alloc = Allocator__child((ctx->alloc),"CryptoAuth_fuzz_test.c",152);
    struct DelayedMsg* delayed = Allocator__calloc((alloc),(sizeof(struct DelayedMsg)),(1),"CryptoAuth_fuzz_test.c",153);
...
{
    if (queuedMessageCount(from) > 500) {
        if ((from) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 163, "(nodeA) " "%s", ("OOM can't delay (drop instead)")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 163, "(nodeB) " "%s", ("OOM can't delay (drop instead)")); } } while (0); };
        return;
    }

    if (from == &ctx->nodeA) { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 167, "(nodeA) " "DELAY %d packets", afterMsgs); } } while (0); } else { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 167, "(nodeB) " "DELAY %d packets", afterMsgs); } } while (0); };



    struct Allocator* alloc = Allocator__child((ctx->alloc),"CryptoAuth_fuzz_test.c",171);
    struct DelayedMsg* delayed = Allocator__calloc((alloc),(sizeof(struct DelayedMsg)),(1),"CryptoAuth_fuzz_test.c",172);
    Allocator__adopt((alloc),(msg->alloc),"CryptoAuth_fuzz_test.c",173);
    delayed->msg = msg;
...
static void sendFrom(struct Context* ctx, struct Node* from, struct Message* msg)
{
    ...
    if ((from) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 189, "(nodeA) " "%s", ("SEND")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 189, "(nodeB) " "%s", ("SEND")); } } while (0); };


    if (maybe(ctx, 20)) {
        if ((from) == &(ctx)->nodeA) { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 193, "(nodeA) " "%s", ("DROP")); } } while (0); } else { do { if (((ctx))->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(((ctx))->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 193, "(nodeB) " "%s", ("DROP")); } } while (0); };
        return;
    }
...
# 210 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
   _Bool 
# 210 "./crypto/test/CryptoAuth_fuzz_test.c"
        flippedImmutable = 
# 210 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                           0
# 210 "./crypto/test/CryptoAuth_fuzz_test.c"
    ...
    if (maybe(ctx, 20)) {
        ...
        flippedImmutable = 
# 213 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                          1
# 213 "./crypto/test/CryptoAuth_fuzz_test.c"
                              ;
    }

    if (!CryptoAuth_decrypt(to->session, msg)) {
        do { if (!((!flippedImmutable))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (217), "(!flippedImmutable)"); } } while (0);
        do { if (!((msg->length == 4 && !__builtin_memcmp(msg->bytes,"hey",4)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (218), "(msg->length == 4 && !__builtin_memcmp(msg->bytes,\"hey\",4))"); } } while (0);
        if (to == &ctx->nodeB) {

            if (maybe(ctx, 10)) {
                return;
            }
            do { if (!((!CryptoAuth_encrypt(to->session, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (224), "(!CryptoAuth_encrypt(to->session, msg))"); } } while (0);
            to->sendCounter++;
            sendFrom(ctx, to, msg);
...
static 
# 235 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
      _Bool 
# 235 "./crypto/test/CryptoAuth_fuzz_test.c"
           sendQueued(struct Context* ctx, struct Node* fromNode)
{
    if (!fromNode->delayedMsgs || fromNode->delayedMsgs->sendAfter > fromNode->sendCounter) {
        return 
# 238 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
              0
# 238 "./crypto/test/CryptoAuth_fuzz_test.c"
                   ;
    }
    ...
    if (fromNode == &ctx->nodeA) { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 244, "(nodeA) " "SENDING QUEUED... %d", fromNode->delayedMsgs->sendAfter); } } while (0); } else { do { if ((ctx)->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print((ctx)->log, Log_Level_DEBUG, "CryptoAuth_fuzz_test.c", 244, "(nodeB) " "SENDING QUEUED... %d", fromNode->delayedMsgs->sendAfter); } } while (0); };




    sendFrom(ctx, fromNode, dmsg->msg);
    Allocator__free((dmsg->alloc),"CryptoAuth_fuzz_test.c",250);
    return 
# 251 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
          1
# 251 "./crypto/test/CryptoAuth_fuzz_test.c"
              ;
}
...
static void mainLoop(struct Context* ctx)
{
    for (int i = 0; i < 500000; i++) {
        if (ctx->successMessageCount > 5) { return; }
        if (maybe(ctx, 800)) {
        ...
        struct Allocator* alloc = Allocator__child((ctx->alloc),"CryptoAuth_fuzz_test.c",269);
        struct Message* msg = Message_new(0, 512, alloc);
        Message_push(msg, "hey", 4, 
# 271 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                   ((void *)0)
# 271 "./crypto/test/CryptoAuth_fuzz_test.c"
                                       );
        do { if (!((!CryptoAuth_encrypt(ctx->nodeA.session, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (272), "(!CryptoAuth_encrypt(ctx->nodeA.session, msg))"); } } while (0);
        sendFrom(ctx, &ctx->nodeA, msg);
        Allocator__free((alloc),"CryptoAuth_fuzz_test.c",274);
    }
...
void* CryptoAuth_fuzz_test_FUZZ_INIT(struct Allocator* alloc, struct Random* rand)
{
    struct Context* ctx = Allocator__calloc((alloc),(sizeof(struct Context)),(1),"CryptoAuth_fuzz_test.c",282);
    (ctx)->Identity_verifier = ((unsigned long) 0x2e998ac81222b2ddull);
    struct EventBase* base = EventBase_new(alloc);
    ctx->alloc = alloc;
    ctx->nodeA.ca = CryptoAuth_new(alloc, 
# 286 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                         ((void *)0)
# 286 "./crypto/test/CryptoAuth_fuzz_test.c"
                                             , base, 
# 286 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                     ((void *)0)
# 286 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                         , rand);
    ctx->nodeB.ca = CryptoAuth_new(alloc, 
# 287 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                         ((void *)0)
# 287 "./crypto/test/CryptoAuth_fuzz_test.c"
                                             , base, 
# 287 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                     ((void *)0)
# 287 "./crypto/test/CryptoAuth_fuzz_test.c"
    ...
    ctx->nodeA.session = CryptoAuth_newSession(
        ctx->nodeA.ca, alloc, ctx->nodeB.ca->publicKey, 
# 289 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                       0
# 289 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                            , "nodeA");
    ctx->nodeB.session = CryptoAuth_newSession(
        ctx->nodeB.ca, alloc, ctx->nodeA.ca->publicKey, 
# 291 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                       0
# 291 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                            , "nodeB");
    return ctx;
}
...
void CryptoAuth_fuzz_test_FUZZ_MAIN(void* vctx, struct Message* fuzz)
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vctx) Identity_ptr = ((struct Context*) vctx); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x2e998ac81222b2ddull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_fuzz_test.c"), (297), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x2e998ac81222b2ddull))"); } } while (0); Identity_ptr; }));


    struct RandomSeed* rs = DeterminentRandomSeed_new(ctx->alloc, fuzz->bytes);
    ctx->rand = Random_newWithSeed(ctx->alloc, 
# 301 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                              ((void *)0)
# 301 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                  , rs, 
# 301 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                        ((void *)0)
# 301 "./crypto/test/CryptoAuth_fuzz_test.c"
    ...
    if (maybe(ctx, 2)) {
        CryptoAuth_addUser_ipv6((&(String) { .bytes = "pass", .len = CString_strlen("pass") }), (&(String) { .bytes = "user", .len = CString_strlen("user") }), 
# 304 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                                           ((void *)0)
# 304 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                                               , ctx->nodeB.ca);
    } else {
        uint8_t nodeAAddress[16];
        AddressCalc_addressForPublicKey(nodeAAddress, ctx->nodeA.ca->publicKey);
        CryptoAuth_addUser_ipv6((&(String) { .bytes = "pass", .len = CString_strlen("pass") }),
                                (&(String) { .bytes = "user", .len = CString_strlen("user") }),
                                nodeAAddress,
                                ctx->nodeB.ca);
    }
    if (maybe(ctx, 3)) {

        CryptoAuth_removeUsers(ctx->nodeB.ca, (&(String) { .bytes = "user", .len = CString_strlen("user") }));
    } else if (maybe(ctx, 2)) {

        CryptoAuth_setAuth((&(String) { .bytes = "pass", .len = CString_strlen("pass") }), (&(String) { .bytes = "user", .len = CString_strlen("user") }), ctx->nodeA.session);
    } else {

        CryptoAuth_setAuth((&(String) { .bytes = "pass", .len = CString_strlen("pass") }), 
# 321 "./crypto/test/CryptoAuth_fuzz_test.c" 3 4
                                                ((void *)0)
# 321 "./crypto/test/CryptoAuth_fuzz_test.c"
                                                    , ctx->nodeA.session);
    }

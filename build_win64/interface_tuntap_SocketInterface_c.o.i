# 1 "interface/tuntap/SocketInterface.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "interface/tuntap/SocketInterface.c"
# 15 "interface/tuntap/SocketInterface.c"
# 1 "./interface/tuntap/SocketInterface.h" 1
# 18 "./interface/tuntap/SocketInterface.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x04378464981111756;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x025795275159794184;
...
struct Linker_x07021322399528127;
...
# 19 "./interface/tuntap/SocketInterface.h" 2
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x02614983101988071;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 20 "./interface/tuntap/SocketInterface.h" 2
# 1 "./exception/Except.h" 1
# 20 "./exception/Except.h"
struct Linker_x07456356662602033;
...
# 21 "./interface/tuntap/SocketInterface.h" 2


struct Linker_x012041579345103282;

# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stdbool.h" 1 3 4
# 26 "./interface/tuntap/SocketInterface.h" 2
# 37 "./interface/tuntap/SocketInterface.h"
struct Iface* SocketInterface_new(const char* socketFullPath,
                                    
# 38 "./interface/tuntap/SocketInterface.h" 3 4
                                   _Bool 
# 38 "./interface/tuntap/SocketInterface.h"
                                        attemptToCreate,
                                    struct EventBase* base,
                                    struct Log* logger,
                                    struct Except* eh,
                                    struct Allocator* alloc);
# 16 "interface/tuntap/SocketInterface.c" 2
...
# 21 "./util/Bits.h"
struct Linker_x09731468746145187;
...
struct Linker_x08953953887386608;
...
struct Pipe* Pipe_forFiles(int inFd,
                           ...
                           struct Log* logger,
                           struct Allocator* userAlloc);
# 20 "interface/tuntap/SocketInterface.c" 2

struct Iface* SocketInterface_new(const char* socketFullPath,
                                    
# 22 "interface/tuntap/SocketInterface.c" 3 4
                                   _Bool 
# 22 "interface/tuntap/SocketInterface.c"
                                        attemptToCreate,
                                    struct EventBase* base,
                                    struct Log* logger,
                                    struct Except* eh,
                                    struct Allocator* alloc)
{
    do { if (logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(logger, Log_Level_INFO, "SocketInterface.c", 28, "Initializing socket: %s;", socketFullPath); } } while (0);

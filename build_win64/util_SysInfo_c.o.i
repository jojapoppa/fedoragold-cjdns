...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08932406998971523;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x011964005408010703;
...
# 1 "./util/SysInfo.h" 1
# 22 "./util/SysInfo.h"
struct Linker_x04659598179205098;
...
struct Linker_x09061916341626775;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x038981392129974823;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x01634149914201326;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0675632579909359;
...
static char* getName(enum SysInfo_Os os)
{
    switch (os) {
        ...
        case SysInfo_Os_WIN64: return "win64";

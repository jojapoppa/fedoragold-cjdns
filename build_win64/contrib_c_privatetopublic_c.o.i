...
# 16 "contrib/c/privatetopublic.c" 2
# 1 "./dht/Address.h" 1
# 18 "./dht/Address.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
...
struct Linker_x000420074283562033;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06675280176967067;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05449273449164427;
...
struct Linker_x06496408248347141;
...
struct Linker_x09786636653030987;
# 34 "./dht/Address.h"
struct Address
{
...
# 17 "contrib/c/privatetopublic.c" 2
# 1 "./util/Base32.h" 1
# 44 "./util/Base32.h"
...
# 18 "contrib/c/privatetopublic.c" 2
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x06897432349227797;
# 32 "./util/Hex.h"
...
# 19 "contrib/c/privatetopublic.c" 2
...
# 21 "contrib/c/privatetopublic.c" 2
...
# 23 "contrib/c/privatetopublic.c" 2
...
# 82 "/usr/share/mingw-w64/include/stdio.h" 3
...
# 683 "/usr/share/mingw-w64/include/stdio.h" 3
...
# 1398 "/usr/share/mingw-w64/include/stdio.h" 3
#pragma pack(pop)
...
# 24 "contrib/c/privatetopublic.c" 2
# 1 "/usr/share/mingw-w64/include/errno.h" 1 3
# 25 "contrib/c/privatetopublic.c" 2



# 27 "contrib/c/privatetopublic.c"
...
int main(int argc, char** argv)
{
    ...
    {
        fprintf(
# 59 "contrib/c/privatetopublic.c" 3
               (__acrt_iob_func(2))
# 59 "contrib/c/privatetopublic.c"
                     , "Reading private key failed: %s\n", strerror(
# 59 "contrib/c/privatetopublic.c" 3 4
                                                                    (*_errno())
# 59 "contrib/c/privatetopublic.c"
                                                                         ));
        return 1;
    ...
    if (AddressCalc_addressForPublicKey(address.ip6.bytes, address.key)) {
        ...
        fprintf(
# 82 "contrib/c/privatetopublic.c" 3
               (__acrt_iob_func(2))
# 82 "contrib/c/privatetopublic.c"

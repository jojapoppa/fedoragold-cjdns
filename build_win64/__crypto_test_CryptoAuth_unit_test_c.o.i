# 1 "./crypto/test/CryptoAuth_unit_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./crypto/test/CryptoAuth_unit_test.c"
# 15 "./crypto/test/CryptoAuth_unit_test.c"
# 1 "./benc/List.h" 1
# 18 "./benc/List.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08963959423834273;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x04137822454373854;
...
struct Linker_x016156200889326477;
...
# 16 "./crypto/test/CryptoAuth_unit_test.c" 2
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x003192395214152022;
...
struct Linker_x08260102213302838;
...
# 17 "./crypto/test/CryptoAuth_unit_test.c" 2
...
# 21 "./util/ArrayList.h"
struct Linker_x08120777594885455;
...
struct Linker_x0933733109992511;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x07270996119646294;
...
struct Linker_x08234282676707048;
...
struct Linker_x01174770618771741;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x09794529453719003;
...
struct Linker_x013521620873632445;
...
struct Linker_x07674757396586767;
...
struct Linker_x016215153385982606;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07726338252842648;
# 32 "./util/Hex.h"
...
# 29 "./crypto/test/CryptoAuth_unit_test.c" 2
# 39 "./crypto/test/CryptoAuth_unit_test.c"
static void encryptRndNonceTest()
{
    uint8_t buff[44];
    __builtin_memset(buff,0,44);

    uint8_t nonce[24];
    __builtin_memset(nonce,0,24);
    ...
    do { if (!((!__builtin_memcmp(expected,output,56)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (60), "(!__builtin_memcmp(expected,output,56))"); } } while (0);

    do { if (!((!CryptoAuth_decryptRndNonce(nonce, &m, secret)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (62), "(!CryptoAuth_decryptRndNonce(nonce, &m, secret))"); } } while (0);
    do { if (!((m.length == 12 && !__builtin_memcmp(m.bytes,"hello world",m.length)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (63), "(m.length == 12 && !__builtin_memcmp(m.bytes,\"hello world\",m.length))"); } } while (0);
}
...
# 68 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                                  ((void *)0)
# 68 "./crypto/test/CryptoAuth_unit_test.c"
                                                                      );
    return Random_newWithSeed(alloc, logger, evilSeed, 
# 69 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                      ((void *)0)
# 69 "./crypto/test/CryptoAuth_unit_test.c"
                                                          );
}
...
static struct Context* setUp(uint8_t* myPrivateKey,
                             ...
                             struct Allocator* alloc)
{
    struct Context* ctx = Allocator__calloc((alloc),(sizeof(struct Context)),(1),"CryptoAuth_unit_test.c",86);
    struct Log* log = ctx->log = FileWriterLog_new(
# 87 "./crypto/test/CryptoAuth_unit_test.c" 3
                                                  (__acrt_iob_func(1))
# 87 "./crypto/test/CryptoAuth_unit_test.c"
                                                        , alloc);
    ...
    struct CryptoAuth_Session* sess = ctx->sess =
        CryptoAuth_newSession(ca, alloc, herPublicKey, 
# 93 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                      0
# 93 "./crypto/test/CryptoAuth_unit_test.c"
                                                           , "CryptoAuth_unit_test.c");

    if (authPassword) {
        CryptoAuth_setAuth((&(String) { .bytes = authPassword, .len = CString_strlen(authPassword) }), 
# 96 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                      ((void *)0)
# 96 "./crypto/test/CryptoAuth_unit_test.c"
                                                          , sess);
    }
...
{
    do { if (!((CString_strlen((char*)expectedOutput) == 264))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (104), "(CString_strlen((char*)expectedOutput) == 264)"); } } while (0);
    struct Allocator* alloc = MallocAllocator__new((1<<20),"CryptoAuth_unit_test.c",105);
    struct Context* ctx = setUp(
# 106 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                               ((void *)0)
# 106 "./crypto/test/CryptoAuth_unit_test.c"
                                   , "wxyzabcdefghijklmnopqrstuv987654", password, alloc);
    struct Message* msg = Message_new(0, 120 + 12, alloc);
    Message_push(msg, "Hello World", 12, 
# 108 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                ((void *)0)
# 108 "./crypto/test/CryptoAuth_unit_test.c"
                                                    );

    do { if (!((!CryptoAuth_encrypt(ctx->sess, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (110), "(!CryptoAuth_encrypt(ctx->sess, msg))"); } } while (0);
    ...
    Allocator__free((alloc),"CryptoAuth_unit_test.c",118);
}

static void helloNoAuth()
{
    testHello(
# 123 "./crypto/test/CryptoAuth_unit_test.c" 3 4
             ((void *)0)
# 123 "./crypto/test/CryptoAuth_unit_test.c"
                 ,
...
static void receiveHelloWithNoAuth()
{
    ...
    do { if (!((Hex_decode(herPublic, 32, "847c0d2c375234f365e660955187a3735a0f7613d1609d3a6a4d8c53aeaa5a22", 64) > 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (144), "(Hex_decode(herPublic, 32, \"847c0d2c375234f365e660955187a3735a0f7613d1609d3a6a4d8c53aeaa5a22\", 64) > 0)"); } } while (0)
                                                                                    ;
    struct Allocator* alloc = MallocAllocator__new((1<<20),"CryptoAuth_unit_test.c",146);
    struct Context* ctx = setUp("0123456789abcdefghijklmnopqrstuv", herPublic, 
# 147 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                      ((void *)0)
# 147 "./crypto/test/CryptoAuth_unit_test.c"
                                                          , alloc);
    struct Message* msg = Message_new(132, 0, alloc);
    do { if (!((Hex_decode(msg->bytes, msg->length, "0000000000ffffffffffffff7fffffffffffffffffffffffffffffffffffffff" "ffffffffffffffff847c0d2c375234f365e660955187a3735a0f7613d1609d3a" "6a4d8c53aeaa5a22ea9cf275eee0185edf7f211192f12e8e642a325ed76925fe" "3c76d313b767a10aca584ca0b979dee990a737da7d68366fa3846d43d541de91" "29ea3e12", 132*2) > 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (149), "(Hex_decode(msg->bytes, msg->length, \"0000000000ffffffffffffff7fffffffffffffffffffffffffffffffffffffff\" \"ffffffffffffffff847c0d2c375234f365e660955187a3735a0f7613d1609d3a\" \"6a4d8c53aeaa5a22ea9cf275eee0185edf7f211192f12e8e642a325ed76925fe\" \"3c76d313b767a10aca584ca0b979dee990a737da7d68366fa3846d43d541de91\" \"29ea3e12\", 132*2) > 0)"); } } while (0)
    ...
    do { if (!((!CryptoAuth_decrypt(ctx->sess, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (156), "(!CryptoAuth_decrypt(ctx->sess, msg))"); } } while (0);
    do { if (!((msg->length == 12))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (157), "(msg->length == 12)"); } } while (0);
    do { if (!((__builtin_memcmp("Hello World",msg->bytes,12) == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (158), "(__builtin_memcmp(\"Hello World\",msg->bytes,12) == 0)"); } } while (0);
    Allocator__free((alloc),"CryptoAuth_unit_test.c",159);
...
static void repeatHello()
{
    ...
    struct Allocator* alloc = MallocAllocator__new((1<<20),"CryptoAuth_unit_test.c",172);
    struct Context* ctx = setUp(
# 173 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                               ((void *)0)
# 173 "./crypto/test/CryptoAuth_unit_test.c"
                                   , "wxyzabcdefghijklmnopqrstuv987654", "password", alloc);
    struct Message* msg = Message_new(0, 120 + 12, alloc);
    Message_push(msg, "Hello World", 12, 
# 175 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                ((void *)0)
# 175 "./crypto/test/CryptoAuth_unit_test.c"
                                                    );

    do { if (!((!CryptoAuth_encrypt(ctx->sess, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (177), "(!CryptoAuth_encrypt(ctx->sess, msg))"); } } while (0);

    Message_reset(msg);
    Message_push(msg, "Hello World", 12, 
# 180 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                ((void *)0)
# 180 "./crypto/test/CryptoAuth_unit_test.c"
                                                    );

    do { if (!((!CryptoAuth_encrypt(ctx->sess, msg)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (182), "(!CryptoAuth_encrypt(ctx->sess, msg))"); } } while (0);
    ...
    Allocator__free((alloc),"CryptoAuth_unit_test.c",190);
}

static void testGetUsers()
{
    struct Allocator* allocator = MallocAllocator__new((1<<20),"CryptoAuth_unit_test.c",195);
    struct EventBase* base = EventBase_new(allocator);
    struct CryptoAuth* ca =
        CryptoAuth_new(allocator, 
# 198 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                 ((void *)0)
# 198 "./crypto/test/CryptoAuth_unit_test.c"
                                     , base, 
# 198 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                             ((void *)0)
# 198 "./crypto/test/CryptoAuth_unit_test.c"
                                                 , evilRandom(allocator, 
# 198 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                                                                         ((void *)0)
# 198 "./crypto/test/CryptoAuth_unit_test.c"
                                                                             ));
    struct StringList* users = 
# 199 "./crypto/test/CryptoAuth_unit_test.c" 3 4
                              ((void *)0)
# 199 "./crypto/test/CryptoAuth_unit_test.c"
                                  ;

    users = CryptoAuth_getUsers(ca, allocator);
    do { if (!((users->length == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (202), "(users->length == 0)"); } } while (0);

    CryptoAuth_addUser((&(String) { .bytes = "pass1", .len = CString_strlen("pass1") }), (&(String) { .bytes = "user1", .len = CString_strlen("user1") }), ca);
    users = CryptoAuth_getUsers(ca, allocator);
    do { if (!((users->length == 1))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (206), "(users->length == 1)"); } } while (0);
    do { if (!((String_equals((&(String) { .bytes = "user1", .len = CString_strlen("user1") }), StringList_get(users,0))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (207), "(String_equals((&(String) { .bytes = \"user1\", .len = CString_strlen(\"user1\") }), StringList_get(users,0)))"); } } while (0);

    CryptoAuth_addUser((&(String) { .bytes = "pass2", .len = CString_strlen("pass2") }), (&(String) { .bytes = "user2", .len = CString_strlen("user2") }), ca);
    users = CryptoAuth_getUsers(ca, allocator);
    do { if (!((users->length == 2))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (211), "(users->length == 2)"); } } while (0);
    do { if (!((String_equals((&(String) { .bytes = "user2", .len = CString_strlen("user2") }),StringList_get(users,1))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (212), "(String_equals((&(String) { .bytes = \"user2\", .len = CString_strlen(\"user2\") }),StringList_get(users,1)))"); } } while (0);
    do { if (!((String_equals((&(String) { .bytes = "user1", .len = CString_strlen("user1") }),StringList_get(users,0))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("CryptoAuth_unit_test.c"), (213), "(String_equals((&(String) { .bytes = \"user1\", .len = CString_strlen(\"user1\") }),StringList_get(users,0)))"); } } while (0);

    Allocator__free((allocator),"CryptoAuth_unit_test.c",215);
}

int CryptoAuth_unit_test_main(int argc, char** argv);int CryptoAuth_unit_test_main(int argc, char** argv)
{
    testGetUsers();
    helloNoAuth();
    helloWithAuth();

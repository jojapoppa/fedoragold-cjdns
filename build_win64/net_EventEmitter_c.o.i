...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05324441710235484;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x0344483378141903;
...
# 19 "./util/version/Version.h"
struct Linker_x023505886212843596;
...
struct Linker_x009998407663313724;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x06239341807479819;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x024598098149539882;
...
struct Linker_x0517421795035429;
...
# 21 "./util/ArrayList.h"
struct Linker_x0992885264105573;
...
# 88 "net/EventEmitter.c"
    ...
    if (pf->bytesSinceLastPing < 8192 && pf->bytesSinceLastPing + msg->length >= 8192) {
        ...
        Message_push32(ping, pf->bytesSinceLastPing, 
# 91 "net/EventEmitter.c" 3 4
                                                    ((void *)0)
# 91 "net/EventEmitter.c"
                                                        );
        Message_push32(ping, 0x01234567, 
# 92 "net/EventEmitter.c" 3 4
                                        ((void *)0)
# 92 "net/EventEmitter.c"
                                            );
        Message_push32(ping, PFChan_Core_PING, 
# 93 "net/EventEmitter.c" 3 4
                                              ((void *)0)
# 93 "net/EventEmitter.c"
                                                  );
...
# 177 "net/EventEmitter.c"
                                 )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EventEmitter.c"), (177), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull))"); } } while (0); Identity_ptr; })); }));
...
# 179 "net/EventEmitter.c" 3 4
                                            ((void *)0)
# 179 "net/EventEmitter.c"
                                                );
    ...
    uint32_t pathfinderNum = Message_pop32(msg, 
# 181 "net/EventEmitter.c" 3 4
                                               ((void *)0)
# 181 "net/EventEmitter.c"
                                                   );
    Message_push32(msg, ev, 
# 182 "net/EventEmitter.c" 3 4
                           ((void *)0)
# 182 "net/EventEmitter.c"
                               );
...
# 207 "net/EventEmitter.c" 3 4
                                   ((void *)0)
# 207 "net/EventEmitter.c"
                                       );
    Message_push32(msg, ev, 
# 208 "net/EventEmitter.c" 3 4
                           ((void *)0)
# 208 "net/EventEmitter.c"
                               );
    return msg;
}
...
# 218 "net/EventEmitter.c"
        ...
        case PFChan_Pathfinder_CONNECT: {
            struct PFChan_Pathfinder_Connect connect;
            Message_shift(msg, -8, 
# 222 "net/EventEmitter.c" 3 4
                                  ((void *)0)
# 222 "net/EventEmitter.c"
                                      );
            Message_pop(msg, &connect, 72, 
# 223 "net/EventEmitter.c" 3 4
                                                                      ((void *)0)
# 223 "net/EventEmitter.c"
                                                                          );
            ...
            Message_push(msg, &resp, 40, 
# 233 "net/EventEmitter.c" 3 4
                                                              ((void *)0)
# 233 "net/EventEmitter.c"
                                                                  );
            Message_push32(msg, PFChan_Core_CONNECT, 
# 234 "net/EventEmitter.c" 3 4
                                                    ((void *)0)
# 234 "net/EventEmitter.c"
                                                        );
...
# 236 "net/EventEmitter.c"
        ...
        case PFChan_Pathfinder_SUPERIORITY: {
            Message_shift(msg, -8, 
# 240 "net/EventEmitter.c" 3 4
                                  ((void *)0)
# 240 "net/EventEmitter.c"
                                      );
            pf->superiority = Message_pop32(msg, 
# 241 "net/EventEmitter.c" 3 4
                                                ((void *)0)
# 241 "net/EventEmitter.c"
                                                    );
...
# 243 "net/EventEmitter.c"
        ...
        case PFChan_Pathfinder_PONG: {
            Message_shift(msg, -8, 
# 253 "net/EventEmitter.c" 3 4
                                  ((void *)0)
# 253 "net/EventEmitter.c"
                                      );
            uint32_t cookie = Message_pop32(msg, 
# 254 "net/EventEmitter.c" 3 4
                                                ((void *)0)
# 254 "net/EventEmitter.c"
                                                    );
            uint32_t count = Message_pop32(msg, 
# 255 "net/EventEmitter.c" 3 4
                                               ((void *)0)
# 255 "net/EventEmitter.c"
                                                   );
...
# 282 "net/EventEmitter.c"
                           )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EventEmitter.c"), (282), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull))"); } } while (0); Identity_ptr; })); }));
    struct EventEmitter_pvt* ee = (__extension__ ({ __typeof__((struct EventEmitter_pvt*) pf->ee) Identity_ptr = ((struct EventEmitter_pvt*) pf->ee); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EventEmitter.c"), (283), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull))"); } } while (0); Identity_ptr; }));
    if (msg->length < 4) {
...
# 288 "net/EventEmitter.c" 3 4
                                                  ((void *)0)
# 288 "net/EventEmitter.c"
                                                      );
    Message_push32(msg, pf->pathfinderId, 
# 289 "net/EventEmitter.c" 3 4
                                         ((void *)0)
# 289 "net/EventEmitter.c"
                                             );
    Message_push32(msg, ev, 
# 290 "net/EventEmitter.c" 3 4
                           ((void *)0)
# 290 "net/EventEmitter.c"
                               );
...
void EventEmitter_regCore(struct EventEmitter* eventEmitter,
                          ...
                          enum PFChan_Pathfinder ev)
{
    struct EventEmitter_pvt* ee = (__extension__ ({ __typeof__((struct EventEmitter_pvt*) eventEmitter) Identity_ptr = ((struct EventEmitter_pvt*) eventEmitter); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EventEmitter.c"), (330), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull))"); } } while (0); Identity_ptr; }));
...
{
    struct EventEmitter_pvt* ee = (__extension__ ({ __typeof__((struct EventEmitter_pvt*) emitter) Identity_ptr = ((struct EventEmitter_pvt*) emitter); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("EventEmitter.c"), (342), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x90ca9134f9ffcc2dull))"); } } while (0); Identity_ptr; }));
    ...
    (pf)->Identity_verifier = ((unsigned long) 0x90ca9134f9ffcc2dull);
    int i = 0;
                                      ...
                                      uint8_t* publicKey)
{
    ...
    (ee)->Identity_verifier = ((unsigned long) 0x90ca9134f9ffcc2dull);
    return &ee->pub;
}

# 1 "subnode/PingResponder.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "subnode/PingResponder.c"
# 15 "subnode/PingResponder.c"
# 1 "./subnode/PingResponder.h" 1
# 18 "./subnode/PingResponder.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05932470801885261;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09942784928124526;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 19 "./subnode/PingResponder.h" 2
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05802551302035823;
...
# 20 "./exception/Except.h"
struct Linker_x04623872205370514;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07334174284069648;
...
struct Linker_x05294514013298723;
...
struct Linker_x0524580758558491;
...
struct Linker_x05329723979554783;
...
struct Linker_x041765351766367065;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x037899583476932897;
...
struct Linker_x03479526491613203;
...
struct Linker_x005178713435239346;
# 34 "./dht/Address.h"
struct Address
{
...
# 24 "./subnode/MsgCore.h" 2
# 1 "./switch/EncodingScheme.h" 1
# 19 "./switch/EncodingScheme.h"
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x09450460354104546;
...
struct Linker_x030982576674761075;
...
struct Linker_x039487170960292106;
...
struct BoilerplateResponder* BoilerplateResponder_new(struct EncodingScheme* myScheme,
                                                      struct Allocator* alloc);
# 22 "./subnode/PingResponder.h" 2


struct Linker_x04947956580136281;
...
static void onPing(Dict* msg,
                   ...
                   struct MsgCore_Handler* handler)
{
    struct PingResponder_pvt* prp = (__extension__ ({ __typeof__((struct PingResponder_pvt*) handler->userData) Identity_ptr = ((struct PingResponder_pvt*) handler->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xac0eaf49225bb32bull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("PingResponder.c"), (35), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xac0eaf49225bb32bull))"); } } while (0); Identity_ptr; }));
    do { if (prp->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(prp->log, Log_Level_DEBUG, "PingResponder.c", 36, "Received ping req from [%s]", Address_toString(src, tmpAlloc)->bytes); } } while (0);

    String* txid = Dict_getString(msg, (&(String) { .bytes = "txid", .len = CString_strlen("txid") }));
    if (!txid) {
        do { if (prp->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(prp->log, Log_Level_DEBUG, "PingResponder.c", 40, "ping missing txid"); } } while (0);
        return;
    }
...
struct PingResponder* PingResponder_new(struct Allocator* allocator,
                                        ...
                                        struct BoilerplateResponder* br)
{
    struct Allocator* alloc = Allocator__child((allocator),"PingResponder.c",55);
    struct PingResponder_pvt* prp =
        Allocator__calloc((alloc),(sizeof(struct PingResponder_pvt)),(1),"PingResponder.c",57);
    (prp)->Identity_verifier = ((unsigned long) 0xac0eaf49225bb32bull);
    prp->log = log;
    prp->alloc = alloc;
    prp->msgCore = msgCore;

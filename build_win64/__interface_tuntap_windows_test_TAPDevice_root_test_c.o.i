# 1 "./interface/tuntap/windows/test/TAPDevice_root_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./interface/tuntap/windows/test/TAPDevice_root_test.c"
# 21 "./interface/tuntap/windows/test/TAPDevice_root_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02632789944640046;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x038676384332406744;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 22 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 2
# 1 "./memory/MallocAllocator.h" 1
# 21 "./memory/MallocAllocator.h"
struct Linker_x06269615284635361;
# 30 "./memory/MallocAllocator.h"
struct Allocator* MallocAllocator__new(unsigned long sizeLimit, const char* file, int line);
# 23 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 2
# 1 "./interface/tuntap/windows/TAPDevice.h" 1
# 18 "./interface/tuntap/windows/TAPDevice.h"
# 1 "./exception/Except.h" 1
# 20 "./exception/Except.h"
struct Linker_x0860226110017678;
...
# 19 "./interface/tuntap/windows/TAPDevice.h" 2


struct Linker_x023092305804093627;
...
struct TAPDevice* TAPDevice_find(const char* preferredName,
                                 struct Except* eh,
                                 struct Allocator* alloc);
# 24 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 2

# 1 "./test/RootTest.h" 1
# 18 "./test/RootTest.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x09317462963557523;
...
int RootTest_TAPDevice_root_test_main(int argc, char** argv);
int TAPDevice_root_test_main(int argc, char** argv);int TAPDevice_root_test_main(int argc, char** argv)
{
    int runIt = 0;
    int j = 0;
    ...
    if (runIt) {
        return RootTest_TAPDevice_root_test_main(j,argv);
    } else {
        fprintf(
...
int RootTest_TAPDevice_root_test_main(int argc, char** argv);
# 26 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 2



int RootTest_TAPDevice_root_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<20),"TAPDevice_root_test.c",31);
    struct TAPDevice* dev = TAPDevice_find(
# 32 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 3 4
                                          ((void *)0)
# 32 "./interface/tuntap/windows/test/TAPDevice_root_test.c"
                                              , 
# 32 "./interface/tuntap/windows/test/TAPDevice_root_test.c" 3 4
                                                ((void *)0)
# 32 "./interface/tuntap/windows/test/TAPDevice_root_test.c"
                                                    , alloc);
    do { if (!((dev && dev->name && dev->path))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("TAPDevice_root_test.c"), (33), "(dev && dev->name && dev->path)"); } } while (0);

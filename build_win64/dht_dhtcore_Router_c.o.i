# 1 "dht/dhtcore/Router.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "dht/dhtcore/Router.c"
# 16 "dht/dhtcore/Router.c"
# 1 "./dht/dhtcore/Router.h" 1
# 22 "./dht/dhtcore/Router.h"
# 1 "./dht/Address.h" 1
# 18 "./dht/Address.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08952139760956903;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x06955290986920344;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x014614026844449413;
...
struct Linker_x08549577493234493;
...
struct Linker_x08974242866561983;
# 34 "./dht/Address.h"
struct Address
{
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x017590446659781933;
...
struct Linker_x06511793583159649;
...
struct Linker_x08347836921456078;
...
# 25 "./dht/dhtcore/Router.h" 2

struct Linker_x0565748288784153;
...
# 17 "dht/dhtcore/Router.c" 2
# 1 "./dht/dhtcore/Router_new.h" 1
# 24 "./dht/dhtcore/Router_new.h"
...
struct Linker_x08164206810032368;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x084162038885333;
...
struct Linker_x06605938544282535;
...
struct Linker_x015025809926762124;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x06657191738433283;
...
struct Linker_x07994472161195758;
...
struct Linker_x047972484042555963;
...
struct Linker_x021403222578642023;
...
struct Linker_x07979953229164527;
...
struct Linker_x09693115301537913;
...
void RouterModule_peerIsReachable(uint64_t pathToPeer,
                                  ...
                                  struct RouterModule* module);
# 25 "./dht/dhtcore/Router_new.h" 2

# 1 "./dht/dhtcore/SearchRunner.h" 1
# 27 "./dht/dhtcore/SearchRunner.h"
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0818621319351631;
...
struct Linker_x06779704964124198;
...
struct Node_Link* Router_linkForPath(struct Router* r, uint64_t path)
{
    struct Router_pvt* rr = (__extension__ ({ __typeof__((struct Router_pvt*)r) Identity_ptr = ((struct Router_pvt*)r); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Router.c"), (34), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull))"); } } while (0); Identity_ptr; }));
...
void Router_sendGetPeers(struct Router* r,
                         ...
                         struct Allocator* alloc)
{
    struct Router_pvt* rr = (__extension__ ({ __typeof__((struct Router_pvt*)r) Identity_ptr = ((struct Router_pvt*)r); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Router.c"), (44), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull))"); } } while (0); Identity_ptr; }));
    RouterModule_getPeers(addr, nearbyLabel, timeoutMilliseconds, rr->routerModule, alloc);
}

struct Node_Two* Router_lookup(struct Router* r, uint8_t targetAddr[16])
{
    struct Router_pvt* rr = (__extension__ ({ __typeof__((struct Router_pvt*)r) Identity_ptr = ((struct Router_pvt*)r); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Router.c"), (50), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull))"); } } while (0); Identity_ptr; }));
    return NodeStore_getBest(rr->nodeStore, targetAddr);
}

void Router_brokenLink(struct Router* r, uint64_t path, uint64_t labelAtErrorHop)
{
    struct Router_pvt* rr = (__extension__ ({ __typeof__((struct Router_pvt*)r) Identity_ptr = ((struct Router_pvt*)r); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Router.c"), (56), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull))"); } } while (0); Identity_ptr; }));
    NodeStore_brokenLink(rr->nodeStore, path, labelAtErrorHop);
}

void Router_disconnectedPeer(struct Router* r, uint64_t path)
{
    struct Router_pvt* rr = (__extension__ ({ __typeof__((struct Router_pvt*)r) Identity_ptr = ((struct Router_pvt*)r); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Router.c"), (62), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x8a82fb216e1a3572ull))"); } } while (0); Identity_ptr; }));
...
struct Router* Router_new(struct RouterModule* rm,
                          ...
                          struct Allocator* alloc)
{
    struct Router_pvt* rp = Allocator__clone((alloc),((&(struct Router_pvt) { .routerModule = rm, .nodeStore = ns, .searchRunner = sr })),sizeof(*((&(struct Router_pvt) { .routerModule = rm, .nodeStore = ns, .searchRunner = sr }))),"Router.c",71)



       ;
    (rp)->Identity_verifier = ((unsigned long) 0x8a82fb216e1a3572ull);
    return &rp->pub;
}

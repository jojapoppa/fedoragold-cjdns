# 1 "contrib/c/publictoip6.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "contrib/c/publictoip6.c"
# 15 "contrib/c/publictoip6.c"
# 1 "./crypto/Key.h" 1
# 18 "./crypto/Key.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08967009916334758;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09107549193138236;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0483533317511629;
...
struct Linker_x004054635324970923;
...
struct Linker_x08453978643206628;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x05549824535630767;
...
struct Linker_x01421479503255636;
...
struct Linker_x05638023579159748;
...
struct Linker_x06703102297253833;
...
# 16 "contrib/c/publictoip6.c" 2
# 1 "./util/AddrTools.h" 1
# 19 "./util/AddrTools.h"
struct Linker_x007771980347708651;
...
# 19 "contrib/c/publictoip6.c" 2


# 20 "contrib/c/publictoip6.c"
...
int main(int argc, char** argv)
{
    ...
    switch (ret) {
        case -1: fprintf(
# 42 "contrib/c/publictoip6.c" 3
                                         (__acrt_iob_func(2))
# 42 "contrib/c/publictoip6.c"
                                               , "ERROR: Key_parse_TOO_SHORT\n"); return 1;
        case -2: fprintf(
# 43 "contrib/c/publictoip6.c" 3
                                         (__acrt_iob_func(2))
# 43 "contrib/c/publictoip6.c"
                                               , "ERROR: Key_parse_MALFORMED\n"); return 1;
        case -3: fprintf(
# 44 "contrib/c/publictoip6.c" 3
                                             (__acrt_iob_func(2))
# 44 "contrib/c/publictoip6.c"
                                                   , "ERROR: Key_parse_DECODE_FAILED\n"); return 1;
        case -4: fprintf(
# 45 "contrib/c/publictoip6.c" 3
                                       (__acrt_iob_func(2))
# 45 "contrib/c/publictoip6.c"
                                             , "ERROR: Key_parse_INVALID\n"); return 1;
        case 0: break;
        default: fprintf(
# 47 "contrib/c/publictoip6.c" 3
                        (__acrt_iob_func(2))
# 47 "contrib/c/publictoip6.c"

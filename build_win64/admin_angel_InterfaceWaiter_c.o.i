# 1 "admin/angel/InterfaceWaiter.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "admin/angel/InterfaceWaiter.c"
# 15 "admin/angel/InterfaceWaiter.c"
...
# 16 "admin/angel/InterfaceWaiter.c" 2
# 1 "./admin/angel/InterfaceWaiter.h" 1
# 18 "./admin/angel/InterfaceWaiter.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x063432001273797;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x07480080026001057;
...
struct Allocator* Allocator_new(unsigned long sizeLimit,
                                ...
                                const char* fileName,
                                int lineNum);
# 19 "./admin/angel/InterfaceWaiter.h" 2
# 1 "./exception/Except.h" 1
# 20 "./exception/Except.h"
struct Linker_x03040219931193995;
...
# 20 "./admin/angel/InterfaceWaiter.h" 2
...
# 21 "./util/Bits.h"
struct Linker_x01689129934303364;
...
# 21 "./admin/angel/InterfaceWaiter.h" 2
# 1 "./util/events/EventBase.h" 1
# 20 "./util/events/EventBase.h"
struct Linker_x08743202702842077;
...
# 22 "./admin/angel/InterfaceWaiter.h" 2

struct Linker_x00668077056671772;
# 34 "./admin/angel/InterfaceWaiter.h"
struct Message* InterfaceWaiter_waitForData(struct Iface* iface,
                                            struct EventBase* eventBase,
                                            struct Allocator* alloc,
                                            struct Except* eh);
# 17 "admin/angel/InterfaceWaiter.c" 2



# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x028685233253507647;
...
void Log_print(struct Log* log,
               ...
               const char* format,
               ...);
# 21 "admin/angel/InterfaceWaiter.c" 2
# 1 "./io/FileWriter.h" 1
# 18 "./io/FileWriter.h"
# 1 "./io/Writer.h" 1
# 23 "./io/Writer.h"
...
# 23 "admin/angel/InterfaceWaiter.c" 2
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) iface) Identity_ptr = ((struct Context*) iface); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3c2d0c52a42f6c57ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("InterfaceWaiter.c"), (46), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3c2d0c52a42f6c57ull))"); } } while (0); Identity_ptr; }));
                                            ...
                                            struct Except* eh)
{
    ...
    (&ctx)->Identity_verifier = ((unsigned long) 0x3c2d0c52a42f6c57ull);
    Iface_plumb(iface, &ctx.iface);

    struct Allocator* tempAlloc = Allocator__child((alloc),"InterfaceWaiter.c",69);
    ctx.timeout = Timeout__setTimeout((timeout), (&ctx), (11160000), (eventBase), (tempAlloc), "InterfaceWaiter.c", 70);
    EventBase_beginLoop(eventBase);

    Iface_unplumb(iface, &ctx.iface);

    Allocator__free((tempAlloc),"InterfaceWaiter.c",75);
    if (ctx.timedOut) {
        Except__throw("InterfaceWaiter.c", 77, eh, "InterfaceWaiter Timed out waiting for data.");
    }

    do { if (!((!iface->connectedIf))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("InterfaceWaiter.c"), (80), "(!iface->connectedIf)"); } } while (0);
    do { if (!((ctx.message))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("InterfaceWaiter.c"), (81), "(ctx.message)"); } } while (0);
    return ctx.message;
}

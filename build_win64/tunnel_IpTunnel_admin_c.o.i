# 1 "tunnel/IpTunnel_admin.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "tunnel/IpTunnel_admin.c"
# 15 "tunnel/IpTunnel_admin.c"
# 1 "./admin/Admin.h" 1
# 18 "./admin/Admin.h"
...
struct Linker_x043559723296375985;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x02803886706930254;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x06447254134111702;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x022450755423811986;
...
struct Linker_x03789605844262134;
...
struct Linker_x04769551688442979;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x011599183406174784;
...
struct Linker_x0570455414075032;
...
struct Linker_x01931305254124862;
...
struct Admin* Admin_new(struct AddrIface* ai,
                        ...
                        String* password);
# 16 "tunnel/IpTunnel_admin.c" 2
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x07218790091589427;
...
struct Linker_x06150291018025067;
...
# 17 "tunnel/IpTunnel_admin.c" 2
# 1 "./benc/Int.h" 1
# 18 "tunnel/IpTunnel_admin.c" 2

# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x06979902142854189;
...
struct Linker_x07551372150854359;
...
struct Linker_x0516788727671029;
...
struct Linker_x0849482524955951;
...
struct Linker_x05731327442373013;
...
struct Linker_x02759906491841242;
...
struct Linker_x04709336465318732;
...
# 23 "tunnel/IpTunnel_admin.c" 2
# 1 "./tunnel/IpTunnel_admin.h" 1
# 20 "./tunnel/IpTunnel_admin.h"
# 1 "./admin/Admin.h" 1
# 21 "./tunnel/IpTunnel_admin.h" 2

struct Linker_x07851174263329315;

void IpTunnel_admin_register(struct IpTunnel* ipTun, struct Admin* admin, struct Allocator* alloc);
# 24 "tunnel/IpTunnel_admin.c" 2


# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 1 3 4
# 1 "/usr/share/mingw-w64/include/stddef.h" 1 3 4
# 2 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 2 3 4
# 27 "tunnel/IpTunnel_admin.c" 2
...
{
    Dict resp = (&(struct Dict_Entry) { .key = (&(String) { .bytes = "connection", .len = CString_strlen("connection") }), .val = (&(Object) { .type = Object_INTEGER, .as.number = conn }), .next = (&(struct Dict_Entry) { .key = (&(String) { .bytes = "error", .len = CString_strlen("error") }), .val = (&(Object) { .type = Object_STRING, .as.string = (&(String) { .bytes = "none", .len = CString_strlen("none") }) }), .next = 
# 36 "tunnel/IpTunnel_admin.c" 3 4
               ((void *)0) 
# 36 "tunnel/IpTunnel_admin.c"
               }) })
...
{
    Dict resp = (&(struct Dict_Entry) { .key = (&(String) { .bytes = "error", .len = CString_strlen("error") }), .val = (&(Object) { .type = Object_STRING, .as.string = (&(String) { .bytes = error, .len = CString_strlen(error) }) }), .next = 
# 45 "tunnel/IpTunnel_admin.c" 3 4
               ((void *)0) 
# 45 "tunnel/IpTunnel_admin.c"
               })
                            ...
                            struct Allocator* requestAlloc)
{
    ...
    String* publicKeyOfAuthorizedNode =
        Dict_getString(args, (&(String) { .bytes = "publicKeyOfAuthorizedNode", .len = CString_strlen("publicKeyOfAuthorizedNode") }));
    String* ip6Address = Dict_getString(args, (&(String) { .bytes = "ip6Address", .len = CString_strlen("ip6Address") }));
    int64_t* ip6Prefix = Dict_getInt(args, (&(String) { .bytes = "ip6Prefix", .len = CString_strlen("ip6Prefix") }));
    int64_t* ip6Alloc = Dict_getInt(args, (&(String) { .bytes = "ip6Alloc", .len = CString_strlen("ip6Alloc") }));
    String* ip4Address = Dict_getString(args, (&(String) { .bytes = "ip4Address", .len = CString_strlen("ip4Address") }));
    int64_t* ip4Prefix = Dict_getInt(args, (&(String) { .bytes = "ip4Prefix", .len = CString_strlen("ip4Prefix") }));
    int64_t* ip4Alloc = Dict_getInt(args, (&(String) { .bytes = "ip4Alloc", .len = CString_strlen("ip4Alloc") }));
            ...
            || Sockaddr_getFamily(&ip4ToGive.addr) != Sockaddr_AF_INET))
    {
        ...
        int conn = IpTunnel_allowConnection(pubKey,
                                            (ip6Address) ? &ip6ToGive.addr : 
# 109 "tunnel/IpTunnel_admin.c" 3 4
                                                                            ((void *)0)
# 109 "tunnel/IpTunnel_admin.c"
                                                                                ,
                                            (ip6Prefix) ? (uint8_t) (*ip6Prefix) : 128,
                                            (ip6Alloc) ? (uint8_t) (*ip6Alloc) : 128,
                                            (ip4Address) ? &ip4ToGive.addr : 
# 112 "tunnel/IpTunnel_admin.c" 3 4
                                                                            ((void *)0)
# 112 "tunnel/IpTunnel_admin.c"
                                                                                ,
...
static void connectTo(Dict* args, void* vcontext, String* txid, struct Allocator* requestAlloc)
{
    ...
    String* publicKeyOfNodeToConnectTo =
        Dict_getString(args, (&(String) { .bytes = "publicKeyOfNodeToConnectTo", .len = CString_strlen("publicKeyOfNodeToConnectTo") }));
                             ...
                             struct Allocator* requestAlloc)
{
    ...
    int conn = (int) *(Dict_getInt(args, (&(String) { .bytes = "connection", .len = CString_strlen("connection") })));
    if (-1 == IpTunnel_removeConnection(conn, context->ipTun)) {
                            ...
                            struct Allocator* alloc)
{
    ...
    Dict_putList(resp, String_new("connections", alloc), l, alloc);
                     ...
                     struct Allocator* alloc)
{
    ...
    if (!Bits_isZero(conn->connectionIp6, 16)) {
        ...
        uint8_t* address;
        do { if (!((16 == Sockaddr_getAddress(addr, &address)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel_admin.c"), (183), "(16 == Sockaddr_getAddress(addr, &address))"); } } while (0);
        Bits__memcpy(address,conn->connectionIp6,16,"IpTunnel_admin.c",184);
        char* printedAddr = Sockaddr_print(addr, alloc);
        Dict_putString(d, String_new("ip6Address", alloc), String_new(printedAddr, alloc), alloc);
        Dict_putInt(d, String_new("ip6Prefix", alloc), conn->connectionIp6Prefix, alloc);
        Dict_putInt(d, String_new("ip6Alloc", alloc), conn->connectionIp6Alloc, alloc);
    }

    if (!Bits_isZero(conn->connectionIp4, 4)) {
        struct Sockaddr* addr = Sockaddr_clone((0 ? Sockaddr_LOOPBACK_be : Sockaddr_LOOPBACK_le), alloc);
        uint8_t* address;
        do { if (!((4 == Sockaddr_getAddress(addr, &address)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel_admin.c"), (194), "(4 == Sockaddr_getAddress(addr, &address))"); } } while (0);
        Bits__memcpy(address,conn->connectionIp4,4,"IpTunnel_admin.c",195);
        char* printedAddr = Sockaddr_print(addr, alloc);
        Dict_putString(d, String_new("ip4Address", alloc), String_new(printedAddr, alloc), alloc);
        Dict_putInt(d, String_new("ip4Prefix", alloc), conn->connectionIp4Prefix, alloc);
        Dict_putInt(d, String_new("ip4Alloc", alloc), conn->connectionIp4Alloc, alloc);
    }

    Dict_putString(d, String_new("key", alloc), Key_stringify(conn->routeHeader.publicKey, alloc), alloc)
                                                                               ;
    Dict_putInt(d, String_new("outgoing", alloc), (conn->isOutgoing) ? 1 : 0, alloc);
    Dict_putString(d, String_new("error", alloc), String_new("none", alloc), alloc);
...
{
    struct Context* context = vcontext;
    int connNum = (int) *(Dict_getInt(args, (&(String) { .bytes = "connection", .len = CString_strlen("connection") })));
...
void IpTunnel_admin_register(struct IpTunnel* ipTun, struct Admin* admin, struct Allocator* alloc)
{
    struct Context* context = Allocator__clone((alloc),((&(struct Context) { .admin = admin, .ipTun = ipTun })),sizeof(*((&(struct Context) { .admin = admin, .ipTun = ipTun }))),"IpTunnel_admin.c",226)


       ;

    Admin_registerFunctionWithArgCount( "IpTunnel_allowConnection", allowConnection, context, 
# 231 "tunnel/IpTunnel_admin.c" 3 4
   1
# 231 "tunnel/IpTunnel_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "publicKeyOfAuthorizedNode", .required = 1, .type = "String" }, { .name = "ip6Address", .required = 0, .type = "String" }, { .name = "ip6Prefix", .required = 0, .type = "Int" }, { .name = "ip6Alloc", .required = 0, .type = "Int" }, { .name = "ip4Address", .required = 0, .type = "String" }, { .name = "ip4Prefix", .required = 0, .type = "Int" }, { .name = "ip4Alloc", .required = 0, .type = "Int" }, }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "publicKeyOfAuthorizedNode", .required = 1, .type = "String" }, { .name = "ip6Address", .required = 0, .type = "String" }, { .name = "ip6Prefix", .required = 0, .type = "Int" }, { .name = "ip6Alloc", .required = 0, .type = "Int" }, { .name = "ip4Address", .required = 0, .type = "String" }, { .name = "ip4Prefix", .required = 0, .type = "Int" }, { .name = "ip4Alloc", .required = 0, .type = "Int" }, })) / sizeof(struct Admin_FunctionArg)), admin)
# 240 "tunnel/IpTunnel_admin.c"
                  ;

    Admin_registerFunctionWithArgCount( "IpTunnel_connectTo", connectTo, context, 
# 242 "tunnel/IpTunnel_admin.c" 3 4
   1
# 242 "tunnel/IpTunnel_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "publicKeyOfNodeToConnectTo", .required = 1, .type = "String" } }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "publicKeyOfNodeToConnectTo", .required = 1, .type = "String" } })) / sizeof(struct Admin_FunctionArg)), admin)


                  ;

    Admin_registerFunctionWithArgCount( "IpTunnel_removeConnection", removeConnection, context, 
# 247 "tunnel/IpTunnel_admin.c" 3 4
   1
# 247 "tunnel/IpTunnel_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "connection", .required = 1, .type = "Int" } }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "connection", .required = 1, .type = "Int" } })) / sizeof(struct Admin_FunctionArg)), admin)


                  ;

    Admin_registerFunctionWithArgCount( "IpTunnel_showConnection", showConnection, context, 
# 252 "tunnel/IpTunnel_admin.c" 3 4
   1
# 252 "tunnel/IpTunnel_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "connection", .required = 1, .type = "Int" } }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "connection", .required = 1, .type = "Int" } })) / sizeof(struct Admin_FunctionArg)), admin)


                  ;

    Admin_registerFunctionWithArgCount( "IpTunnel_listConnections", listConnections, context, 
# 257 "tunnel/IpTunnel_admin.c" 3 4
   1
# 257 "tunnel/IpTunnel_admin.c"
   , 
# 257 "tunnel/IpTunnel_admin.c" 3 4
   ((void *)0)
# 257 "tunnel/IpTunnel_admin.c"

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05031803423466401;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x08789308761355838;
...
struct Linker_x09268494192548731;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x07210164871028377;
...
struct Linker_x01321133595927897;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x08558159271469328;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04653647851667675;
...
struct Linker_x09479065295499245;
...
struct Linker_x09405920967868795;
...
# 18 "interface/UDPInterface_admin.c" 2
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x08963306933694639;
...
struct Linker_x07195564191362316;
...
# 21 "./util/ArrayList.h"
struct Linker_x03086100210387839;
...
struct Linker_x09371995647524562;
...
struct Linker_x007258289133594609;
...
struct Linker_x018762385015218208;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x046651638146951013;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x06151109612794547;
...
struct Linker_x027537418766365507;
...
struct Linker_x0788723035071887;
...
struct Linker_x022492800164034898;
...
struct Linker_x04824417892532564;
...
# 20 "interface/UDPInterface_admin.c" 2

# 1 "./util/events/FakeNetwork.h" 1
# 25 "./util/events/FakeNetwork.h"
struct Linker_x05497711578743973;
...
struct FakeNetwork_UDPIface* FakeNetwork_iface(struct FakeNetwork* net,
                                               ...
                                               struct Allocator* alloc);
# 22 "interface/UDPInterface_admin.c" 2

# 1 "./crypto/Key.h" 1
# 22 "./crypto/Key.h"
struct Linker_x043366487365066253;
...
struct Linker_x03126613414001169;
...
struct Linker_x04214183636827511;
...
# 19 "./interface/UDPInterface.h"
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x0003333004925369698;
...
struct Linker_x03634437587078123;
...
# 28 "./interface/UDPInterface.h" 2

struct Linker_x00989823061130144;
...
# 26 "interface/UDPInterface_admin.c" 2
...
# 31 "interface/UDPInterface_admin.c" 2
...
static void beginConnection(Dict* args,
                            ...
                            struct Allocator* requestAlloc)
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (68), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    ...
    char* error = 
# 79 "interface/UDPInterface_admin.c" 3 4
                 ((void *)0)
# 79 "interface/UDPInterface_admin.c"
                     ;

    do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "UDPInterface_admin.c", 81, "Peering with [%s]", publicKey->bytes); } } while (0);

    struct Sockaddr_storage ss;
    uint8_t pkBytes[32];
    int ret;
    if ((ret = Key_parse(publicKey, pkBytes, 
# 86 "interface/UDPInterface_admin.c" 3 4
                                            ((void *)0)
# 86 "interface/UDPInterface_admin.c"
                                                ))) {
        ...
        char* addrPtr = 
# 98 "interface/UDPInterface_admin.c" 3 4
                       ((void *)0)
# 98 "interface/UDPInterface_admin.c"
                           ;
        int addrLen = Sockaddr_getAddress(&ss.addr, &addrPtr);
        do { if (!((addrLen > 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (100), "(addrLen > 0)"); } } while (0);
        struct Allocator* tempAlloc = Allocator__child((ctx->alloc),"UDPInterface_admin.c",101);
        ...
        Allocator__free((tempAlloc),"UDPInterface_admin.c",117);
...
# 155 "interface/UDPInterface_admin.c" 3 4
                                ((void *)0)
# 155 "interface/UDPInterface_admin.c"
                                    ;
    struct Jmp jmp;
    jmp.handler.exception = Jmp_callback; if (!
# 157 "interface/UDPInterface_admin.c" 3
   _setjmp((
# 157 "interface/UDPInterface_admin.c"
   jmp.buf
# 157 "interface/UDPInterface_admin.c" 3
...
# 157 "interface/UDPInterface_admin.c"
        ...
        if (dscp) {
            if (UDPInterface_setDSCP(udpIf, dscp)) {
                do { if (ctx->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_WARN, "UDPInterface_admin.c", 162, "Set DSCP failed"); } } while (0);
            }
        }
    } else {
        Dict* out = Dict_new(alloc);
        Dict_putString(out, String_new("error", alloc), String_new(jmp.message, alloc), alloc);
        Admin_sendMessage(out, txid, ctx->admin);
        Allocator__free((alloc),"UDPInterface_admin.c",169);
        return 
# 170 "interface/UDPInterface_admin.c" 3 4
              ((void *)0)
# 170 "interface/UDPInterface_admin.c"
                  ;
    }
    return udpIf;
}
...
static void newInterface2(struct Context* ctx,
                          ...
                          uint16_t beaconPort)
{
    struct Allocator* const alloc = Allocator__child((ctx->alloc),"UDPInterface_admin.c",182);
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (209), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
...
# 217 "interface/UDPInterface_admin.c" 3 4
                  ((void *)0) 
# 217 "interface/UDPInterface_admin.c"
                  })
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (228), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    Dict* out = Dict_new(requestAlloc);
    struct Jmp jmp;
    jmp.handler.exception = Jmp_callback; if (!
# 231 "interface/UDPInterface_admin.c" 3
   _setjmp((
# 231 "interface/UDPInterface_admin.c"
   jmp.buf
# 231 "interface/UDPInterface_admin.c" 3
   ), __builtin_frame_address (0))
# 231 "interface/UDPInterface_admin.c"
        ...
        Dict_putString(out, String_new("error", requestAlloc), String_new(jmp.message, requestAlloc), requestAlloc);
    }
    Admin_sendMessage(out, txid, ctx->admin);
}
...
static void setBroadcastDevices(
    Dict* args, void* vcontext, String* txid, struct Allocator* requestAlloc)
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (243), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    struct UDPInterface* udpif = getIface(ctx, args, txid, requestAlloc, 
# 244 "interface/UDPInterface_admin.c" 3 4
                                                                        ((void *)0)
# 244 "interface/UDPInterface_admin.c"
                                                                            );
    if (!udpif) { return; }
...
static void getBroadcastDevices(
    Dict* args, void* vcontext, String* txid, struct Allocator* requestAlloc)
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (255), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    struct UDPInterface* udpif = getIface(ctx, args, txid, requestAlloc, 
# 256 "interface/UDPInterface_admin.c" 3 4
                                                                        ((void *)0)
# 256 "interface/UDPInterface_admin.c"
                                                                            );
    if (!udpif) { return; }
    Dict* out = Dict_new(requestAlloc);
    Dict_putString(out, String_new("error", requestAlloc), String_new("none", requestAlloc), requestAlloc);
...
static void getBroadcastAddrs(
    Dict* args, void* vcontext, String* txid, struct Allocator* requestAlloc)
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (268), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    struct UDPInterface* udpif = getIface(ctx, args, txid, requestAlloc, 
# 269 "interface/UDPInterface_admin.c" 3 4
                                                                        ((void *)0)
# 269 "interface/UDPInterface_admin.c"
                                                                            );
    if (!udpif) { return; }
    Dict* out = Dict_new(requestAlloc);
    Dict_putString(out, String_new("error", requestAlloc), String_new("none", requestAlloc), requestAlloc);
...
static void beacon(Dict* args, void* vcontext, String* txid, struct Allocator* requestAlloc)
{
    ...
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (284), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));

    char* error = 
# 286 "interface/UDPInterface_admin.c" 3 4
                 ((void *)0)
# 286 "interface/UDPInterface_admin.c"
                     ;
...
# 310 "interface/UDPInterface_admin.c" 3 4
              ((void *)0) 
# 310 "interface/UDPInterface_admin.c"
              }) }) })
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("UDPInterface_admin.c"), (320), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xf21146f673dda19aull))"); } } while (0); Identity_ptr; }));
    struct UDPInterface* udpif = getIface(ctx, args, txid, requestAlloc, 
# 321 "interface/UDPInterface_admin.c" 3 4
                                                                        ((void *)0)
...
void UDPInterface_admin_register(struct EventBase* base,
                                 ...
                                 struct GlobalConfig* globalConf)
{
    struct Context* ctx = Allocator__clone((alloc),((&(struct Context) { .eventBase = base, .alloc = alloc, .logger = logger, .admin = admin, .ic = ic, .fakeNet = fakeNet, .globalConf = globalConf })),sizeof(*((&(struct Context) { .eventBase = base, .alloc = alloc, .logger = logger, .admin = admin, .ic = ic, .fakeNet = fakeNet, .globalConf = globalConf }))),"UDPInterface_admin.c",340)
       ...
       ;
    (ctx)->Identity_verifier = ((unsigned long) 0xf21146f673dda19aull);
    ctx->ifaces = ArrayList_UDPInterface_new(alloc);

    Admin_registerFunctionWithArgCount( "UDPInterface_new", newInterface, ctx, 
# 352 "interface/UDPInterface_admin.c" 3 4
   1
# 352 "interface/UDPInterface_admin.c"
...
# 359 "interface/UDPInterface_admin.c" 3 4
   1
# 359 "interface/UDPInterface_admin.c"
...
# 369 "interface/UDPInterface_admin.c" 3 4
   1
# 369 "interface/UDPInterface_admin.c"
   , 
# 369 "interface/UDPInterface_admin.c" 3 4
   ((void *)0)
# 369 "interface/UDPInterface_admin.c"
...
# 371 "interface/UDPInterface_admin.c" 3 4
   1
# 371 "interface/UDPInterface_admin.c"
...
# 377 "interface/UDPInterface_admin.c" 3 4
   1
# 377 "interface/UDPInterface_admin.c"
...
# 382 "interface/UDPInterface_admin.c" 3 4
   1
# 382 "interface/UDPInterface_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "interfaceNumber", .required = 0, .type = "Int" } }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "interfaceNumber", .required = 0, .type = "Int" } })) / sizeof(struct Admin_FunctionArg)), admin)
...
# 387 "interface/UDPInterface_admin.c" 3 4
   1
# 387 "interface/UDPInterface_admin.c"
...
# 393 "interface/UDPInterface_admin.c" 3 4
   1
# 393 "interface/UDPInterface_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "interfaceNumber", .required = 0, .type = "Int" }, }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "interfaceNumber", .required = 0, .type = "Int" }, })) / sizeof(struct Admin_FunctionArg)), admin)

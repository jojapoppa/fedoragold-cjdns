# 1 "util/Seccomp_dummy.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "util/Seccomp_dummy.c"
# 15 "util/Seccomp_dummy.c"
# 1 "./util/Seccomp.h" 1
# 18 "./util/Seccomp.h"
...
struct Linker_x028209891823430056;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x040879934726533196;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x043288212365558265;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x09366815217384934;

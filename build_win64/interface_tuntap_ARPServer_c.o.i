...
struct Linker_x05517922786073974;
...
# 20 "./util/Assert.h"
struct Linker_x07285541198953394;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x032848773540512166;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x007309847638532019;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x06567826196573907;
...
struct Linker_x011090177739905216;
           ...
           isValidARP(struct Message* msg)
{
    ...
    Message_pop(msg, &arp, 28, 
# 40 "interface/tuntap/ARPServer.c" 3 4
                                              ((void *)0)
# 40 "interface/tuntap/ARPServer.c"
                                                  );
    Message_shift(msg, 28, 
# 41 "interface/tuntap/ARPServer.c" 3 4
                                          ((void *)0)
# 41 "interface/tuntap/ARPServer.c"
                                              );
...
static __attribute__ ((warn_unused_result)) struct Iface* answerARP(struct Message* msg, struct ARPServer_pvt* as)
{
    struct ARPHeader_6_4 arp;
    Message_pop(msg, &arp, 28, 
# 60 "interface/tuntap/ARPServer.c" 3 4
                                              ((void *)0)
# 60 "interface/tuntap/ARPServer.c"
                                                  );
    if (msg->length) {
    ...
    Message_push(msg, &arp, 28, 
# 75 "interface/tuntap/ARPServer.c" 3 4
                                               ((void *)0)
# 75 "interface/tuntap/ARPServer.c"
                                                   );
    TUNMessageType_push(msg, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x0806))); _x >> 8 | _x << 8; }))), 
# 76 "interface/tuntap/ARPServer.c" 3 4
                                               ((void *)0)
# 76 "interface/tuntap/ARPServer.c"
                                                   );
...
# 85 "interface/tuntap/ARPServer.c"
                              )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xe115b8d991510f3full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ARPServer.c"), (85), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xe115b8d991510f3full))"); } } while (0); Identity_ptr; })); }));

    if (msg->length >= 28 + 4) {
        uint16_t ethertype = TUNMessageType_pop(msg, 
# 88 "interface/tuntap/ARPServer.c" 3 4
                                                    ((void *)0)
# 88 "interface/tuntap/ARPServer.c"
                                                        );
...
# 94 "interface/tuntap/ARPServer.c" 3 4
                                           ((void *)0)
# 94 "interface/tuntap/ARPServer.c"
                                               );
    }
...
# 101 "interface/tuntap/ARPServer.c"
                              )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xe115b8d991510f3full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ARPServer.c"), (101), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xe115b8d991510f3full))"); } } while (0); Identity_ptr; })); }));
    return Iface_next(&as->external, msg);
}
                                ...
                                struct Allocator* alloc)
{
    ...
    (out)->Identity_verifier = ((unsigned long) 0xe115b8d991510f3full);

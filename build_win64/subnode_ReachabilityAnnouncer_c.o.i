...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x06084202201447342;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x09025010350274245;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x06595285353201383;
...
struct Linker_x09913623027055345;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x020335091619960144;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x08110488003824035;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x04316164130405604;
...
struct Linker_x0021451051041933233;
...
struct Linker_x07980811856553796;
...
struct Linker_x04080506718393817;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x0897926020104989;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x07303858678871642;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x07934171028922261;
...
struct Linker_x024609591826945176;
...
struct Linker_x0005001715665773121;
...
struct Linker_x06063878652868031;
...
struct Linker_x003010446740407091;
...
struct Linker_x09339868456122946;
...
struct Linker_x06463792599421361;
...
struct Linker_x034613229151981617;
...
struct Linker_x06213160661676085;
...
struct Linker_x004952332012514371;
...
struct Linker_x038665174501101185;
...
struct Linker_x07508606354791596;
...
struct Linker_x07498517761807986;
...
# 1 "./crypto/Sign.h" 1
# 21 "./crypto/Sign.h"
struct Linker_x07077698445361469;
...
# 19 "./util/AddrTools.h"
struct Linker_x06727127636478556;
...
# 21 "./util/ArrayList.h"
struct Linker_x0999026410720903;
...
static void hashMsgList(struct ArrayList_OfMessages* msgList, uint8_t out[64])
{
    ...
    for (int i = 0; i < msgList->length; i++) {
        ...
        Message_push(msg, hash, 64, 
# 99 "subnode/ReachabilityAnnouncer.c" 3 4
                                   ((void *)0)
# 99 "subnode/ReachabilityAnnouncer.c"
                                       );
        crypto_hash_sha512_ref(hash, msg->bytes, msg->length);
        Message_pop(msg, 
# 101 "subnode/ReachabilityAnnouncer.c" 3 4
                        ((void *)0)
# 101 "subnode/ReachabilityAnnouncer.c"
                            , 64, 
# 101 "subnode/ReachabilityAnnouncer.c" 3 4
                                  ((void *)0)
# 101 "subnode/ReachabilityAnnouncer.c"
                          ...
                          struct Message* msg)
{
    for (int i = 0; i < rap->localPeers->length; i++) {
        ...
        if (msg->length > 904) {
            Message_pop(msg, 
# 243 "subnode/ReachabilityAnnouncer.c" 3 4
                            ((void *)0)
# 243 "subnode/ReachabilityAnnouncer.c"
                                , msg->length - lastLen, 
# 243 "subnode/ReachabilityAnnouncer.c" 3 4
                                                         ((void *)0)
# 243 "subnode/ReachabilityAnnouncer.c"
                      ...
                      int64_t sinceTime)
{
    ...
    Message_pop(rap->nextMsg, 
# 303 "subnode/ReachabilityAnnouncer.c" 3 4
                             ((void *)0)
# 303 "subnode/ReachabilityAnnouncer.c"
                                 , 120, 
# 303 "subnode/ReachabilityAnnouncer.c" 3 4
                                                         ((void *)0)
# 303 "subnode/ReachabilityAnnouncer.c"
                                                             );
    Message_push(rap->nextMsg, refPeer, 32, 
# 304 "subnode/ReachabilityAnnouncer.c" 3 4
                                                           ((void *)0)
# 304 "subnode/ReachabilityAnnouncer.c"
                                                               );
    Message_push(rap->nextMsg, 
# 305 "subnode/ReachabilityAnnouncer.c" 3 4
                              ((void *)0)
# 305 "subnode/ReachabilityAnnouncer.c"
                                  , 120, 
# 305 "subnode/ReachabilityAnnouncer.c" 3 4
                                                          ((void *)0)
# 305 "subnode/ReachabilityAnnouncer.c"
...
static void setupNextMsg(struct ReachabilityAnnouncer_pvt* rap)
{
    ...
    Message_push(nextMsg, 
# 351 "subnode/ReachabilityAnnouncer.c" 3 4
                         ((void *)0)
# 351 "subnode/ReachabilityAnnouncer.c"
                             , 120, 
# 351 "subnode/ReachabilityAnnouncer.c" 3 4
                                                     ((void *)0)
# 351 "subnode/ReachabilityAnnouncer.c"
...
void ReachabilityAnnouncer_updatePeer(struct ReachabilityAnnouncer* ra,
                                      ...
                                      struct ReachabilityCollector_PeerInfo* pi)
{
    struct ReachabilityAnnouncer_pvt* rap = (__extension__ ({ __typeof__((struct ReachabilityAnnouncer_pvt*) ra) Identity_ptr = ((struct ReachabilityAnnouncer_pvt*) ra); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReachabilityAnnouncer.c"), (437), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull))"); } } while (0); Identity_ptr; }));
...
static void onReply(Dict* msg, struct Address* src, struct MsgCore_Promise* prom)
{
    ...
    struct ReachabilityAnnouncer_pvt* rap = (__extension__ ({ __typeof__(q->rap) Identity_ptr = (q->rap); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReachabilityAnnouncer.c"), (557), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull))"); } } while (0); Identity_ptr; }));
...
{
    struct ReachabilityAnnouncer_pvt* rap =
        (__extension__ ({ __typeof__((struct ReachabilityAnnouncer_pvt*) vRap) Identity_ptr = ((struct ReachabilityAnnouncer_pvt*) vRap); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReachabilityAnnouncer.c"), (623), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull))"); } } while (0); Identity_ptr; }));
...
# 668 "subnode/ReachabilityAnnouncer.c"
    ...
    Message_pop(msg, 
# 671 "subnode/ReachabilityAnnouncer.c" 3 4
                    ((void *)0)
# 671 "subnode/ReachabilityAnnouncer.c"
                        , 120, 
# 671 "subnode/ReachabilityAnnouncer.c" 3 4
                                                ((void *)0)
# 671 "subnode/ReachabilityAnnouncer.c"
    ...
    if (rap->resetState) {
        ...
        Message_push(msg, &version, 4, 
# 682 "subnode/ReachabilityAnnouncer.c" 3 4
                                                          ((void *)0)
# 682 "subnode/ReachabilityAnnouncer.c"
                                                              );
    }

    Message_push(msg, 
# 685 "subnode/ReachabilityAnnouncer.c" 3 4
                     ((void *)0)
# 685 "subnode/ReachabilityAnnouncer.c"
                         , 120, 
# 685 "subnode/ReachabilityAnnouncer.c" 3 4
                                                 ((void *)0)
# 685 "subnode/ReachabilityAnnouncer.c"
    ...
    Message_pop(msg, 
# 695 "subnode/ReachabilityAnnouncer.c" 3 4
                    ((void *)0)
# 695 "subnode/ReachabilityAnnouncer.c"
                        , 64, 
# 695 "subnode/ReachabilityAnnouncer.c" 3 4
                              ((void *)0)
# 695 "subnode/ReachabilityAnnouncer.c"
...
{
    struct ReachabilityAnnouncer_pvt* rap =
        (__extension__ ({ __typeof__((struct ReachabilityAnnouncer_pvt*) sh->userData) Identity_ptr = ((struct ReachabilityAnnouncer_pvt*) sh->userData); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReachabilityAnnouncer.c"), (720), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x7c5e07eb3c309ea4ull))"); } } while (0); Identity_ptr; }));
                                                        ...
                                                        struct EncodingScheme* myScheme)
{
    ...
    (rap)->Identity_verifier = ((unsigned long) 0x7c5e07eb3c309ea4ull);
    rap->alloc = alloc;
    rap->log = log;
    rap->base = base;
    rap->msgCore = msgCore;

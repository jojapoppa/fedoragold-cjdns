# 1 "subnode/SupernodeHunter_admin.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "subnode/SupernodeHunter_admin.c"
# 15 "subnode/SupernodeHunter_admin.c"
# 1 "./admin/Admin.h" 1
# 18 "./admin/Admin.h"
...
struct Linker_x020087759828575913;
...
# 1 "./util/Assert.h" 1
# 20 "./util/Assert.h"
struct Linker_x05610785604083017;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
__attribute__((__noreturn__))
...
struct Linker_x09146728649248386;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x019520844265510617;
...
struct Linker_x08151097687271234;
...
struct Linker_x09315365914954481;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0059215778406670694;
...
struct Linker_x04970947953176539;
...
struct Linker_x08196559700400305;
...
struct Admin* Admin_new(struct AddrIface* ai,
                        ...
                        String* password);
# 16 "subnode/SupernodeHunter_admin.c" 2
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x039980427255732365;
...
# 17 "subnode/SupernodeHunter_admin.c" 2
# 1 "./crypto/Key.h" 1
# 18 "./crypto/Key.h"
# 1 "./benc/String.h" 1
# 20 "./benc/String.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x0364035274177988;
...
struct Linker_x08139138035716629;
...
struct Linker_x07774764668611529;
...
struct Linker_x06414835637724849;
...
struct Linker_x06774285956336465;
...
# 18 "subnode/SupernodeHunter_admin.c" 2
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x04524107598997116;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x06867314659224484;
...
struct Linker_x015886917431058878;
...
struct Linker_x09064488099116983;
...
struct Linker_x05628359692136518;
...
struct Linker_x032395737499049315;
...
struct Linker_x046217428796237514;
...
struct Linker_x06890313119737246;
...
struct Linker_x07497950167556051;
...
struct SupernodeHunter* SupernodeHunter_new(struct Allocator* allocator,
                                            ...
                                            struct ReachabilityCollector* rc);
# 19 "subnode/SupernodeHunter_admin.c" 2
# 1 "./subnode/SupernodeHunter_admin.h" 1
# 18 "./subnode/SupernodeHunter_admin.h"
# 1 "./admin/Admin.h" 1
# 19 "./subnode/SupernodeHunter_admin.h" 2


struct Linker_x014298032438926356;

void SupernodeHunter_admin_register(struct SupernodeHunter* snh,
                                    struct Admin* admin,
                                    struct Allocator* alloc);
# 20 "subnode/SupernodeHunter_admin.c" 2
...
{
    struct Address addr;
    __builtin_memset(&addr,0,(8 + 16 + 32 + 8));
    if (Key_parse(Dict_getString(args, (&(String) { .bytes = "key", .len = CString_strlen("key") })), addr.key, addr.ip6.bytes)) { return 
# 33 "subnode/SupernodeHunter_admin.c" 3 4
                                                                                   ((void *)0)
# 33 "subnode/SupernodeHunter_admin.c"
                                                                                       ; }
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter_admin.c"), (46), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull))"); } } while (0); Identity_ptr; }));
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter_admin.c"), (72), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull))"); } } while (0); Identity_ptr; }));
    struct Address* addr = getAddr(args, requestAlloc);
    if (!addr) {
        sendError(ctx, txid, requestAlloc, "parse_error");
        return;
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter_admin.c"), (100), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull))"); } } while (0); Identity_ptr; }));
    int page = 0;
    ...
    Dict* out = Dict_new(requestAlloc);
    Dict_putList(out, String_new("snodes", requestAlloc), snodeList, requestAlloc);
...
{
    struct Context* ctx = (__extension__ ({ __typeof__((struct Context*) vcontext) Identity_ptr = ((struct Context*) vcontext); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SupernodeHunter_admin.c"), (119), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xb05dd6b560363904ull))"); } } while (0); Identity_ptr; }));
    ...
    Dict_putInt(out, String_new("usingAuthorizedSnode", requestAlloc), ctx->snh->snodeIsReachable > 1, requestAlloc);
    Dict_putString(out, String_new("activeSnode", requestAlloc), String_new(activeSnode, requestAlloc), requestAlloc);
    Dict_putString(out, String_new("error", requestAlloc), String_new("none", requestAlloc), requestAlloc);
    Admin_sendMessage(out, txid, ctx->admin);
}
...
void SupernodeHunter_admin_register(struct SupernodeHunter* snh,
                                    ...
                                    struct Allocator* alloc)
{
    struct Context* ctx = Allocator__clone((alloc),((&(struct Context) { .admin = admin, .alloc = alloc, .snh = snh })),sizeof(*((&(struct Context) { .admin = admin, .alloc = alloc, .snh = snh }))),"SupernodeHunter_admin.c",136)



       ;
    (ctx)->Identity_verifier = ((unsigned long) 0xb05dd6b560363904ull);

    Admin_registerFunctionWithArgCount( "SupernodeHunter_addSnode", addSnode, ctx, 
# 143 "subnode/SupernodeHunter_admin.c" 3 4
   1
# 143 "subnode/SupernodeHunter_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "key", .required = 
# 143 "subnode/SupernodeHunter_admin.c" 3 4
   1
# 143 "subnode/SupernodeHunter_admin.c"
   , .type = "String" } }), (sizeof(((struct Admin_FunctionArg[]) { { .name = "key", .required = 
# 143 "subnode/SupernodeHunter_admin.c" 3 4
   1
# 143 "subnode/SupernodeHunter_admin.c"
   , .type = "String" } })) / sizeof(struct Admin_FunctionArg)), admin)
                  ...
                  ;
    Admin_registerFunctionWithArgCount( "SupernodeHunter_listSnodes", listSnodes, ctx, 
# 147 "subnode/SupernodeHunter_admin.c" 3 4
   0
# 147 "subnode/SupernodeHunter_admin.c"
...
# 147 "subnode/SupernodeHunter_admin.c"
   , .type = "Int" } })) / sizeof(struct Admin_FunctionArg)), admin)
                  ...
                  ;
    Admin_registerFunctionWithArgCount( "SupernodeHunter_removeSnode", removeSnode, ctx, 
# 151 "subnode/SupernodeHunter_admin.c" 3 4
   1
# 151 "subnode/SupernodeHunter_admin.c"
   , ((struct Admin_FunctionArg[]) { { .name = "key", .required = 
# 151 "subnode/SupernodeHunter_admin.c" 3 4
   1
# 151 "subnode/SupernodeHunter_admin.c"
...
# 151 "subnode/SupernodeHunter_admin.c"
   , .type = "String" } })) / sizeof(struct Admin_FunctionArg)), admin)
                  ...
                  ;
    Admin_registerFunctionWithArgCount( "SupernodeHunter_status", status, ctx, 
# 155 "subnode/SupernodeHunter_admin.c" 3 4
   0
# 155 "subnode/SupernodeHunter_admin.c"
   , 
# 155 "subnode/SupernodeHunter_admin.c" 3 4
   ((void *)0)
# 155 "subnode/SupernodeHunter_admin.c"

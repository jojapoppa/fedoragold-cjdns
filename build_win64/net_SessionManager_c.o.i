...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x02611636488523337;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x03291432383547388;
...
# 19 "./util/version/Version.h"
struct Linker_x05492232422051235;
...
struct Linker_x06364350256104829;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08646954787160921;
...
struct Linker_x013435194946231954;
...
struct Linker_x019390670444533664;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x05291573453273639;
...
struct Linker_x07100640091015682;
...
# 21 "./util/ArrayList.h"
struct Linker_x08953047655905149;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05515769276631286;
...
struct Linker_x033194443061497436;
...
struct Linker_x05613007288803227;
...
struct Linker_x07455946770707083;
...
struct Linker_x07153211194004179;
...
struct Linker_x015206801231072542;
...
# 19 "./util/AddrTools.h"
struct Linker_x06999612174477166;
...
struct Linker_x0769884424522395;
...
struct Linker_x005956971604665151;
                        ...
                        enum PFChan_Core ev)
{
    ...
    Message_push(msg, &session, 64, 
# 136 "net/SessionManager.c" 3 4
                                                 ((void *)0)
# 136 "net/SessionManager.c"
                                                     );
    Message_push32(msg, destPf, 
# 137 "net/SessionManager.c" 3 4
                               ((void *)0)
# 137 "net/SessionManager.c"
                                   );
    Message_push32(msg, ev, 
# 138 "net/SessionManager.c" 3 4
                           ((void *)0)
# 138 "net/SessionManager.c"
                               );
...
{
    struct SessionManager_Session_pvt* ssp = (__extension__ ({ __typeof__(sm->ifaceMap.values[mapIndex]) Identity_ptr = (sm->ifaceMap.values[mapIndex]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (145), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
...
# 160 "net/SessionManager.c"
                               ; }
    check(sm, index);
    return (__extension__ ({ __typeof__(sm->ifaceMap.values[index]) Identity_ptr = (sm->ifaceMap.values[index]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (162), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
}

struct SessionManager_Session* SessionManager_sessionForHandle(uint32_t handle,
                                                               struct SessionManager* manager)
{
    struct SessionManager_pvt* sm = (__extension__ ({ __typeof__((struct SessionManager_pvt*) manager) Identity_ptr = ((struct SessionManager_pvt*) manager); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (168), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
...
# 176 "net/SessionManager.c"
                                      ; }
    check(sm, ifaceIndex);
    return (__extension__ ({ __typeof__(sm->ifaceMap.values[ifaceIndex]) Identity_ptr = (sm->ifaceMap.values[ifaceIndex]); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (178), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
}

struct SessionManager_Session* SessionManager_sessionForIp6(uint8_t* ip6,
                                                            struct SessionManager* manager)
{
    struct SessionManager_pvt* sm = (__extension__ ({ __typeof__((struct SessionManager_pvt*) manager) Identity_ptr = ((struct SessionManager_pvt*) manager); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (184), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
...
struct SessionManager_HandleList* SessionManager_getHandleList(struct SessionManager* manager,
                                                               struct Allocator* alloc)
{
    struct SessionManager_pvt* sm = (__extension__ ({ __typeof__((struct SessionManager_pvt*) manager) Identity_ptr = ((struct SessionManager_pvt*) manager); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (191), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
                                                     ...
                                                     int maintainSession)
{
    ...
    (sess)->Identity_verifier = ((unsigned long) 0x3e9e3f2609b91f6full);
...
static __attribute__ ((warn_unused_result)) struct Iface* ctrlFrame(struct Message* msg, struct SessionManager_pvt* sm)
{
    ...
    Message_pop(msg, &rh.sh, 12, 
# 280 "net/SessionManager.c" 3 4
                                               ((void *)0)
# 280 "net/SessionManager.c"
                                                   );
    Message_pop(msg, 
# 281 "net/SessionManager.c" 3 4
                    ((void *)0)
# 281 "net/SessionManager.c"
                        , 4, 
# 281 "net/SessionManager.c" 3 4
                             ((void *)0)
# 281 "net/SessionManager.c"
    ...
    rh.flags = 1 | (1<<1);
    Message_push(msg, &rh, (56 + 12), 
# 283 "net/SessionManager.c" 3 4
                                            ((void *)0)
# 283 "net/SessionManager.c"
                                                );
...
static __attribute__ ((warn_unused_result)) struct Iface* failedDecrypt(struct Message* msg,
                                 ...
                                 struct SessionManager_pvt* sm)
{
    Message_push32(msg, 6, 
# 291 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 291 "net/SessionManager.c"
                                                 );
    Message_push16(msg, 2, 
# 292 "net/SessionManager.c" 3 4
                                      ((void *)0)
# 292 "net/SessionManager.c"
                                          );
    Message_push16(msg, 0, 
# 293 "net/SessionManager.c" 3 4
                          ((void *)0)
# 293 "net/SessionManager.c"
                              );
    uint16_t csum = Checksum_engine(msg->bytes, msg->length);
    Message_pop16(msg, 
# 295 "net/SessionManager.c" 3 4
                      ((void *)0)
# 295 "net/SessionManager.c"
                          );
    Message_push16(msg, csum, 
# 296 "net/SessionManager.c" 3 4
                             ((void *)0)
# 296 "net/SessionManager.c"
                                 );

    Message_push32(msg, 0xffffffff, 
# 298 "net/SessionManager.c" 3 4
                                   ((void *)0)
# 298 "net/SessionManager.c"
                                       );
...
# 302 "net/SessionManager.c"
    ...
    Message_push(msg, &sh, 12, 
# 305 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 305 "net/SessionManager.c"
                                                 );
...
# 313 "net/SessionManager.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (313), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; })); }));
...
# 318 "net/SessionManager.c"
    ...
    Message_shift(msg, -12, 
# 322 "net/SessionManager.c" 3 4
                                          ((void *)0)
# 322 "net/SessionManager.c"
                                              );
    ...
    if (nonceOrHandle == 0xffffffff) {
        Message_shift(msg, 12, 
# 332 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 332 "net/SessionManager.c"
                                                 );
...
# 353 "net/SessionManager.c"
        ...
        Message_shift(msg, -4, 
# 355 "net/SessionManager.c" 3 4
                              ((void *)0)
# 355 "net/SessionManager.c"
                                  );
...
# 387 "net/SessionManager.c"
    ...
    if (ret) {
        do { if (!1) { break; } uint8_t path[20]; AddrTools_printPath(path, ((uint64_t)__builtin_bswap64(((uint64_t)(switchHeader->label_be))))); uint8_t ip[40]; AddrTools_printIp(ip, session->pub.caSession->herIp6); do { if (sm->log && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(sm->log, Log_Level_DEBUG, "SessionManager.c", 391, "ver[%u] send[%d] recv[%u] ip[%s] path[%s] " "DROP Failed decrypting message NoH[%d] state[%s]", session->pub.version, session->pub.sendHandle, session->pub.receiveHandle, ip, path, nonceOrHandle, CryptoAuth_stateString(CryptoAuth_getState(session->pub.caSession))); } } while (0); } while (0)
                                                                                                 ...
                                                                                                 ;
        Message_shift(msg, length0 - msg->length - 24, 
# 396 "net/SessionManager.c" 3 4
                                                      ((void *)0)
# 396 "net/SessionManager.c"
                                                          );
        msg->length = 0;
        Message_push32(msg, CryptoAuth_getState(session->pub.caSession), 
# 398 "net/SessionManager.c" 3 4
                                                                        ((void *)0)
# 398 "net/SessionManager.c"
                                                                            );
        Message_push32(msg, ret, 
# 399 "net/SessionManager.c" 3 4
                                ((void *)0)
# 399 "net/SessionManager.c"
                                    );
        Message_push(msg, firstSixteen, 16, 
# 400 "net/SessionManager.c" 3 4
                                           ((void *)0)
# 400 "net/SessionManager.c"
                                               );
        Message_shift(msg, 12, 
# 401 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 401 "net/SessionManager.c"
                                                 );
    ...
    if (currentMessageSetup) {
        session->pub.sendHandle = Message_pop32(msg, 
# 409 "net/SessionManager.c" 3 4
                                                    ((void *)0)
# 409 "net/SessionManager.c"
                                                        );
    }

    Message_shift(msg, (56 + 12), 
# 412 "net/SessionManager.c" 3 4
                                        ((void *)0)
# 412 "net/SessionManager.c"
                                            );
...
static void unsetupSession(struct SessionManager_pvt* sm, struct SessionManager_Session_pvt* sess)
{
    ...
    Message_push(eventMsg, &n, 64, 
# 485 "net/SessionManager.c" 3 4
                                                ((void *)0)
# 485 "net/SessionManager.c"
                                                    );
    Message_push32(eventMsg, 0xffffffff, 
# 486 "net/SessionManager.c" 3 4
                                        ((void *)0)
# 486 "net/SessionManager.c"
                                            );
    Message_push32(eventMsg, PFChan_Core_UNSETUP_SESSION, 
# 487 "net/SessionManager.c" 3 4
                                                         ((void *)0)
# 487 "net/SessionManager.c"
                                                             );
...
static void triggerSearch(struct SessionManager_pvt* sm, uint8_t target[16], uint32_t version)
{
    ...
    struct Message* eventMsg = Message_new(0, 512, eventAlloc);
    Message_push32(eventMsg, version, 
# 496 "net/SessionManager.c" 3 4
                                     ((void *)0)
# 496 "net/SessionManager.c"
                                         );
    Message_push32(eventMsg, 0, 
# 497 "net/SessionManager.c" 3 4
                               ((void *)0)
# 497 "net/SessionManager.c"
                                   );
    Message_push(eventMsg, target, 16, 
# 498 "net/SessionManager.c" 3 4
                                      ((void *)0)
# 498 "net/SessionManager.c"
                                          );
    Message_push32(eventMsg, 0xffffffff, 
# 499 "net/SessionManager.c" 3 4
                                        ((void *)0)
# 499 "net/SessionManager.c"
                                            );
    Message_push32(eventMsg, PFChan_Core_SEARCH_REQ, 
# 500 "net/SessionManager.c" 3 4
                                                    ((void *)0)
# 500 "net/SessionManager.c"
                                                        );
    Iface_send(&sm->eventIf, eventMsg);
...
{
    struct SessionManager_pvt* sm = (__extension__ ({ __typeof__((struct SessionManager_pvt*) vSessionManager) Identity_ptr = ((struct SessionManager_pvt*) vSessionManager); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (541), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; }));
                               ...
                               struct SessionManager_Session_pvt* sess)
{
    ...
    Message_shift(msg, -(56 + 12), 
# 596 "net/SessionManager.c" 3 4
                                         ((void *)0)
# 596 "net/SessionManager.c"
                                             );
    struct SwitchHeader* sh;
    CryptoAuth_resetIfTimeout(sess->pub.caSession);
    if (CryptoAuth_getState(sess->pub.caSession) < CryptoAuth_State_RECEIVED_KEY) {

        Message_push32(msg, sess->pub.receiveHandle, 
# 601 "net/SessionManager.c" 3 4
                                                    ((void *)0)
# 601 "net/SessionManager.c"
                                                        );


        Message_shift(msg, (120 + 12), 
# 604 "net/SessionManager.c" 3 4
                                                                   ((void *)0)
# 604 "net/SessionManager.c"
                                                                       );
        Bits__memcpy(msg->bytes,&header->sh,12,"SessionManager.c",605);
        sh = (struct SwitchHeader*) msg->bytes;
        Message_shift(msg, -(120 + 12), 
# 607 "net/SessionManager.c" 3 4
                                                                    ((void *)0)
# 607 "net/SessionManager.c"
                                                                        );
    } else {
        sh = &header->sh;
    }
...
# 613 "net/SessionManager.c"
    ...
    if (CryptoAuth_getState(sess->pub.caSession) >= CryptoAuth_State_RECEIVED_KEY) {
        ...
        Message_push32(msg, sess->pub.sendHandle, 
# 626 "net/SessionManager.c" 3 4
                                                 ((void *)0)
# 626 "net/SessionManager.c"
                                                     );
    } else {
    ...
    Message_shift(msg, 12, 
# 635 "net/SessionManager.c" 3 4
                                         ((void *)0)
# 635 "net/SessionManager.c"
                                             );
...
# 657 "net/SessionManager.c"
    ...
    Message_pop(msg, 
# 661 "net/SessionManager.c" 3 4
                    ((void *)0)
# 661 "net/SessionManager.c"
                        , (56 + 12), 
# 661 "net/SessionManager.c" 3 4
                                            ((void *)0)
# 661 "net/SessionManager.c"
    ...
    Message_push32(msg, 0xffffffff, 
# 662 "net/SessionManager.c" 3 4
                                   ((void *)0)
# 662 "net/SessionManager.c"
                                       );
    Message_push(msg, &sh, 12, 
# 663 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 663 "net/SessionManager.c"
                                                 );
    return Iface_next(&sm->pub.switchIf, msg);
}
...
# 670 "net/SessionManager.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (670), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; })); }));
...
# 738 "net/SessionManager.c"
                                   )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("SessionManager.c"), (738), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x3e9e3f2609b91f6full))"); } } while (0); Identity_ptr; })); }));
    enum PFChan_Pathfinder ev = Message_pop32(msg, 
# 739 "net/SessionManager.c" 3 4
                                                  ((void *)0)
# 739 "net/SessionManager.c"
                                                      );
    uint32_t sourcePf = Message_pop32(msg, 
# 740 "net/SessionManager.c" 3 4
                                          ((void *)0)
# 740 "net/SessionManager.c"
                                              );
...
# 748 "net/SessionManager.c" 3 4
                                             ((void *)0)
# 748 "net/SessionManager.c"
                                                 );
                                          ...
                                          struct EventEmitter* ee)
{
    ...
    (sm)->Identity_verifier = ((unsigned long) 0x3e9e3f2609b91f6full);

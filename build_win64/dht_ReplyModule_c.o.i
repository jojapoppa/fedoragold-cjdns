...
# 1 "<command-line>"
# 1 "dht/ReplyModule.c"
# 16 "dht/ReplyModule.c"
# 1 "./dht/CJDHTConstants.h" 1
# 18 "./dht/CJDHTConstants.h"
# 1 "./benc/String.h" 1
# 18 "./benc/String.h"
# 1 "./benc/Object.h" 1
# 18 "./benc/Object.h"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08920043323661693;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x04010062149194571;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x036919901834283664;
...
struct Linker_x05556495648043678;
...
# 19 "./dht/CJDHTConstants.h" 2
# 1 "./util/version/Version.h" 1
# 19 "./util/version/Version.h"
struct Linker_x08517210692428803;
...
# 17 "dht/ReplyModule.c" 2
# 1 "./dht/DHTMessage.h" 1
# 22 "./dht/DHTMessage.h"
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x04928554378179808;
...
struct Linker_x0837163540641223;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x028374914003724006;
...
# 23 "dht/ReplyModule.c" 2
# 33 "dht/ReplyModule.c"
...
# 44 "dht/ReplyModule.c"
void ReplyModule_register(struct DHTModuleRegistry* registry, struct Allocator* allocator)
{
    struct DHTModule* dm = Allocator__clone((allocator),((&(struct DHTModule) { .name = "ReplyModule", .context = registry, .handleIncoming = handleIncoming, .handleOutgoing = handleOutgoing })),sizeof(*((&(struct DHTModule) { .name = "ReplyModule", .context = registry, .handleIncoming = handleIncoming, .handleOutgoing = handleOutgoing }))),"ReplyModule.c",46)
...
static int handleIncoming(struct DHTMessage* message, void* vcontext)
{
    if (Dict_getString(message->asDict, CJDHTConstants_QUERY) == 
# 58 "dht/ReplyModule.c" 3 4
                                                                ((void *)0)
# 58 "dht/ReplyModule.c"
                                                                    ) {
        return 0;
    }
    ...
    do { if (!((!((uintptr_t)message->binMessage->bytes % 4) || !"alignment fault0"))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("ReplyModule.c"), (65), "(!((uintptr_t)message->binMessage->bytes % 4) || !\"alignment fault0\")"); } } while (0);

    struct DHTMessage* reply = Allocator__clone((message->allocator),((&(struct DHTMessage) { .replyTo = message, .address = message->address, .allocator = message->allocator, .binMessage = message->binMessage })),sizeof(*((&(struct DHTMessage) { .replyTo = message, .address = message->address, .allocator = message->allocator, .binMessage = message->binMessage }))),"ReplyModule.c",67)
...
{
    if (message->replyTo != 
# 81 "dht/ReplyModule.c" 3 4
                           ((void *)0)
# 81 "dht/ReplyModule.c"
                               ) {
        if (message->asDict == 
# 82 "dht/ReplyModule.c" 3 4
                              ((void *)0)
# 82 "dht/ReplyModule.c"
                                  ) {
        ...
        if (tid != 
# 88 "dht/ReplyModule.c" 3 4
                  ((void *)0)
# 88 "dht/ReplyModule.c"
                      ) {

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x03363193684054884;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x01933350390451123;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x016257014035032302;
...
struct Linker_x003797840126146701;
...
struct Linker_x06489014459578757;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x022841016978460016;
...
struct Linker_x007631975140254044;
...
struct Linker_x026481192690162336;
...
struct Linker_x05250666311054837;
...
struct Linker_x0033421547537094476;
# 30 "./io/FileWriter.h"
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x038467249724040187;
...
struct Linker_x039974408598872646;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x02819044281366274;
...
struct Linker_x06364336893808511;
...
# 21 "./util/ArrayList.h"
struct Linker_x009609022419036206;
...
struct Linker_x04503843735866415;
...
struct Linker_x05529389616753955;
...
struct Linker_x045869646803351216;
...
struct Linker_x04861285175628902;
...
# 1 "./dht/Address.h" 1
# 21 "./dht/Address.h"
struct Linker_x030089023522529845;
# 34 "./dht/Address.h"
struct Address
{
...
struct Linker_x02203016445837973;
...
struct Linker_x07372498268729164;
...
struct Linker_x04789216585954523;
...
struct Linker_x05633973166783728;
...
struct Linker_x0676868936799863;
...
struct Linker_x08389026876420342;
...
struct Linker_x09673557806775801;
...
struct Linker_x07019128119196616;
...
struct Linker_x09626715472468472;
...
struct Linker_x06410567306989645;
...
struct Linker_x09570160840664663;
...
# 22 "./net/TUNAdapter.h"
struct Linker_x04171973616972955;
...
struct Linker_x0012301508658935312;
...
struct Linker_x0802126113265244;
...
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x07776141753659056;
# 32 "./util/Hex.h"
...
struct Linker_x07926327227591323;
...
struct Linker_x03462155705702059;
...
struct Linker_x03818259643615258;
...
struct Linker_x0010689859808761693;
...
struct Linker_x000843603951129368;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x02947517294397357;
...
struct Linker_x09327965215747063;
...
struct Linker_x021798045471968086;
...
# 55 "./test/Beacon_test.c" 3 4
   _Bool 
# 55 "./test/Beacon_test.c"
        beaconsSent;
...
# 74 "./test/Beacon_test.c" 3 4
                         __builtin_offsetof (
# 74 "./test/Beacon_test.c"
                         struct TwoNodes
# 74 "./test/Beacon_test.c" 3 4
                         , 
# 74 "./test/Beacon_test.c"
...
# 74 "./test/Beacon_test.c"
                         )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (74), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull))"); } } while (0); Identity_ptr; })); }));
    do { if (!((TUNMessageType_pop(msg, 
# 75 "./test/Beacon_test.c" 3 4
   ((void *)0)
# 75 "./test/Beacon_test.c"
   ) == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (75), "(TUNMessageType_pop(msg, ((void *)0)) == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; }))))"); } } while (0);
    Message_shift(msg, -40, 
# 76 "./test/Beacon_test.c" 3 4
                                               ((void *)0)
# 76 "./test/Beacon_test.c"
                                                   );
...
# 84 "./test/Beacon_test.c"
                         )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (84), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull))"); } } while (0); Identity_ptr; })); }));
    do { if (!((TUNMessageType_pop(msg, 
# 85 "./test/Beacon_test.c" 3 4
   ((void *)0)
# 85 "./test/Beacon_test.c"
   ) == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; })))))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (85), "(TUNMessageType_pop(msg, ((void *)0)) == ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; }))))"); } } while (0);
    Message_shift(msg, -40, 
# 86 "./test/Beacon_test.c" 3 4
                                               ((void *)0)
# 86 "./test/Beacon_test.c"
                                                   );
    uint8_t buff[1024];
...
{
    struct TwoNodes* ctx = (__extension__ ({ __typeof__((struct TwoNodes*) vTwoNodes) Identity_ptr = ((struct TwoNodes*) vTwoNodes); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (104), "(Identity_ptr->Identity_verifier == ((unsigned long) 0x5902ebd7a91a6598ull))"); } } while (0); Identity_ptr; }));

    if (!ctx->beaconsSent) {
        if (Pathfinder_getNodeStore(ctx->nodeA->pathfinder) &&
            Pathfinder_getNodeStore(ctx->nodeB->pathfinder))
        {
            do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "Beacon_test.c", 110, "Linking A and B"); } } while (0);
            TestFramework_linkNodes(ctx->nodeB, ctx->nodeA, 
# 111 "./test/Beacon_test.c" 3 4
                                                           1
# 111 "./test/Beacon_test.c"
                                                               );
            ctx->beaconsSent = 
...
# 112 "./test/Beacon_test.c"
    ...
    do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "Beacon_test.c", 122, "A seems to be linked with B"); } } while (0);
    if (Pathfinder_getNodeStore(ctx->nodeB->pathfinder)->nodeCount < 2) {
        notLinkedYet(ctx);
        return;
    }
    do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "Beacon_test.c", 127, "B seems to be linked with A"); } } while (0);
    do { if (ctx->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_DEBUG, "Beacon_test.c", 128, "\n\nSetup Complete\n\n"); } } while (0);
...
# 156 "./test/Beacon_test.c"
    ...
    struct TwoNodes* out = Allocator__calloc((alloc),(sizeof(struct TwoNodes)),(1),"Beacon_test.c",171);
    (out)->Identity_verifier = ((unsigned long) 0x5902ebd7a91a6598ull);
    ...
    out->nodeA = a;
    out->logger = logger;
    out->checkLinkageTimeout = Timeout__setInterval((checkLinkage), (out), (1), (base), (alloc), "Beacon_test.c", 180);
    out->base = base;
    out->startTime = Time_currentTimeMilliseconds(base);
    out->runTest = runTest;
    out->alloc = alloc;

    do { if (a->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(a->logger, Log_Level_DEBUG, "Beacon_test.c", 186, "Waiting for nodes to link asynchronously..."); } } while (0);
}
...
{
    struct Message* msg;
    uint8_t UniqueName_06a169281e32b2074820[64 + 512]; msg = &(struct Message){ .length = 64, .bytes = UniqueName_06a169281e32b2074820 + 512, .padding = 512, .capacity = 64 };

    Bits__memcpy(msg->bytes,message,CString_strlen(message) + 1,"Beacon_test.c",197);
    ...
    if (from == tn->nodeA) {
        ...
        do { if (!((
# 211 "./test/Beacon_test.c" 3 4
       0
# 211 "./test/Beacon_test.c"
       ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (211), "(0)"); } } while (0);
    }

    TUNMessageType_push(msg, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; }))), 
# 214 "./test/Beacon_test.c" 3 4
                                               ((void *)0)
# 214 "./test/Beacon_test.c"
                                                   );
    Iface_send(fromIf, msg);

    if (to == tn->nodeA) {
        do { if (!((tn->messageFrom == 1))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (218), "(tn->messageFrom == 1)"); } } while (0);
    } else if (to == tn->nodeB) {
        do { if (!((tn->messageFrom == 2))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (220), "(tn->messageFrom == 2)"); } } while (0);
    } else {
        do { if (!((
# 222 "./test/Beacon_test.c" 3 4
       0
# 222 "./test/Beacon_test.c"
       ))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Beacon_test.c"), (222), "(0)"); } } while (0);
    }
...
static void runTest(struct TwoNodes* tn)
{
    ...
    do { if (tn->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(tn->logger, Log_Level_DEBUG, "Beacon_test.c", 247, "\n\nTest passed, shutting down\n\n"); } } while (0);
    Allocator__free((tn->alloc),"Beacon_test.c",248);
}


int Beacon_test_main(int argc, char** argv);int Beacon_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<22),"Beacon_test.c",254);
    struct Writer* logwriter = FileWriter_new(
# 255 "./test/Beacon_test.c" 3
                                             (__acrt_iob_func(1))
# 255 "./test/Beacon_test.c"
                                                   , alloc);
    struct Log* logger = WriterLog_new(logwriter, alloc);
    struct Random* rand = Random_new(alloc, logger, 
# 257 "./test/Beacon_test.c" 3 4
                                                   ((void *)0)
# 257 "./test/Beacon_test.c"
                                                       );
    struct EventBase* base = EventBase_new(alloc);
    start(Allocator__child((alloc),"Beacon_test.c",259), logger, base, rand, runTest);

    EventBase_beginLoop(base);
    Allocator__free((alloc),"Beacon_test.c",262);

...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x05935904395359559;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x05031357500682829;
...
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x09704296478942693;
...
struct Linker_x06869959148481657;
...
# 1 "./benc/Dict.h" 1
# 21 "./benc/Dict.h"
struct Linker_x03395337682326678;
...
# 1 "./benc/List.h" 1
# 21 "./benc/List.h"
struct Linker_x06102624075892014;
...
struct Linker_x08869976562876569;
...
# 1 "./util/Bits.h" 1
# 21 "./util/Bits.h"
struct Linker_x05546031770041513;
...
struct Linker_x026776711638996953;
...
struct Linker_x022470433032715253;
...
struct Linker_x09979491205331357;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x0919651251277543;
...
struct Linker_x05510764890179398;
...
struct Linker_x04823736144340063;
...
struct Linker_x014098987687066034;
...
struct Linker_x08329265073372807;
...
struct Linker_x02556701529314571;
...
struct Linker_x08918505336691995;
...
struct Linker_x03837553574087209;
...
struct Linker_x023714867507450998;
...
# 63 "./util/platform/netdev/NetDev.h"
...
# 19 "./util/AddrTools.h"
struct Linker_x03869718022594393;
...
# 32 "tunnel/IpTunnel.c" 2


# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x023306092541218204;
...
# 41 "tunnel/IpTunnel.c" 2

# 1 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 1 3 4
# 1 "/usr/share/mingw-w64/include/stddef.h" 1 3 4
# 2 "/usr/lib/gcc/x86_64-w64-mingw32/9.2-win32/include/stddef.h" 2 3 4
# 43 "tunnel/IpTunnel.c" 2
...
# 77 "tunnel/IpTunnel.c" 3 4
                                                _Bool 
# 77 "tunnel/IpTunnel.c"
                                                     isOutgoing, struct IpTunnel_pvt* context)
{
    if (context->pub.connectionList.count == context->connectionCapacity) {
        ...
        context->pub.connectionList.connections =
            Allocator__realloc((context->allocator),(context->pub.connectionList.connections),(newSize),"IpTunnel.c",82);
    ...
    if (!isOutgoing) {
        for (int i = (int)context->pub.connectionList.count - 1; i >= 0; i--) {
            ...
            {
                Bits__memcpy(conn,&context->pub.connectionList.connections[i + 1],sizeof(struct IpTunnel_Connection),"IpTunnel.c",94)
...
# 109 "tunnel/IpTunnel.c" 3 4
   0xffffffffU 
# 109 "tunnel/IpTunnel.c"
   >> 1)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (109), "(context->nextConnectionNumber < (0xffffffffU >> 1))"); } } while (0);
...
static void deleteConnection(struct IpTunnel_Connection* conn, struct IpTunnel_pvt* context)
{
    ...
    do { if (!((i >= 0 && i < (signed int)context->pub.connectionList.count))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (122), "(i >= 0 && i < (signed int)context->pub.connectionList.count)"); } } while (0);

    for (; (unsigned int)i < context->pub.connectionList.count-1; ++i) {
        Bits__memcpy(&context->pub.connectionList.connections[i],&context->pub.connectionList.connections[i + 1],sizeof(struct IpTunnel_Connection),"IpTunnel.c",125)
                                                      ...
                                                      struct IpTunnel_pvt* context)
{
    ...
    return 
# 148 "tunnel/IpTunnel.c" 3 4
          ((void *)0)
# 148 "tunnel/IpTunnel.c"
              ;
}
# 162 "tunnel/IpTunnel.c"
int IpTunnel_allowConnection(uint8_t publicKeyOfAuthorizedNode[32],
                             struct Sockaddr* ip6Addr,
                             uint8_t ip6Prefix,
                             uint8_t ip6Alloc,
                             ...
                             struct IpTunnel* tunnel)
{
    struct IpTunnel_pvt* context = (__extension__ ({ __typeof__((struct IpTunnel_pvt*)tunnel) Identity_ptr = ((struct IpTunnel_pvt*)tunnel); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (171), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull))"); } } while (0); Identity_ptr; }));

    do { if (context->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_DEBUG, "IpTunnel.c", 173, "IPv4 Prefix to allow: %d", ip4Prefix); } } while (0);
...
# 175 "tunnel/IpTunnel.c"
                             ;
    uint8_t* ip4Address = 
# 176 "tunnel/IpTunnel.c" 3 4
                         ((void *)0)
# 176 "tunnel/IpTunnel.c"
                             ;
    if (ip6Addr) {
...
# 208 "tunnel/IpTunnel.c" 3 4
                         ((void *)0)
# 208 "tunnel/IpTunnel.c"
                             , 4, 
# 208 "tunnel/IpTunnel.c" 3 4
                                                ((void *)0)
# 208 "tunnel/IpTunnel.c"
    ...
    Message_push(message, &connection->routeHeader, (56 + 12), 
# 212 "tunnel/IpTunnel.c" 3 4
                                                                     ((void *)0)
# 212 "tunnel/IpTunnel.c"
                                                                         );
                               ...
                               struct IpTunnel_pvt* context)
{
    ...
    BencMessageWriter_write(dict, msg, 
# 222 "tunnel/IpTunnel.c" 3 4
                                      ((void *)0)
# 222 "tunnel/IpTunnel.c"
                                          );
    ...
    Message_shift(msg, 8, 
# 227 "tunnel/IpTunnel.c" 3 4
                                              ((void *)0)
# 227 "tunnel/IpTunnel.c"
                                                  );
    ...
    Message_shift(msg, 40, 
# 236 "tunnel/IpTunnel.c" 3 4
                                              ((void *)0)
# 236 "tunnel/IpTunnel.c"
                                                  );
    ...
    do { do { if (!((!msg->currentIface))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (252), "(!msg->currentIface)"); } } while (0); struct Iface Iface_y = { .currentMsg = msg }; msg->currentIface = &Iface_y; struct Iface* Iface_x = sendToNode(msg, connection, context); msg->currentIface = 
# 252 "tunnel/IpTunnel.c" 3 4
   ((void *)0)
# 252 "tunnel/IpTunnel.c"
...
static void requestAddresses(struct IpTunnel_Connection* conn, struct IpTunnel_pvt* context)
{
    if (1) {
        ...
        do { if (context->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_DEBUG, "IpTunnel.c", 260, "Requesting addresses from [%s] for connection [%d]", addr, conn->number); } } while (0)
                                     ;
    }
...
# 265 "tunnel/IpTunnel.c" 3 4
            ((void *)0) 
# 265 "tunnel/IpTunnel.c"
            }) })



      ;
    struct Allocator* msgAlloc = Allocator__child((context->allocator),"IpTunnel.c",270);
    sendControlMessage(&d, conn, msgAlloc, context);
    Allocator__free((msgAlloc),"IpTunnel.c",272);
}
# 282 "tunnel/IpTunnel.c"
int IpTunnel_connectTo(uint8_t publicKeyOfNodeToConnectTo[32], struct IpTunnel* tunnel)
{
    struct IpTunnel_pvt* context = (__extension__ ({ __typeof__((struct IpTunnel_pvt*)tunnel) Identity_ptr = ((struct IpTunnel_pvt*)tunnel); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (284), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull))"); } } while (0); Identity_ptr; }));

    struct IpTunnel_Connection* conn = newConnection(
# 286 "tunnel/IpTunnel.c" 3 4
                                                    1
# 286 "tunnel/IpTunnel.c"
                                                        , context);
    Bits__memcpy(conn->routeHeader.publicKey,publicKeyOfNodeToConnectTo,32,"IpTunnel.c",287);
    AddressCalc_addressForPublicKey(conn->routeHeader.ip6, publicKeyOfNodeToConnectTo);

    if (1) {
        uint8_t addr[40];
        AddrTools_printIp(addr, conn->routeHeader.ip6);
        do { if (context->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_DEBUG, "IpTunnel.c", 293, "Trying to connect to [%s]", addr); } } while (0);
    }
...
int IpTunnel_removeConnection(int connectionNumber, struct IpTunnel* tunnel)
{
    struct IpTunnel_pvt* context = (__extension__ ({ __typeof__((struct IpTunnel_pvt*)tunnel) Identity_ptr = ((struct IpTunnel_pvt*)tunnel); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (309), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull))"); } } while (0); Identity_ptr; }));
...
static 
# 323 "tunnel/IpTunnel.c" 3 4
      _Bool 
# 323 "tunnel/IpTunnel.c"
           isControlMessageInvalid(struct Message* message, struct IpTunnel_pvt* context)
{
    ...
    if (header->nextHeader != 17 || message->length < length + 40) {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 328, "Invalid IPv6 packet (not UDP or length field too big)"); } } while (0);
        return 
# 329 "tunnel/IpTunnel.c" 3 4
              1
# 329 "tunnel/IpTunnel.c"
                  ;
    }

    Message_shift(message, -40, 
# 332 "tunnel/IpTunnel.c" 3 4
                                                   ((void *)0)
# 332 "tunnel/IpTunnel.c"
                                                       );
    ...
    if (Checksum_udpIp6(header->sourceAddr, message->bytes, length)) {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 336, "Checksum mismatch"); } } while (0);
        return 
# 337 "tunnel/IpTunnel.c" 3 4
              1
# 337 "tunnel/IpTunnel.c"
                  ;
    }
    ...
    if (((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(udp->length_be))); _x >> 8 | _x << 8; }))) != length
        ...
        || udp->destPort_be != 0)
    {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 345, "Invalid UDP packet (length mismatch or wrong ports)"); } } while (0);
        return 
# 346 "tunnel/IpTunnel.c" 3 4
              1
# 346 "tunnel/IpTunnel.c"
                  ;
    }

    Message_shift(message, -8, 
# 349 "tunnel/IpTunnel.c" 3 4
                                                   ((void *)0)
# 349 "tunnel/IpTunnel.c"
                                                       );

    message->length = length;
    return 
# 352 "tunnel/IpTunnel.c" 3 4
          0
# 352 "tunnel/IpTunnel.c"
               ;
}
                                       ...
                                       struct IpTunnel_pvt* context)
{
    if (1) {
        uint8_t addr[40];
        AddrTools_printIp(addr, conn->routeHeader.ip6);
        do { if (context->logger && Log_Level_DEBUG >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_DEBUG, "IpTunnel.c", 363, "Got request for addresses from [%s]", addr); } } while (0);
    }

    if (conn->isOutgoing) {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 367, "got request for addresses from outgoing connection"); } } while (0);
        return 0;
    }
    Dict* addresses = Dict_new(requestAlloc);
    
# 371 "tunnel/IpTunnel.c" 3 4
   _Bool 
# 371 "tunnel/IpTunnel.c"
        noAddresses = 
# 371 "tunnel/IpTunnel.c" 3 4
                      1
# 371 "tunnel/IpTunnel.c"
    ...
    if (!Bits_isZero(conn->connectionIp6, 16)) {
        ...
        noAddresses = 
# 384 "tunnel/IpTunnel.c" 3 4
                     0
# 384 "tunnel/IpTunnel.c"
                          ;
    }
    if (!Bits_isZero(conn->connectionIp4, 4)) {
        ...
        noAddresses = 
# 398 "tunnel/IpTunnel.c" 3 4
                     0
# 398 "tunnel/IpTunnel.c"
                          ;
    }
    if (noAddresses) {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 401, "no addresses to provide"); } } while (0);
        return 0;
    }
...
# 434 "tunnel/IpTunnel.c" 3
   _setjmp((
# 434 "tunnel/IpTunnel.c"
   j.buf
# 434 "tunnel/IpTunnel.c" 3
...
# 434 "tunnel/IpTunnel.c"
        ...
        do { if (ctx->logger && Log_Level_ERROR >= Log_Level_DEBUG) { Log_print(ctx->logger, Log_Level_ERROR, "IpTunnel.c", 437, "Error setting ip address on TUN [%s]", j.message); } } while (0);
        return;
    }

    ss.addr.prefix = prefixLen;
    
# 442 "tunnel/IpTunnel.c" 3 4
   _Bool 
# 442 "tunnel/IpTunnel.c"
        installRoute = 
# 442 "tunnel/IpTunnel.c" 3 4
                       0
# 442 "tunnel/IpTunnel.c"
...
{
    if (!conn->isOutgoing) {
        do { if (context->logger && Log_Level_WARN >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_WARN, "IpTunnel.c", 461, "got offer of addresses from incoming connection"); } } while (0);
        return 0;
    }

    String* txid = Dict_getString(d, (&(String) { .bytes = "txid", .len = CString_strlen("txid") }));
    if (!txid || txid->len != 4) {
        do { if (context->logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_INFO, "IpTunnel.c", 467, "missing or wrong length txid"); } } while (0);
        return 0;
    }

    int number;
    Bits__memcpy(&number,txid->bytes,4,"IpTunnel.c",472);
    if (number < 0 || number >= (int)context->nextConnectionNumber) {
        do { if (context->logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_INFO, "IpTunnel.c", 474, "txid out of range"); } } while (0);
        return 0;
    }
    ...
    if (number != conn->number) {
        for (int i = 0; i < (int)context->pub.connectionList.count; i++) {
            if (context->pub.connectionList.connections[i].number == number) {
                ...
                {
                    do { if (context->logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_INFO, "IpTunnel.c", 485, "txid doesn't match origin"); } } while (0);
                    return 0;
                } else {
    ...
    if (ip4 && ip4->len == 4) {
        Bits__memcpy(conn->connectionIp4,ip4->bytes,4,"IpTunnel.c",501);
        ...
        uint8_t* addrBytes = 
# 516 "tunnel/IpTunnel.c" 3 4
                            ((void *)0)
# 516 "tunnel/IpTunnel.c"
                                ;
        Sockaddr_getAddress(sa, &addrBytes);
        Bits__memcpy(addrBytes,ip4->bytes,4,"IpTunnel.c",518);
        char* printedAddr = Sockaddr_print(sa, alloc);

        do { if (context->logger && Log_Level_INFO >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_INFO, "IpTunnel.c", 521, "Got issued address [%s/%d:%d] for connection [%d]", printedAddr, conn->connectionIp4Alloc, conn->connectionIp4Prefix, conn->number); } } while (0)
                                                                                                ;
...
# 547 "tunnel/IpTunnel.c"
    ...
    if (context->rg->hasUncommittedChanges) {
        ...
        if (!tunName) {
            do { if (context->logger && Log_Level_ERROR >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_ERROR, "IpTunnel.c", 560, "Failed to set routes because TUN interface is not setup"); } } while (0);
            return 0;
        }
        struct Jmp j;
        j.handler.exception = Jmp_callback; if (!
# 564 "tunnel/IpTunnel.c" 3
       _setjmp((
...
# 564 "tunnel/IpTunnel.c"
            ...
            do { if (context->logger && Log_Level_ERROR >= Log_Level_DEBUG) { Log_print(context->logger, Log_Level_ERROR, "IpTunnel.c", 567, "Error setting routes for TUN [%s]", j.message); } } while (0);
            return 0;
        }
    }
    return 0;
...
{
    struct IpTunnel_pvt* context = (__extension__ ({ __typeof__((struct IpTunnel_pvt*)tunIf) Identity_ptr = ((struct IpTunnel_pvt*)tunIf); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (715), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull))"); } } while (0); Identity_ptr; }));
...
# 755 "tunnel/IpTunnel.c"
    ...
    TUNMessageType_push(message, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x86DD))); _x >> 8 | _x << 8; }))), 
# 762 "tunnel/IpTunnel.c" 3 4
                                                   ((void *)0)
# 762 "tunnel/IpTunnel.c"
                                                       );
...
# 774 "tunnel/IpTunnel.c"
    ...
    TUNMessageType_push(message, ((uint16_t)(__extension__ ({ uint16_t _x = (((uint16_t)(0x0800))); _x >> 8 | _x << 8; }))), 
# 785 "tunnel/IpTunnel.c" 3 4
                                                   ((void *)0)
# 785 "tunnel/IpTunnel.c"
                                                       );
    return Iface_next(&context->pub.tunInterface, message);
}
...
# 792 "tunnel/IpTunnel.c"
       )); do { if (!((Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull)))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("IpTunnel.c"), (792), "(Identity_ptr->Identity_verifier == ((unsigned long) 0xc2b80168d6a3782eull))"); } } while (0); Identity_ptr; })); }));
    ...
    Message_shift(message, -((56 + 12) + 4), 
# 810 "tunnel/IpTunnel.c" 3 4
                                                                 ((void *)0)
# 810 "tunnel/IpTunnel.c"
                                                                     );
...
# 872 "tunnel/IpTunnel.c"
    ...
    (context)->Identity_verifier = ((unsigned long) 0xc2b80168d6a3782eull);

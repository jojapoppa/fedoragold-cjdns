# 1 "exception/Except.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "exception/Except.c"
# 18 "exception/Except.c"
...
struct Linker_x07712130882959478;
...
# 19 "exception/Except.c" 2
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x015384682352783274;
...
# 265 "/usr/share/mingw-w64/include/stdio.h" 3
...
# 571 "/usr/share/mingw-w64/include/stdio.h" 3
...
# 862 "/usr/share/mingw-w64/include/stdio.h" 3
static __attribute__ ((__unused__)) __inline__ __attribute__((__cdecl__))
                                                     __attribute__ ((__nonnull__ (2)))
...
# 1222 "/usr/share/mingw-w64/include/stdio.h" 3
...
# 449 "/usr/share/mingw-w64/include/stdlib.h" 3
static __attribute__ ((__unused__)) __inline__ __attribute__((__cdecl__))
...
# 24 "exception/Except.c" 2


# 25 "exception/Except.c"
void Except__throw(char* file, int line, struct Except* eh, char* format, ...)
{
    va_list args;
    
# 28 "exception/Except.c" 3 4
   __builtin_va_start(
# 28 "exception/Except.c"
   args
# 28 "exception/Except.c" 3 4
   ,
# 28 "exception/Except.c"
...
# 28 "exception/Except.c"
    ...
    if (eh) {
        ...
        fprintf(
# 44 "exception/Except.c" 3
               (__acrt_iob_func(2))
# 44 "exception/Except.c"
                     , "%s:%d ", subFile, line);
        vfprintf(
# 45 "exception/Except.c" 3
                (__acrt_iob_func(2))
# 45 "exception/Except.c"
                      , format, args);
        fprintf(
# 46 "exception/Except.c" 3
               (__acrt_iob_func(2))
# 46 "exception/Except.c"
                     , "\n");
    }
    abort();
    exit(100);

# 1 "./util/test/Hex_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./util/test/Hex_test.c"
# 15 "./util/test/Hex_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x040127075033845494;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x024368093821781822;
...
struct Linker_x09459296870188587;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x024723476042949555;
...
struct Linker_x05521133278165535;
...
struct Linker_x010666156603164545;
...
# 18 "./util/test/Hex_test.c" 2
# 1 "./util/Hex.h" 1
# 21 "./util/Hex.h"
struct Linker_x037942195034346526;
...
# 22 "./util/test/Hex_test.c" 2


# 23 "./util/test/Hex_test.c"
int Hex_test_main(int argc, char** argv);int Hex_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((20000),"Hex_test.c",25);
    struct Random* rand = Random_new(alloc, 
# 26 "./util/test/Hex_test.c" 3 4
                                           ((void *)0)
# 26 "./util/test/Hex_test.c"
                                               , 
# 26 "./util/test/Hex_test.c" 3 4
                                                 ((void *)0)
# 26 "./util/test/Hex_test.c"
    ...
    do { if (!((Hex_encode(hex, 65, bytes, 32) == 64))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Hex_test.c"), (33), "(Hex_encode(hex, 65, bytes, 32) == 64)"); } } while (0);



    uint8_t bytes2[32];
    do { if (!((Hex_decode(bytes2, 32, hex, 64) == 32))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Hex_test.c"), (38), "(Hex_decode(bytes2, 32, hex, 64) == 32)"); } } while (0);

    do { if (!((__builtin_memcmp(bytes,bytes2,32) == 0))) { Assert_failure("Assertion failure [%s:%d] [%s]\n", ("Hex_test.c"), (40), "(__builtin_memcmp(bytes,bytes2,32) == 0)"); } } while (0);

    Allocator__free((alloc),"Hex_test.c",42);
    return 0;
}

# 1 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
# 1 "/home/jojapoppa/fedoragold-cjdns//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
# 15 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
...
# 1 "./util/Linker.h" 1
# 20 "./util/Assert.h" 2
struct Linker_x08159197279461583;
# 33 "./util/Assert.h"
__attribute__((__format__ (__printf__, 1, 2)))
...
struct Linker_x020636556201230505;
...
struct Linker_x08588710372789534;
...
# 1 "./util/log/Log.h" 1
# 20 "./util/log/Log.h"
struct Linker_x08100093717298962;
...
struct Linker_x04562559747125452;
...
struct Linker_x03342275244405739;
...
struct Iface* TUNInterface_new(const char* interfaceName,
                                   ...
                                   struct Except* eh,
                                   struct Allocator* alloc);
# 16 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
...
# 21 "./util/Bits.h"
struct Linker_x06898449402292044;
...
# 22 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
# 1 "./util/events/Timeout.h" 1
# 20 "./util/events/Timeout.h"
struct Linker_x044288068773937916;
...
# 23 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
# 1 "./wire/Ethernet.h" 1
# 23 "./wire/Ethernet.h"
struct Ethernet
{
...
# 24 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
# 1 "./wire/Headers.h" 1
# 23 "./wire/Headers.h"
...
struct Linker_x005830665998934048;
...
void NetDev_setRoutes(const char* ifName,
                      ...
                      struct Except* eh);
# 26 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
# 1 "./test/RootTest.h" 1
# 18 "./test/RootTest.h"
# 1 "./util/CString.h" 1
# 20 "./util/CString.h"
struct Linker_x09010493907644317;
...
int RootTest_TUNInterface_ipv6_withroute_root_test_main(int argc, char** argv);
int TUNInterface_ipv6_withroute_root_test_main(int argc, char** argv);int TUNInterface_ipv6_withroute_root_test_main(int argc, char** argv)
{
    int runIt = 0;
    int j = 0;
    ...
    if (runIt) {
        return RootTest_TUNInterface_ipv6_withroute_root_test_main(j,argv);
    } else {
        fprintf(
...
# 47 "./test/RootTest.h"
                ...
                "TUNInterface_ipv6_withroute_root_test",
                (argc > 0) ? argv[0] : "",
                "TUNInterface_ipv6_withroute_root_test");
    }
    return 0;
...
int RootTest_TUNInterface_ipv6_withroute_root_test_main(int argc, char** argv);
# 27 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2
...
struct Linker_x048222203420669363;
...
void TUNTools_echoTest(struct Sockaddr* udpBindTo,
                       ...
                       struct Log* logger,
                       struct Allocator* alloc);
# 28 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 2

int RootTest_TUNInterface_ipv6_withroute_root_test_main(int argc, char** argv)
{
    struct Allocator* alloc = MallocAllocator__new((1<<20),"TUNInterface_ipv6_withroute_root_test.c",31);
    struct EventBase* base = EventBase_new(alloc);
    struct Log* logger = FileWriterLog_new(
# 33 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 3
                                          (__acrt_iob_func(1))
# 33 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
                                                , alloc);
...
# 39 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 3 4
                                        ((void *)0)
# 39 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
...
# 42 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 3 4
                                                    ((void *)0)
# 42 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
                                                        );
    addrC->flags |= (1<<1);
    addrC->prefix = 125;
    NetDev_setRoutes(assignedIfName, ((struct Sockaddr*[]) { addrC }) , 1, logger, alloc, 
# 45 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c" 3 4
                                                                                         ((void *)0)
# 45 "./interface/tuntap/test/TUNInterface_ipv6_withroute_root_test.c"
                                                                                             );

    TUNTools_echoTest(addrA, addrC, TUNTools_genericIP6Echo, tun, base, logger, alloc);
    Allocator__free((alloc),"TUNInterface_ipv6_withroute_root_test.c",48);
    return 0;
}
